...
static const char * const ctypes[] =
{
   ...
   "char *", "const char *", "Eina_Stringshare *", "Efl_Strbuf *",
...
static int
doc_lex(Eo_Lexer *ls, Eolian_Documentation *doc, Efl_Bool *term, Efl_Bool *since)
{
   int tokret = -1;
   eina_strbuf_reset(ls->buff);
   *since = EFL_FALSE;
...
void doc_error(Eo_Lexer *ls, const char *msg, Eolian_Documentation *doc, Efl_Strbuf *buf)
{
