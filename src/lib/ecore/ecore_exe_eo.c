...
void _ecore_exe_command_set(Eo             *obj,
                            Ecore_Exe_Data *pd,
                            const char     *exe_cmd,
                            Ecore_Exe_Flags flags);

EOAPI EFL_VOID_FUNC_BODYV(ecore_obj_exe_command_set,
                          EFL_FUNC_CALL(exe_cmd, flags),
                          const char     *exe_cmd,
                          Ecore_Exe_Flags flags);

void _ecore_exe_command_get(const Eo        *obj,
                            Ecore_Exe_Data  *pd,
                            const char     **exe_cmd,
                            Ecore_Exe_Flags *flags);

EOAPI EFL_VOID_FUNC_BODYV_CONST(ecore_obj_exe_command_get,
                                EFL_FUNC_CALL(exe_cmd, flags),
                                const char     **exe_cmd,
                                Ecore_Exe_Flags *flags);
...
void _ecore_exe_efl_control_suspend_set(Eo             *obj,
                                        Ecore_Exe_Data *pd,
                                        Efl_Bool        suspend);
...
#  define ECORE_EXE_EXTRA_OPS
    ...
    EFL_OPS_DEFINE(
        ...
        EFL_OBJECT_OP_FUNC(efl_control_suspend_set,
                           _ecore_exe_efl_control_suspend_set),
        ECORE_EXE_EXTRA_OPS);
    opsp = &ops;
...
EFL_DEFINE_CLASS(ecore_exe_class_get,
                 &_ecore_exe_class_desc,
                 EFL_OBJECT_CLASS,
