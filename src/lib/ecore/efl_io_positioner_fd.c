...
EOLIAN static void
_efl_io_positioner_fd_positioner_fd_set(Eo *o EFL_UNUSED, Efl_Io_Positioner_Fd_Data *pd, int fd)
{
   pd->fd = fd;
}

EOLIAN static int
_efl_io_positioner_fd_positioner_fd_get(const Eo *o EFL_UNUSED, Efl_Io_Positioner_Fd_Data *pd)
{
   return pd->fd;
}
...
_efl_io_positioner_fd_efl_io_positioner_seek(Eo *o, Efl_Io_Positioner_Fd_Data *pd EFL_UNUSED, int64_t offset, Efl_Io_Positioner_Whence whence)
{
...
_efl_io_positioner_fd_efl_io_positioner_position_get(const Eo *o, Efl_Io_Positioner_Fd_Data *pd EFL_UNUSED)
{
   int fd = efl_io_positioner_fd_get(o);
   off_t offset;
