...
_efl_exe_signal(Eo *obj EFL_UNUSED, Efl_Exe_Data *pd, Efl_Exe_Signal sig)
{
   ...
   switch (sig)
     {
      case EFL_EXE_SIGNAL_INT:  s = SIGINT;  pd->exit_signalled = EFL_TRUE; break;
      case EFL_EXE_SIGNAL_QUIT: s = SIGQUIT; pd->exit_signalled = EFL_TRUE; break;
      case EFL_EXE_SIGNAL_TERM: s = SIGTERM; pd->exit_signalled = EFL_TRUE; break;
      case EFL_EXE_SIGNAL_KILL: s = SIGKILL; pd->exit_signalled = EFL_TRUE; break;
...
EOLIAN static void
_efl_exe_efl_io_reader_can_read_set(Eo *obj, Efl_Exe_Data *pd, Efl_Bool can_read)
{
...
EOLIAN static void
_efl_exe_efl_io_writer_can_write_set(Eo *obj, Efl_Exe_Data *pd, Efl_Bool can_write)
{
