...
EOLIAN static Efl_Bool
_efl_io_closer_fd_efl_io_closer_close_on_exec_set(Eo *o, Efl_Io_Closer_Fd_Data *pd, Efl_Bool close_on_exec)
{
#ifdef _WIN32
   ...
   fd = efl_io_closer_fd_get(o);
   if (fd < 0) return EFL_TRUE; /* postpone until fd_set(), users
