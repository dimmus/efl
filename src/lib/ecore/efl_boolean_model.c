                                          ...
                                          const char *property)
{
   ...
   sr = _storage_lookup(pd, property, index, EFL_FALSE, EFL_FALSE, &found, &default_value);
                                          ...
                                          const char *property, Eina_Value *value)
{
   ...
   if (!eina_value_bool_convert(value, &flag))
     convert_fail = EFL_TRUE;

   sr = _storage_lookup(pd, property, index, EFL_TRUE, flag, &found, &default_value);
   if (!found)
     return efl_model_property_set(efl_super(obj, EFL_BOOLEAN_MODEL_CLASS),
                                   property, value);
...
static Eina_Iterator *
_efl_boolean_model_boolean_iterator_get(Eo *obj, Efl_Boolean_Model_Data *pd, const char *name, Efl_Bool request)
{
