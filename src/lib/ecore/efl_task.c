...
EOLIAN static void
_efl_task_priority_set(Eo *obj EFL_UNUSED, Efl_Task_Data *pd, Efl_Task_Priority priority)
{
...
EOLIAN static void
_efl_task_efl_object_parent_set(Eo *obj, Efl_Task_Data *pd EFL_UNUSED, Efl_Object *parent)
{
