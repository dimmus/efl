...
eldbus_model_connect_do(Eldbus_Model_Data *pd)
{
    ...
    else
    {
        ...
        else pd->connection = eldbus_connection_get(pd->type);
    }
...
static void
_eldbus_model_connect(Eo *obj                EFL_UNUSED,
...
static void
_eldbus_model_connection_set(Eo *obj            EFL_UNUSED,
                             Eldbus_Model_Data *pd,
...
_eldbus_model_connection_get(const Eo *obj EFL_UNUSED, Eldbus_Model_Data *pd)
{
...
static const char *
_eldbus_model_address_get(const Eo *obj EFL_UNUSED, Eldbus_Model_Data *pd)
{
    return pd->address;
}

static Efl_Bool
_eldbus_model_private_get(const Eo *obj EFL_UNUSED, Eldbus_Model_Data *pd)
{
    return pd->private;
}

static Eldbus_Connection_Type
_eldbus_model_type_get(const Eo *obj EFL_UNUSED, Eldbus_Model_Data *pd)
{
    return pd->type;
}
...
_eldbus_model_efl_model_property_set(Eo                   *obj,
                                     Eldbus_Model_Data *pd EFL_UNUSED,
                                     const char           *property,
...
_eldbus_model_efl_model_properties_get(const Eo *obj         EFL_UNUSED,
                                       Eldbus_Model_Data *pd EFL_UNUSED)
{
...
static Efl_Object *
_eldbus_model_efl_model_child_add(Eo *obj               EFL_UNUSED,
                                  Eldbus_Model_Data *pd EFL_UNUSED)
{
    return NULL;
}
...
static void
_eldbus_model_efl_model_child_del(Eo *obj               EFL_UNUSED,
                                  Eldbus_Model_Data *pd EFL_UNUSED,
                                  Efl_Object *child     EFL_UNUSED)
{}

static Eina_Future *
_eldbus_model_efl_model_children_slice_get(Eo *obj               EFL_UNUSED,
                                           Eldbus_Model_Data *pd EFL_UNUSED,
...
static unsigned int
_eldbus_model_efl_model_children_count_get(const Eo *obj         EFL_UNUSED,
                                           Eldbus_Model_Data *pd EFL_UNUSED)
{
    return 0;
}
