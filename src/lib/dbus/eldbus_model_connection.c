...
static void _eldbus_model_connection_names_list_cb(void *,
                                                   const Eldbus_Message *,
                                                   Eldbus_Pending *);

static Efl_Object *
_eldbus_model_connection_efl_object_constructor(
    Eo                           *obj,
...
static void
_eldbus_model_connection_efl_object_invalidate(Eo *obj,
                                               Eldbus_Model_Connection_Data *pd)
{
...
static Eina_Future *
_eldbus_model_connection_efl_model_children_slice_get(
    Eo                           *obj,
    Eldbus_Model_Connection_Data *pd,
    unsigned int                  start,
    unsigned int                  count)
...
static unsigned int
_eldbus_model_connection_efl_model_children_count_get(
    const Eo                     *obj,
    Eldbus_Model_Connection_Data *pd)
{
    _eldbus_model_children_list(obj, pd);
                                       ...
                                       Eldbus_Pending *pending EFL_UNUSED)
{
    ...
    while (eldbus_message_iter_get_and_next(array, 's', &bus))
    {
        ...
        child = efl_add(ELDBUS_MODEL_OBJECT_CLASS,
                        pd->obj,
