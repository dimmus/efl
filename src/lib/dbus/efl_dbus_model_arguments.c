...
static void _efl_dbus_model_arguments_properties_load(Efl_Dbus_Model_Arguments_Data *);
static void _efl_dbus_model_arguments_unload(Efl_Dbus_Model_Arguments_Data *);
static Efl_Bool _efl_dbus_model_arguments_is_input_argument(Efl_Dbus_Model_Arguments_Data *, const char *);
static Efl_Bool _efl_dbus_model_arguments_is_output_argument(Efl_Dbus_Model_Arguments_Data *, const char *);
static Efl_Bool _efl_dbus_model_arguments_property_set(Efl_Dbus_Model_Arguments_Data *, Eina_Value *, const char *);
static unsigned int _efl_dbus_model_arguments_argument_index_get(Efl_Dbus_Model_Arguments_Data *, const char *);
...
static Efl_Object*
_efl_dbus_model_arguments_efl_object_constructor(Eo *obj, Efl_Dbus_Model_Arguments_Data *pd)
{
   pd->obj = obj;
   // We do keep strings here as some of our API are looking for arg%u as a key instead of just indexes.
   pd->properties = eina_hash_string_superfast_new(EINA_FREE_CB(_efl_dbus_model_arguments_hash_free));
...
static Efl_Object *
_efl_dbus_model_arguments_efl_object_finalize(Eo *obj, Efl_Dbus_Model_Arguments_Data *pd)
{
...
static void
_efl_dbus_model_arguments_efl_object_invalidate(Eo *obj, Efl_Dbus_Model_Arguments_Data *pd)
{
...
_efl_dbus_model_arguments_efl_model_properties_get(const Eo *obj EFL_UNUSED,
                                                 Efl_Dbus_Model_Arguments_Data *pd)
{
...
static Eina_Future *
_efl_dbus_model_arguments_efl_model_property_set(Eo *obj,
                                               Efl_Dbus_Model_Arguments_Data *pd,
...
static Eina_Value *
_efl_dbus_model_arguments_efl_model_property_get(const Eo *obj, Efl_Dbus_Model_Arguments_Data *pd, const char *property)
{
   Eina_Value *value;
   Efl_Bool ret;
...
static const char *
_efl_dbus_model_arguments_arg_name_get(const Eo *obj EFL_UNUSED, Efl_Dbus_Model_Arguments_Data *pd)
{
   return pd->name;
}
...
static Efl_Bool
_efl_dbus_model_arguments_is(Efl_Dbus_Model_Arguments_Data *pd,
                           const char *argument,
...
static Efl_Bool
_efl_dbus_model_arguments_is_input_argument(Efl_Dbus_Model_Arguments_Data *pd, const char *argument)
{
   return _efl_dbus_model_arguments_is(pd, argument, ELDBUS_INTROSPECTION_ARGUMENT_DIRECTION_IN);
}

static Efl_Bool
_efl_dbus_model_arguments_is_output_argument(Efl_Dbus_Model_Arguments_Data *pd, const char *argument)
{
   return _efl_dbus_model_arguments_is(pd, argument, ELDBUS_INTROSPECTION_ARGUMENT_DIRECTION_OUT) ||
     _efl_dbus_model_arguments_is(pd, argument, ELDBUS_INTROSPECTION_ARGUMENT_DIRECTION_NONE);
}

static unsigned int
_efl_dbus_model_arguments_argument_index_get(Efl_Dbus_Model_Arguments_Data *pd, const char *argument)
{
   unsigned int i = 0;
