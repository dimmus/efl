 ...
 */
typedef Efl_Bool (*Eldbus_Property_Get_Cb)(const Eldbus_Service_Interface *iface, const char *propname, Eldbus_Message_Iter *iter, const Eldbus_Message *request_msg, Eldbus_Message **error);
...
EAPI Eldbus_Connection *eldbus_service_connection_get(const Eldbus_Service_Interface *iface) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
EAPI const char *eldbus_service_object_path_get(const Eldbus_Service_Interface *iface) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 * @return EFL_TRUE if success
 */
EAPI Efl_Bool eldbus_service_signal_emit(const Eldbus_Service_Interface *iface, unsigned int signal_id, ...) EINA_ARG_NONNULL(1);
 ...
 * @return EFL_TRUE if success
 */
EAPI Eldbus_Message *eldbus_service_signal_new(const Eldbus_Service_Interface *iface, unsigned int signal_id) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 * @return EFL_TRUE if success
 */
EAPI Efl_Bool eldbus_service_signal_send(const Eldbus_Service_Interface *iface, Eldbus_Message *signal_msg) EINA_ARG_NONNULL(1, 2);
 ...
 */
EAPI void *eldbus_service_object_data_get(const Eldbus_Service_Interface *iface, const char *key) EINA_ARG_NONNULL(1, 2) EFL_WARN_UNUSED_RESULT;
 ...
 * @return EFL_TRUE if success
 */
EAPI Efl_Bool eldbus_service_property_changed(const Eldbus_Service_Interface *iface, const char *name) EINA_ARG_NONNULL(1, 2);

EAPI Efl_Bool eldbus_service_property_invalidate_set(const Eldbus_Service_Interface *iface, const char *name, Efl_Bool is_invalidate) EINA_ARG_NONNULL(1, 2);
 ...
 * @return EFL_TRUE if success
 */
EAPI Efl_Bool eldbus_service_object_manager_attach(Eldbus_Service_Interface *iface) EINA_ARG_NONNULL(1);
 ...
 * @return EFL_TRUE if success
 */
EAPI Efl_Bool eldbus_service_object_manager_detach(Eldbus_Service_Interface *iface) EINA_ARG_NONNULL(1);
