...
static const char *_eldbus_introspection_attribute_value_get(Eina_Inlist *,
                                                             const char *);
...
static void  _eldbus_introspection_parse_children(
     Eina_Inlist *,
     const Eldbus_Introspection_Element_Parse_Table[]);
static void
_eldbus_introspection_interface_free(Eldbus_Introspection_Interface *);
...
static void
_eldbus_introspection_argument_free(Eldbus_Introspection_Argument *);
static void
_eldbus_introspection_property_free(Eldbus_Introspection_Property *);
static void
_eldbus_introspection_annotation_free(Eldbus_Introspection_Annotation *);
...
eldbus_introspection_parse(const char *xml)
{
    ...
    node = (Eldbus_Introspection_Node *)_eldbus_introspection_parse_node(
...
static const char *
_eldbus_introspection_attribute_value_get(Eina_Inlist *attributes,
                                          const char  *key)
{
...
_eldbus_introspection_parse_argument(Eina_Simple_XML_Node_Tag *tag)
{
    ...
    direction =
        _eldbus_introspection_attribute_value_get(tag->attributes, "direction");
    if (direction)
    {
...
_eldbus_introspection_parse_property(Eina_Simple_XML_Node_Tag *tag)
{
    ...
    access =
        _eldbus_introspection_attribute_value_get(tag->attributes, "access");
...
static void
_eldbus_introspection_annotation_free(
    Eldbus_Introspection_Annotation *annotation)
{
...
static void
_eldbus_introspection_parse_children(
    Eina_Inlist                                   *children,
    const Eldbus_Introspection_Element_Parse_Table table[])
{
