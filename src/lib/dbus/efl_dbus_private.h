...
void efl_dbus_data_set(Eina_Inlist **p_lst, const char *key, const void *data)
  EINA_ARG_NONNULL(1, 2, 3);
void *efl_dbus_data_get(Eina_Inlist **p_lst, const char *key)
  EINA_ARG_NONNULL(1, 2);
void *efl_dbus_data_del(Eina_Inlist **p_lst, const char *key)
  EINA_ARG_NONNULL(1, 2);
...
Efl_Bool efl_dbus_object_proxy_del(Efl_Dbus_Object *obj,
                                   Efl_Dbus_Proxy  *proxy,
                                   const char      *interface)
  EINA_ARG_NONNULL(1, 2);

void efl_dbus_connection_signal_handler_add(Efl_Dbus_Connection     *conn,
                                            Efl_Dbus_Signal_Handler *handler)
  EINA_ARG_NONNULL(1, 2);
void efl_dbus_connection_pending_add(Efl_Dbus_Connection *conn,
                                     Efl_Dbus_Pending    *pending)
  EINA_ARG_NONNULL(1, 2);
void efl_dbus_connection_signal_handler_del(Efl_Dbus_Connection     *conn,
                                            Efl_Dbus_Signal_Handler *handler)
  EINA_ARG_NONNULL(1, 2);
void efl_dbus_connection_signal_handler_del(Efl_Dbus_Connection     *conn,
                                            Efl_Dbus_Signal_Handler *handler)
  EINA_ARG_NONNULL(1, 2);
void efl_dbus_connection_pending_del(Efl_Dbus_Connection *conn,
                                     Efl_Dbus_Pending    *pending)
  EINA_ARG_NONNULL(1, 2);

Efl_Dbus_Object *efl_dbus_connection_name_object_get(Efl_Dbus_Connection *conn,
                                                     const char          *name,
                                                     const char          *path);
void             efl_dbus_connection_name_object_set(Efl_Dbus_Connection *conn,
                                                     Efl_Dbus_Object     *obj);

Efl_Bool efl_dbus_object_proxy_add(Efl_Dbus_Object *obj, Efl_Dbus_Proxy *proxy)
  EINA_ARG_NONNULL(1, 2);
Efl_Dbus_Proxy *efl_dbus_object_proxy_get(Efl_Dbus_Object *obj,
                                          const char      *interface);

void efl_dbus_connection_name_object_del(Efl_Dbus_Connection   *conn,
                                         const Efl_Dbus_Object *obj);
Efl_Dbus_Connection_Name      *
efl_dbus_connection_name_get(Efl_Dbus_Connection *conn, const char *name);
void efl_dbus_connection_name_owner_monitor(Efl_Dbus_Connection      *conn,
                                            Efl_Dbus_Connection_Name *cn,
                                            Efl_Bool                  enable);

Efl_Dbus_Pending *_efl_dbus_connection_send(Efl_Dbus_Connection *conn,
                                            Efl_Dbus_Message    *msg,
                                            Efl_Dbus_Message_Cb  cb,
                                            const void          *cb_data,
                                            double               timeout);
Efl_Dbus_Message *_efl_dbus_connection_send_and_block(Efl_Dbus_Connection *conn,
                                                      Efl_Dbus_Message    *msg,
                                                      double timeout);
...
Efl_Bool    _message_iter_from_eina_value(const char            *signature,
                                          Efl_Dbus_Message_Iter *iter,
                                          const Eina_Value      *value);
Efl_Bool    _message_iter_from_eina_value_struct(const char            *signature,
                                                 Efl_Dbus_Message_Iter *iter,
                                                 const Eina_Value      *value);

void efl_dbus_connection_name_ref(Efl_Dbus_Connection_Name *cn);
void efl_dbus_connection_name_unref(Efl_Dbus_Connection      *conn,
                                    Efl_Dbus_Connection_Name *cn);
Efl_Dbus_Signal_Handler *_efl_dbus_signal_handler_add(Efl_Dbus_Connection *conn,
                                                      const char *sender,
                                                      const char *path,
                                                      const char *interface,
                                                      const char *member,
                                                      ...
                                                      const void *cb_data);
Efl_Dbus_Message        *efl_dbus_message_signal_new(const char *path,
                                                     const char *interface,
                                                     const char *name)
