...
static void _efl_dbus_object_event_callback_call(Efl_Dbus_Object *obj, Efl_Dbus_Object_Event_Type type, const void *event_info);
static void _efl_dbus_object_context_event_cb_del(Efl_Dbus_Object_Context_Event *ce, Efl_Dbus_Object_Context_Event_Cb *ctx);
   ...
   EINA_LIST_FOREACH_SAFE(obj->signal_handlers, iter, iter_next, h)
     {
        DBG("obj=%p delete owned signal handler %p %s",
            obj, h, efl_dbus_signal_handler_match_get(h));
...
_efl_dbus_object_free(Efl_Dbus_Object *obj)
{
   ...
   EINA_LIST_FREE(obj->signal_handlers, h)
     {
        if (h->dangling)
          efl_dbus_signal_handler_free_cb_del(h, _on_signal_handler_free, obj);
        else
...
efl_dbus_object_get(Efl_Dbus_Connection *conn, const char *bus, const char *path)
{
   Efl_Dbus_Object *obj;
   ...
   if (obj)
     return efl_dbus_object_ref(obj);
   ...
   obj->properties = efl_dbus_proxy_get(obj, EFL_DBUS_FDO_INTERFACE_PROPERTIES);
...
EAPI void
efl_dbus_object_free_cb_add(Efl_Dbus_Object *obj, Efl_Dbus_Free_Cb cb, const void *data)
{
   EFL_DBUS_OBJECT_CHECK(obj);
...
EAPI void
efl_dbus_object_free_cb_del(Efl_Dbus_Object *obj, Efl_Dbus_Free_Cb cb, const void *data)
{
   EFL_DBUS_OBJECT_CHECK(obj);
   EINA_SAFETY_ON_NULL_RETURN(cb);
...
_cb_interfaces_added(void *data, const Efl_Dbus_Message *msg)
{
   ...
   if (!efl_dbus_message_arguments_get(msg, "oa{sa{sv}}", &obj_path, &array_ifaces))
     return;
   ...
   while (efl_dbus_message_iter_get_and_next(array_ifaces, 'e', &entry_iface))
     {
        ...
        _efl_dbus_object_event_callback_call(obj, EFL_DBUS_OBJECT_EVENT_IFACE_ADDED,
                                          &event);
   ...
   while (efl_dbus_message_iter_get_and_next(array_ifaces, 's', &iface))
     {
        ...
        _efl_dbus_object_event_callback_call(obj, EFL_DBUS_OBJECT_EVENT_IFACE_REMOVED,
                                          &event);
     }
}
...
EAPI void
efl_dbus_object_event_callback_add(Efl_Dbus_Object *obj, Efl_Dbus_Object_Event_Type type, Efl_Dbus_Object_Event_Cb cb, const void *cb_data)
{
   Efl_Dbus_Object_Context_Event *ce;
   Efl_Dbus_Object_Context_Event_Cb *ctx;
      ...
      case EFL_DBUS_OBJECT_EVENT_IFACE_ADDED:
         {
            ...
            obj->interfaces_added =
                     _efl_dbus_signal_handler_add(obj->conn, obj->name, NULL,
                                               EFL_DBUS_FDO_INTERFACE_OBJECT_MANAGER,
                                               "InterfacesAdded",
                                               _cb_interfaces_added, obj);
            EINA_SAFETY_ON_NULL_RETURN(obj->interfaces_added);
            efl_dbus_signal_handler_match_extra_set(obj->interfaces_added, "arg0",
                                                 obj->path, NULL);
            break;
         }
      ...
      case EFL_DBUS_OBJECT_EVENT_PROPERTY_REMOVED:
        {
           ...
           obj->properties_changed =
                    efl_dbus_object_signal_handler_add(obj,
...
static void
_efl_dbus_object_context_event_cb_del(Efl_Dbus_Object_Context_Event *ce, Efl_Dbus_Object_Context_Event_Cb *ctx)
{
...
EAPI void
efl_dbus_object_event_callback_del(Efl_Dbus_Object *obj, Efl_Dbus_Object_Event_Type type, Efl_Dbus_Object_Event_Cb cb, const void *cb_data)
{
   Efl_Dbus_Object_Context_Event *ce;
   ...
   switch (type)
     {
      ...
      case EFL_DBUS_OBJECT_EVENT_IFACE_REMOVED:
        {
           if (obj->event_handlers[EFL_DBUS_OBJECT_EVENT_IFACE_REMOVED].list)
             break;
           efl_dbus_signal_handler_del(obj->interfaces_removed);
      ...
      case EFL_DBUS_OBJECT_EVENT_PROPERTY_REMOVED:
        {
           if (obj->event_handlers[EFL_DBUS_OBJECT_EVENT_PROPERTY_CHANGED].list ||
               obj->event_handlers[EFL_DBUS_OBJECT_EVENT_PROPERTY_REMOVED].list)
             break;
           efl_dbus_signal_handler_del(obj->properties_changed);
...
static void
_efl_dbus_object_event_callback_call(Efl_Dbus_Object *obj, Efl_Dbus_Object_Event_Type type, const void *event_info)
{
   Efl_Dbus_Object_Context_Event *ce;
...
static void
_on_object_message_cb(void *data, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending)
{
...
efl_dbus_object_send(Efl_Dbus_Object *obj, Efl_Dbus_Message *msg, Efl_Dbus_Message_Cb cb, const void *cb_data, double timeout)
{
   ...
   pending = _efl_dbus_connection_send(obj->conn, msg, _on_object_message_cb,
                                     cb_data, timeout);
...
efl_dbus_object_signal_handler_add(Efl_Dbus_Object *obj, const char *interface, const char *member, Efl_Dbus_Signal_Cb cb, const void *cb_data)
{
   ...
   handler = _efl_dbus_signal_handler_add(obj->conn, obj->name, obj->path,
...
efl_dbus_object_method_call_new(Efl_Dbus_Object *obj, const char *interface, const char *member)
{
   EFL_DBUS_OBJECT_CHECK_RETVAL(obj, NULL);
   EINA_SAFETY_ON_NULL_RETURN_VAL(interface, NULL);
   EINA_SAFETY_ON_NULL_RETURN_VAL(member, NULL);

   return efl_dbus_message_method_call_new(obj->name, obj->path, interface, member);
}

Efl_Bool
efl_dbus_object_proxy_add(Efl_Dbus_Object *obj, Efl_Dbus_Proxy *proxy)
{
   return eina_hash_add(obj->proxies, efl_dbus_proxy_interface_get(proxy), proxy);
}
...
Efl_Bool
efl_dbus_object_proxy_del(Efl_Dbus_Object *obj, Efl_Dbus_Proxy *proxy, const char *interface)
{
   return eina_hash_del(obj->proxies, interface, proxy);
}

EAPI Efl_Dbus_Pending *
efl_dbus_object_peer_ping(Efl_Dbus_Object *obj, Efl_Dbus_Message_Cb cb, const void *data)
{
   Efl_Dbus_Message *msg;
   Efl_Dbus_Pending *p;
   EFL_DBUS_OBJECT_CHECK_RETVAL(obj, NULL);
   msg = efl_dbus_object_method_call_new(obj, EFL_DBUS_FDO_INTEFACE_PEER, "Ping");
   p = efl_dbus_object_send(obj, msg, cb, data, -1);
   return p;
}

EAPI Efl_Dbus_Pending *
efl_dbus_object_peer_machine_id_get(Efl_Dbus_Object *obj, Efl_Dbus_Message_Cb cb, const void *data)
{
   Efl_Dbus_Message *msg;
   Efl_Dbus_Pending *p;
   EFL_DBUS_OBJECT_CHECK_RETVAL(obj, NULL);
   msg = efl_dbus_object_method_call_new(obj, EFL_DBUS_FDO_INTEFACE_PEER,
                                      "GetMachineId");
   p = efl_dbus_object_send(obj, msg, cb, data, -1);
   return p;
}
...
EAPI Efl_Dbus_Pending *
efl_dbus_object_introspect(Efl_Dbus_Object *obj, Efl_Dbus_Message_Cb cb, const void *data)
{
   Efl_Dbus_Message *msg;
   Efl_Dbus_Pending *p;
   EFL_DBUS_OBJECT_CHECK_RETVAL(obj, NULL);
   msg = efl_dbus_object_method_call_new(obj, EFL_DBUS_FDO_INTERFACE_INTROSPECTABLE,
                                      "Introspect");
   p = efl_dbus_object_send(obj, msg, cb, data, -1);
   return p;
}
