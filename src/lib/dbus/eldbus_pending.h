 ...
 */
EAPI const char           *eldbus_pending_destination_get(const Eldbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *eldbus_pending_path_get(const Eldbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *eldbus_pending_interface_get(const Eldbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *eldbus_pending_method_get(const Eldbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
