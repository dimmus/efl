...
Efl_Dbus_Message *
efl_dbus_message_new(Efl_Bool writable)
{
...
efl_dbus_message_method_call_new(const char *dest,
                                 const char *path,
                                 const char *iface,
                                 const char *method)
{
...
EAPI Efl_Bool
efl_dbus_message_error_get(const Efl_Dbus_Message *msg,
                           const char            **name,
                           const char            **text)
{
  if (name) *name = NULL;
...
static Efl_Bool
_efl_dbus_message_arguments_vget(Efl_Dbus_Message *msg,
...
EAPI Efl_Bool
efl_dbus_message_arguments_get(const Efl_Dbus_Message *msg,
                               const char             *signature,
                               ...)
{
  Efl_Bool ret;
  ...
  ret =
    _efl_dbus_message_arguments_vget((Efl_Dbus_Message *)msg, signature, ap);
  va_end(ap);
  return ret;
}

EAPI Efl_Bool
efl_dbus_message_arguments_vget(const Efl_Dbus_Message *msg,
                                const char             *signature,
                                va_list                 ap)
{
  EFL_DBUS_MESSAGE_CHECK_RETVAL(msg, EFL_FALSE);
  EINA_SAFETY_ON_NULL_RETURN_VAL(signature, EFL_FALSE);
  return _efl_dbus_message_arguments_vget((Efl_Dbus_Message *)msg,
                                          signature,
                                          ap);
}

static Efl_Bool
_efl_dbus_message_iter_arguments_vappend(Efl_Dbus_Message_Iter *iter,
                                         const char            *signature,
                                         va_list               *aq)
{
  ...
  while ((type = dbus_signature_iter_get_signature(&signature_iter)))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (type[0] == DBUS_STRUCT_BEGIN_CHAR) real_type = DBUS_TYPE_STRUCT;
...
static Efl_Bool
_efl_dbus_message_arguments_vappend(Efl_Dbus_Message *msg,
                                    const char       *signature,
                                    va_list          *aq)
{
  DBusSignatureIter      signature_iter;
...
EAPI Efl_Bool
efl_dbus_message_arguments_append(Efl_Dbus_Message *msg,
                                  const char       *signature,
                                  ...)
{
  Efl_Bool ret;
...
EAPI Efl_Bool
efl_dbus_message_arguments_vappend(Efl_Dbus_Message *msg,
                                   const char       *signature,
                                   va_list           ap)
{
  va_list  aq;
...
EAPI Efl_Bool
efl_dbus_message_iter_container_close(Efl_Dbus_Message_Iter *iter,
                                      Efl_Dbus_Message_Iter *sub)
{
  EFL_DBUS_MESSAGE_ITERATOR_CHECK_RETVAL(iter, EFL_FALSE);
...
EAPI Efl_Bool
efl_dbus_message_iter_fixed_array_append(Efl_Dbus_Message_Iter *iter,
                                         int                    type,
                                         const void            *array,
                                         unsigned int           size)
{
...
EAPI Efl_Bool
efl_dbus_message_iter_fixed_array_get(Efl_Dbus_Message_Iter *iter,
                                      int                    signature,
                                      void                  *value,
                                      int                   *n_elements)
{
 ...
 */
EAPI Efl_Bool
efl_dbus_message_iter_get_and_next(Efl_Dbus_Message_Iter *iter,
                                   char                   signature,
                                   ...)
{
  char    type;
...
static Efl_Bool
_efl_dbus_message_iter_arguments_vget(Efl_Dbus_Message_Iter *iter,
                                      const char            *signature,
                                      va_list               *aq)
{
  int               iter_type;
  ...
  while (iter_type != DBUS_TYPE_INVALID)
  {
    ...
    else
    {
      ...
      dbus_message_iter_recurse(&iter->dbus_iterator, &sub_itr->dbus_iterator);
      iter->iterators =
...
EAPI Efl_Bool
efl_dbus_message_iter_arguments_get(Efl_Dbus_Message_Iter *iter,
                                    const char            *signature,
                                    ...)
{
  va_list  ap;
...
EAPI Efl_Bool
efl_dbus_message_iter_arguments_vget(Efl_Dbus_Message_Iter *iter,
                                     const char            *signature,
                                     va_list                ap)
{
  va_list  aq;
...
EAPI Efl_Dbus_Message *
efl_dbus_message_error_new(const Efl_Dbus_Message *msg,
...
EAPI Efl_Dbus_Message *
efl_dbus_message_signal_new(const char *path,
