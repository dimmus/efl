...
static void
_eldbus_model_method_call_cb(void *, const Eldbus_Message *, Eldbus_Pending *);

static Efl_Object *
_eldbus_model_method_efl_object_constructor(Eo                       *obj,
...
static void
_eldbus_model_method_proxy_set(Eo *obj                   EFL_UNUSED,
                               Eldbus_Model_Method_Data *pd,
                               Eldbus_Proxy             *proxy)
{
    pd->proxy = proxy;
...
static void
_eldbus_model_method_method_set(Eo *obj                            EFL_UNUSED,
                                Eldbus_Model_Method_Data          *pd,
...
static void
_eldbus_model_method_call(Eo *obj                      EFL_UNUSED,
                          Eldbus_Model_Method_Data *pd EFL_UNUSED)
{
    Eldbus_Model_Arguments_Data *data =
        efl_data_scope_get(obj, ELDBUS_MODEL_ARGUMENTS_CLASS);
    ...
    pending            = eldbus_proxy_send(data->proxy,
                                msg,
                                _eldbus_model_method_call_cb,
                                pd,
                                -1);
...
static void
_eldbus_model_method_call_cb(void                 *data,
                             const Eldbus_Message *msg,
                             Eldbus_Pending       *pending)
{
    Eldbus_Model_Method_Data    *pd = (Eldbus_Model_Method_Data *)data;
    Eldbus_Model_Arguments_Data *args_data =
        efl_data_scope_get(pd->obj, ELDBUS_MODEL_ARGUMENTS_CLASS);
