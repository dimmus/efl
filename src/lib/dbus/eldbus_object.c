...
static void _eldbus_object_event_callback_call(Eldbus_Object           *obj,
                                               Eldbus_Object_Event_Type type,
                                               const void *event_info);
static void
            _eldbus_object_context_event_cb_del(Eldbus_Object_Context_Event    *ce,
...
_eldbus_object_call_del(Eldbus_Object *obj)
{
    ...
    */
    ...
    while (ce->list)
    {
        ...
        ctx =
            EINA_INLIST_CONTAINER_GET(ce->list, Eldbus_Object_Context_Event_Cb);
...
_eldbus_object_free(Eldbus_Object *obj)
{
    ...
    if (obj->interfaces_added) eldbus_signal_handler_del(obj->interfaces_added);
...
eldbus_object_get(Eldbus_Connection *conn, const char *bus, const char *path)
{
    ...
    if (obj) return eldbus_object_ref(obj);
...
EAPI void
eldbus_object_free_cb_add(Eldbus_Object *obj,
                          Eldbus_Free_Cb cb,
                          const void    *data)
{
    ELDBUS_OBJECT_CHECK(obj);
...
EAPI void
eldbus_object_free_cb_del(Eldbus_Object *obj,
                          Eldbus_Free_Cb cb,
                          const void    *data)
{
    ELDBUS_OBJECT_CHECK(obj);
...
EAPI void
eldbus_object_event_callback_add(Eldbus_Object           *obj,
                                 Eldbus_Object_Event_Type type,
        ...
        case ELDBUS_OBJECT_EVENT_IFACE_ADDED:
            {
                ...
                obj->interfaces_added = _eldbus_signal_handler_add(
                    obj->conn,
                    obj->name,
                    NULL,
                ...
                eldbus_signal_handler_match_extra_set(obj->interfaces_added,
                                                      "arg0",
                                                      obj->path,
                                                      NULL);
                break;
        ...
        case ELDBUS_OBJECT_EVENT_IFACE_REMOVED:
            {
                ...
                obj->interfaces_removed = _eldbus_signal_handler_add(
                    obj->conn,
                    obj->name,
                    NULL,
                    ELDBUS_FDO_INTERFACE_OBJECT_MANAGER,
        ...
        case ELDBUS_OBJECT_EVENT_PROPERTY_REMOVED:
            {
                ...
                obj->properties_changed = eldbus_object_signal_handler_add(
                    obj,
...
EAPI void
eldbus_object_event_callback_del(Eldbus_Object           *obj,
                                 Eldbus_Object_Event_Type type,
                                 Eldbus_Object_Event_Cb   cb,
                                 const void              *cb_data)
{
    ...
    switch (type)
    {
        ...
        case ELDBUS_OBJECT_EVENT_PROPERTY_REMOVED:
            {
                if (obj->event_handlers[ELDBUS_OBJECT_EVENT_PROPERTY_CHANGED]
                        .list ||
                    obj->event_handlers[ELDBUS_OBJECT_EVENT_PROPERTY_REMOVED]
                        .list)
                    break;
                eldbus_signal_handler_del(obj->properties_changed);
...
static void
_eldbus_object_event_callback_call(Eldbus_Object           *obj,
                                   Eldbus_Object_Event_Type type,
                                   const void              *event_info)
{
    Eldbus_Object_Context_Event    *ce;
...
EAPI Eldbus_Pending *
eldbus_object_send(Eldbus_Object    *obj,
                   Eldbus_Message   *msg,
                   ...
                   double            timeout)
{
    ...
    pending = _eldbus_connection_send(obj->conn,
                                      msg,
...
eldbus_object_signal_handler_add(Eldbus_Object   *obj,
                                 ...
                                 const void      *cb_data)
{
    ...
    handler = _eldbus_signal_handler_add(obj->conn,
                                         obj->name,
                                         obj->path,
                                         interface,
                                         member,
...
EAPI Eldbus_Message *
eldbus_object_method_call_new(Eldbus_Object *obj,
                              const char    *interface,
                              const char    *member)
{
    ELDBUS_OBJECT_CHECK_RETVAL(obj, NULL);
    ...
    return eldbus_message_method_call_new(obj->name,
                                          obj->path,
                                          interface,
                                          member);
}
...
Efl_Bool
eldbus_object_proxy_del(Eldbus_Object *obj,
                        Eldbus_Proxy  *proxy,
                        const char    *interface)
{
...
EAPI Eldbus_Pending *
eldbus_object_peer_ping(Eldbus_Object    *obj,
                        Eldbus_Message_Cb cb,
                        const void       *data)
{
    Eldbus_Message *msg;
...
EAPI Eldbus_Pending *
eldbus_object_peer_machine_id_get(Eldbus_Object    *obj,
                                  Eldbus_Message_Cb cb,
                                  const void       *data)
{
    Eldbus_Message *msg;
    Eldbus_Pending *p;
    ELDBUS_OBJECT_CHECK_RETVAL(obj, NULL);
    msg = eldbus_object_method_call_new(obj,
...
EAPI Eldbus_Pending *
eldbus_object_introspect(Eldbus_Object    *obj,
                         Eldbus_Message_Cb cb,
                         const void       *data)
{
    Eldbus_Message *msg;
