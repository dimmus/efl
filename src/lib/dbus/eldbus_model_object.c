...
static void _eldbus_model_object_introspect_cb(void *,
                                               const Eldbus_Message *,
                                               Eldbus_Pending *);
static void _eldbus_model_object_create_children(Eldbus_Model_Object_Data *,
                                                 Eldbus_Object *,
                                                 Eina_List *);

static Efl_Object *
_eldbus_model_object_efl_object_constructor(Eo                       *obj,
...
static void
_eldbus_model_object_bus_set(Eo *obj                   EFL_UNUSED,
                             Eldbus_Model_Object_Data *pd,
                             const char               *bus)
{
...
static void
_eldbus_model_object_path_set(Eo *obj                   EFL_UNUSED,
                              Eldbus_Model_Object_Data *pd,
                              const char               *path)
{
...
static void
_eldbus_model_object_efl_object_invalidate(Eo                       *obj,
                                           Eldbus_Model_Object_Data *pd)
{
...
static void
_eldbus_model_object_efl_object_destructor(Eo                       *obj,
                                           Eldbus_Model_Object_Data *pd)
{
                                ...
                                const char               *path)
{
    ...
    object = eldbus_object_get(eldbus_model_connection_get(obj), bus, path);
    if (!object)
    {
   ...
   // TODO: Register for interface added/removed event
    pending = eldbus_object_introspect(object,
                                       &_eldbus_model_object_introspect_cb,
                                       pd);
...
static Eina_Future *
_eldbus_model_object_efl_model_children_slice_get(Eo *obj EFL_UNUSED,
                                                  Eldbus_Model_Object_Data *pd,
                                                  unsigned start,
                                                  unsigned count)
{
...
static unsigned int
_eldbus_model_object_efl_model_children_count_get(const Eo *obj EFL_UNUSED,
                                                  Eldbus_Model_Object_Data *pd)
{
...
static const char *
_eldbus_model_object_bus_get(const Eo *obj             EFL_UNUSED,
                             Eldbus_Model_Object_Data *pd)
{
    return pd->bus;
}
...
static const char *
_eldbus_model_object_path_get(const Eo *obj             EFL_UNUSED,
                              Eldbus_Model_Object_Data *pd)
{
    return pd->path;
}
                                      ...
                                      Eina_List                *nodes)
{
    ...
    EINA_LIST_FOREACH(nodes, it, node)
    {
        ...
        absolute_path =
            _eldbus_model_object_concatenate_path(current_path, relative_path);
...
static void
_eldbus_model_object_create_children(Eldbus_Model_Object_Data *pd,
                                     Eldbus_Object            *object,
                                     Eina_List                *interfaces)
{
    ...
    EINA_LIST_FOREACH(interfaces, l, interface)
    {
        ...
        child =
            efl_add_ref(ELDBUS_MODEL_PROXY_CLASS,
                        pd->obj,
                                   ...
                                   Eldbus_Pending       *pending)
{
    ...
    _eldbus_model_object_introspect_nodes(pd,
                                          current_path,
                                          pd->introspection->nodes);
    _eldbus_model_object_create_children(pd,
                                         object,
