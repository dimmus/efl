                 ...
                 const Efl_Dbus_Message           *msg)
{
    ...
    variant   = efl_dbus_message_iter_container_new(main_iter,
                                                  'v',
                                                  prop->property->type);
              ...
              Efl_Dbus_Message          **error_reply)
{
    ...
    EINA_ITERATOR_FOREACH(iterator, prop)
    {
        ...
        var = efl_dbus_message_iter_container_new(entry,
                                                  'v',
                                                  prop->property->type);
...
_object_free(Efl_Dbus_Service_Object *obj)
{
    ...
    */
    ...
    while (obj->children)
    {
        Efl_Dbus_Service_Object *child;
        child =
            EINA_INLIST_CONTAINER_GET(obj->children, Efl_Dbus_Service_Object);
                ...
                void                     *user_data)
{
    ...
    EINA_SAFETY_ON_NULL_RETURN_VAL(efl_dbus_msg,
