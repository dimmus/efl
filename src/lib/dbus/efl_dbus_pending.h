 ...
 */
EAPI void                  efl_dbus_pending_data_set(Efl_Dbus_Pending *pending, const char *key, const void *data) EINA_ARG_NONNULL(1, 2, 3);
 ...
 */
EAPI void                 *efl_dbus_pending_data_get(const Efl_Dbus_Pending *pending, const char *key) EINA_ARG_NONNULL(1, 2);
 ...
 * @param key A string corresponding to the key associated with the data.
 */
EAPI void                 *efl_dbus_pending_data_del(Efl_Dbus_Pending *pending, const char *key) EINA_ARG_NONNULL(1, 2);
 ...
 */
EAPI void                  efl_dbus_pending_cancel(Efl_Dbus_Pending *pending) EINA_ARG_NONNULL(1);
 ...
 */
EAPI const char           *efl_dbus_pending_destination_get(const Efl_Dbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *efl_dbus_pending_path_get(const Efl_Dbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *efl_dbus_pending_interface_get(const Efl_Dbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI const char           *efl_dbus_pending_method_get(const Efl_Dbus_Pending *pending) EINA_ARG_NONNULL(1) EFL_WARN_UNUSED_RESULT;
 ...
 */
EAPI void                  efl_dbus_pending_free_cb_add(Efl_Dbus_Pending *pending, Efl_Dbus_Free_Cb cb, const void *data) EINA_ARG_NONNULL(1, 2);
 ...
 */
EAPI void                  efl_dbus_pending_free_cb_del(Efl_Dbus_Pending *pending, Efl_Dbus_Free_Cb cb, const void *data) EINA_ARG_NONNULL(1, 2);
