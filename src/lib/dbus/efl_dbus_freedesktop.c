...
efl_dbus_name_request(Efl_Dbus_Connection *conn,
                      const char          *name,
                      unsigned int         flags,
...
EAPI Efl_Dbus_Pending *
efl_dbus_name_release(Efl_Dbus_Connection *conn,
                      const char          *name,
                      Efl_Dbus_Message_Cb  cb,
                      const void          *cb_data)
{
...
EAPI Efl_Dbus_Pending *
efl_dbus_name_owner_get(Efl_Dbus_Connection *conn,
                        const char          *name,
                        Efl_Dbus_Message_Cb  cb,
                        const void          *cb_data)
{
...
EAPI Efl_Dbus_Pending *
efl_dbus_name_owner_has(Efl_Dbus_Connection *conn,
                        const char          *name,
                        Efl_Dbus_Message_Cb  cb,
                        const void          *cb_data)
{
...
EAPI Efl_Dbus_Pending *
efl_dbus_names_list(Efl_Dbus_Connection *conn,
                    Efl_Dbus_Message_Cb  cb,
                    const void          *cb_data)
{
    EINA_SAFETY_ON_NULL_RETURN_VAL(conn, NULL);
...
EAPI Efl_Dbus_Pending *
efl_dbus_name_start(Efl_Dbus_Connection *conn,
                    const char          *name,
                    unsigned int         flags,
                    Efl_Dbus_Message_Cb  cb,
                    const void          *cb_data)
...
EAPI Efl_Dbus_Pending *
efl_dbus_hello(Efl_Dbus_Connection *conn,
               Efl_Dbus_Message_Cb  cb,
               const void          *cb_data)
{
    EINA_SAFETY_ON_NULL_RETURN_VAL(conn, NULL);
