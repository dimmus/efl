...
static Efl_Object *
_eldbus_model_signal_efl_object_constructor(Eo                       *obj,
...
static void
_eldbus_model_signal_signal_constructor(
    Eo *obj                            EFL_UNUSED,
    Eldbus_Model_Signal_Data          *pd,
    Eldbus_Proxy                      *proxy,
    const Eldbus_Introspection_Signal *signal)
{
    ...
    eldbus_model_arguments_custom_constructor(efl_super(obj, MY_CLASS),
                                              proxy,
                                              signal->name,
                                              signal->arguments);
...
static void
_eldbus_model_signal_efl_object_invalidate(Eo                       *obj,
                                           Eldbus_Model_Signal_Data *pd)
{
...
_eldbus_model_signal_callback_add(Eldbus_Model_Signal_Data *pd)
{
    ...
    pd->handler =
        eldbus_proxy_signal_handler_add(args_data->proxy,
                                        pd->signal->name,
                                        _eldbus_model_signal_handler_cb,
                                        pd);
}
