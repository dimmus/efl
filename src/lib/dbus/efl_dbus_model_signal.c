...
static Efl_Object *
_efl_dbus_model_signal_efl_object_constructor(Eo                         *obj,
...
static void
_efl_dbus_model_signal_signal_constructor(
  Eo *obj                              EFL_UNUSED,
  Efl_Dbus_Model_Signal_Data          *pd,
  ...
  const Efl_Dbus_Introspection_Signal *signal)
{
  ...
  efl_dbus_model_arguments_custom_constructor(efl_super(obj, MY_CLASS),
                                              proxy,
                                              signal->name,
                                              signal->arguments);
...
static void
_efl_dbus_model_signal_efl_object_invalidate(Eo                         *obj,
                                             Efl_Dbus_Model_Signal_Data *pd)
{
...
_efl_dbus_model_signal_callback_add(Efl_Dbus_Model_Signal_Data *pd)
{
  ...
  pd->handler =
    efl_dbus_proxy_signal_handler_add(args_data->proxy,
                                      pd->signal->name,
                                      _efl_dbus_model_signal_handler_cb,
                                      pd);
}
