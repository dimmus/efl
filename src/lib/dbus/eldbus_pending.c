...
static void eldbus_pending_dispatch(Eldbus_Pending *pending,
                                    Eldbus_Message *msg);
...
cb_pending(DBusPendingCall *dbus_pending, void *user_data)
{
    ...
    msg = eldbus_message_new(EFL_FALSE);
...
EAPI Eldbus_Pending *
eldbus_connection_send(Eldbus_Connection *conn,
                       Eldbus_Message    *msg,
                       ...
                       double             timeout)
{
    ...
    pending = _eldbus_connection_send(conn,
                                      msg,
                                      _on_conn_message_cb,
                                      cb_data,
                                      timeout);
...
_eldbus_message_error_get(const Eldbus_Message *msg,
 ...
 */
Eldbus_Pending *
_eldbus_connection_send(Eldbus_Connection *conn,
                        Eldbus_Message    *msg,
                        Eldbus_Message_Cb  cb,
                        const void        *cb_data,
                        double             timeout)
{
   ...
   /* Steal the reference */
    ...
    {
        error_msg = _eldbus_message_error_get(msg,
    ...
    error_msg =
        _eldbus_message_error_get(pending->msg_sent,
                                  "org.enlightenment.DBus.Error",
...
Eldbus_Message *
_eldbus_connection_send_and_block(Eldbus_Connection *conn,
                                  Eldbus_Message    *msg,
                                  double             timeout)
{
...
EAPI void
eldbus_pending_data_set(Eldbus_Pending *pending,
                        const char     *key,
                        const void     *data)
{
...
EAPI void
eldbus_pending_free_cb_add(Eldbus_Pending *pending,
                           Eldbus_Free_Cb  cb,
                           const void     *data)
{
    ELDBUS_PENDING_CHECK(pending);
...
EAPI void
eldbus_pending_free_cb_del(Eldbus_Pending *pending,
                           Eldbus_Free_Cb  cb,
                           const void     *data)
{
    ELDBUS_PENDING_CHECK(pending);
