...
static void efl_dbus_pending_dispatch(Efl_Dbus_Pending *pending, Efl_Dbus_Message *msg);
...
static void
_on_conn_message_cb(void *data, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending)
{
   Efl_Dbus_Message_Cb cb = efl_dbus_pending_data_del(pending, "__user_cb");
   Efl_Dbus_Connection *conn = efl_dbus_pending_data_del(pending, "__connection");
...
efl_dbus_connection_send(Efl_Dbus_Connection *conn, Efl_Dbus_Message *msg, Efl_Dbus_Message_Cb cb, const void *cb_data, double timeout)
{
   ...
   pending = _efl_dbus_connection_send(conn, msg, _on_conn_message_cb, cb_data,
                                     timeout);
...
_efl_dbus_message_error_get(const Efl_Dbus_Message *msg, const char *error_name, const char *error_msg)
{
   int32_t serial;
 ...
 */
Efl_Dbus_Pending *
_efl_dbus_connection_send(Efl_Dbus_Connection *conn, Efl_Dbus_Message *msg, Efl_Dbus_Message_Cb cb, const void *cb_data, double timeout)
{
   Efl_Dbus_Pending *pending;
   ...
   if (!dbus_connection_send_with_reply(conn->dbus_conn,
     ...
     {
        error_msg = _efl_dbus_message_error_get(msg, "org.enlightenment.DBus.NoConnection",
   ...
   if (!pending->dbus_pending)
     {
        error_msg = _efl_dbus_message_error_get(msg, "org.enlightenment.DBus.Error",
   ...
   error_msg = _efl_dbus_message_error_get(pending->msg_sent,
...
Efl_Dbus_Message *
_efl_dbus_connection_send_and_block(Efl_Dbus_Connection *conn, Efl_Dbus_Message *msg, double timeout)
{
...
EAPI void
efl_dbus_pending_data_set(Efl_Dbus_Pending *pending, const char *key, const void *data)
{
...
EAPI void
efl_dbus_pending_free_cb_add(Efl_Dbus_Pending *pending, Efl_Dbus_Free_Cb cb, const void *data)
{
   EFL_DBUS_PENDING_CHECK(pending);
...
EAPI void
efl_dbus_pending_free_cb_del(Efl_Dbus_Pending *pending, Efl_Dbus_Free_Cb cb, const void *data)
{
   EFL_DBUS_PENDING_CHECK(pending);
   EINA_SAFETY_ON_NULL_RETURN(cb);
