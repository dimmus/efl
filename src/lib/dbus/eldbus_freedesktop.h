 ...
 */
EAPI void                  eldbus_name_owner_changed_callback_add(Eldbus_Connection *conn, const char *bus, Eldbus_Name_Owner_Changed_Cb cb, const void *cb_data, Efl_Bool allow_initial_call) EINA_ARG_NONNULL(1, 2, 3);
/**
 ...
 */
EAPI Efl_Bool eldbus_proxy_properties_monitor(Eldbus_Proxy *proxy, Efl_Bool enable) EINA_ARG_NONNULL(1);
