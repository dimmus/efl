              ...
              Eldbus_Message_Iter *iter)
{
    ...
    Efl_Bool ok = eldbus_message_iter_arguments_append(iter, type, &array);
        ...
        case '(':
            {
                ...
                for (i = 0; i < eina_value_array_count(value_array); i++)
                {
                    ...
                    eldbus_message_iter_arguments_append(array,
                                                         type + 1,
                                                         &entry);
...
EAPI Efl_Bool
eldbus_message_from_eina_value(const char       *signature,
                               Eldbus_Message   *msg,
                               const Eina_Value *value)
{
    Eldbus_Message_Iter *iter;
