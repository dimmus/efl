...
static void _efl_dbus_model_connection_names_list_cb(void *,
                                                     const Efl_Dbus_Message *,
                                                     Efl_Dbus_Pending *);

static Efl_Object *
_efl_dbus_model_connection_efl_object_constructor(
  Eo                             *obj,
...
static void
_efl_dbus_model_connection_efl_object_invalidate(
  Eo                             *obj,
  Efl_Dbus_Model_Connection_Data *pd)
{
...
static Eina_Future *
_efl_dbus_model_connection_efl_model_children_slice_get(
  Eo                             *obj,
  Efl_Dbus_Model_Connection_Data *pd,
  unsigned int                    start,
  unsigned int                    count)
...
static unsigned int
_efl_dbus_model_connection_efl_model_children_count_get(
  const Eo                       *obj,
  Efl_Dbus_Model_Connection_Data *pd)
{
  _efl_dbus_model_children_list(obj, pd);
                                         ...
                                         Efl_Dbus_Pending *pending EFL_UNUSED)
{
  ...
  while (efl_dbus_message_iter_get_and_next(array, 's', &bus))
  {
    ...
    child = efl_add(EFL_DBUS_MODEL_OBJECT_CLASS,
                    pd->obj,
