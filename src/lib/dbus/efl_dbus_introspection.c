...
typedef struct _Efl_Dbus_Introspection_Element_Parse_Table Efl_Dbus_Introspection_Element_Parse_Table;
...
static const char *_efl_dbus_introspection_attribute_value_get(Eina_Inlist *, const char *);
static void *_efl_dbus_introspection_parse_node(Eina_Simple_XML_Node_Tag *);
static void *_efl_dbus_introspection_parse_interface(Eina_Simple_XML_Node_Tag *);
...
static void *_efl_dbus_introspection_parse_annotation(Eina_Simple_XML_Node_Tag *);
static void _efl_dbus_introspection_parse_children(Eina_Inlist *, const Efl_Dbus_Introspection_Element_Parse_Table[]);
static void _efl_dbus_introspection_interface_free(Efl_Dbus_Introspection_Interface *);
static void _efl_dbus_introspection_method_free(Efl_Dbus_Introspection_Method *);
static void _efl_dbus_introspection_signal_free(Efl_Dbus_Introspection_Signal *);
static void _efl_dbus_introspection_argument_free(Efl_Dbus_Introspection_Argument *);
static void _efl_dbus_introspection_property_free(Efl_Dbus_Introspection_Property *);
static void _efl_dbus_introspection_annotation_free(Efl_Dbus_Introspection_Annotation *);
...
efl_dbus_introspection_parse(const char *xml)
{
   ...
   node = (Efl_Dbus_Introspection_Node*)_efl_dbus_introspection_parse_node((Eina_Simple_XML_Node_Tag*)xml_node);
...
static const char *
_efl_dbus_introspection_attribute_value_get(Eina_Inlist *attributes, const char *key)
{
...
static void
_efl_dbus_introspection_interface_free(Efl_Dbus_Introspection_Interface *interface)
{
...
_efl_dbus_introspection_parse_argument(Eina_Simple_XML_Node_Tag *tag)
{
   ...
   direction = _efl_dbus_introspection_attribute_value_get(tag->attributes, "direction");
   if (direction)
     {
...
_efl_dbus_introspection_parse_property(Eina_Simple_XML_Node_Tag *tag)
{
   ...
   access = _efl_dbus_introspection_attribute_value_get(tag->attributes, "access");
...
static void
_efl_dbus_introspection_annotation_free(Efl_Dbus_Introspection_Annotation *annotation)
{
...
static void
_efl_dbus_introspection_parse_children(Eina_Inlist *children, const Efl_Dbus_Introspection_Element_Parse_Table table[])
{
