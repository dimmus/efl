...
static void
_eldbus_model_arguments_properties_load(Eldbus_Model_Arguments_Data *);
static void _eldbus_model_arguments_unload(Eldbus_Model_Arguments_Data *);
static Efl_Bool
_eldbus_model_arguments_is_input_argument(Eldbus_Model_Arguments_Data *,
                                          const char *);
static Efl_Bool
_eldbus_model_arguments_is_output_argument(Eldbus_Model_Arguments_Data *,
                                           const char *);
static Efl_Bool
_eldbus_model_arguments_property_set(Eldbus_Model_Arguments_Data *,
                                     Eina_Value *,
                                     const char *);
static unsigned int
_eldbus_model_arguments_argument_index_get(Eldbus_Model_Arguments_Data *,
                                           const char *);
...
static Efl_Object *
_eldbus_model_arguments_efl_object_constructor(Eo                          *obj,
                                               Eldbus_Model_Arguments_Data *pd)
{
    ...
    pd->properties = eina_hash_string_superfast_new(
        EINA_FREE_CB(_eldbus_model_arguments_hash_free));
...
static void
_eldbus_model_arguments_custom_constructor(Eo *obj EFL_UNUSED,
                                           Eldbus_Model_Arguments_Data *pd,
                                           Eldbus_Proxy                *proxy,
                                           const char                  *name,
...
_eldbus_model_arguments_efl_model_properties_get(
...
static Eina_Value *
_eldbus_model_arguments_efl_model_property_get(const Eo                    *obj,
                                               Eldbus_Model_Arguments_Data *pd,
                                               const char *property)
{
    Eina_Value *value;
...
static const char *
_eldbus_model_arguments_arg_name_get(const Eo *obj                EFL_UNUSED,
                                     Eldbus_Model_Arguments_Data *pd)
{
    return pd->name;
}
                                         ...
                                         Eldbus_Pending              *pending)
{
    ...
    EINA_LIST_FOREACH(pd->arguments, it, argument)
    {
        if (ELDBUS_INTROSPECTION_ARGUMENT_DIRECTION_IN != argument->direction)
        {
            ...
            ret = _eldbus_model_arguments_property_set(pd,
                                                       value_struct,
                                                       property);
            EINA_SAFETY_ON_FALSE_GOTO(ret, on_error);
        }
    ...
    {
        Efl_Model_Property_Event evt = { .changed_properties =
                                             changed_properties };
...
static Efl_Bool
_eldbus_model_arguments_is_input_argument(Eldbus_Model_Arguments_Data *pd,
                                          const char                  *argument)
{
    return _eldbus_model_arguments_is(
        pd,
        argument,
...
static Efl_Bool
_eldbus_model_arguments_is_output_argument(Eldbus_Model_Arguments_Data *pd,
                                           const char *argument)
{
    return _eldbus_model_arguments_is(
               pd,
...
static unsigned int
_eldbus_model_arguments_argument_index_get(Eldbus_Model_Arguments_Data *pd,
                                           const char *argument)
{
    unsigned int i = 0;
