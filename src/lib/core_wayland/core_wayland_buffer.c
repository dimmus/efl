...
// static struct exynos_bo *(*sym_exynos_bo_create)(struct exynos_device *dev,
//                                                  size_t                size,
//                                                  uint32_t flags) = NULL;
...
_intel_alloc(Buffer_Manager *self,
             const char     *name,
             int             w,
             int             h,
             unsigned long  *stride,
...
#if 0
static Buffer_Handle *
_exynos_alloc(Buffer_Manager  *self,
              const char *name EFL_UNUSED,
              int              w,
              int              h,
              unsigned long   *stride,
              int32_t         *fd)
...
_exynos_buffer_manager_setup(int fd)
{
    ...
    if (!drm_exynos_lib) return EFL_FALSE;
...
#endif
static Buffer_Handle *
_wl_shm_alloc(Buffer_Manager *self EFL_UNUSED,
              const char *name     EFL_UNUSED,
              int                  w,
              int                  h,
              unsigned long       *stride,
...
static Buffer_Handle *
_vc4_alloc(Buffer_Manager *self EFL_UNUSED,
           const char *name     EFL_UNUSED,
           int                  w,
           int                  h,
           unsigned long       *stride,
...
static Buffer_Handle *
_buffer_manager_alloc(const char    *name,
                      int            w,
                      int            h,
                      unsigned long *stride,
                      int32_t       *fd)
...
static void
_create_succeeded(void *data                         EFL_UNUSED,
