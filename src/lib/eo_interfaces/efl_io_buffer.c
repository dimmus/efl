...
_efl_io_buffer_limit_set(Eo *o, Efl_Io_Buffer_Data *pd, size_t limit)
{
    ...
    efl_io_writer_can_write_set(
        o,
        (limit == 0) || (efl_io_buffer_position_write_get(o) < limit));
}
...
_efl_io_buffer_binbuf_steal(Eo *o, Efl_Io_Buffer_Data *pd)
{
    ...
    ret =
        eina_binbuf_manage_new(pd->bytes, efl_io_sizer_size_get(o), EFL_FALSE);
                                  ...
                                  uint64_t            position)
{
    ...
    efl_event_callback_call(o,
                            EFL_IO_BUFFER_EVENT_POSITION_WRITE_CHANGED,
                            NULL);
    if (changed)
        efl_event_callback_call(o,
                                EFL_IO_POSITIONER_EVENT_POSITION_CHANGED,
