...
_efl_gfx_property_get(const Eo *obj, Efl_Gfx_Property *property)
{
    ...
    efl_gfx_shape_stroke_color_get(obj,
                                   &property->r,
                                   &property->g,
                                   &property->b,
                                   &property->a);
...
_efl_gfx_shape_efl_gfx_path_interpolate(Eo                 *obj,
                                        ...
                                        double              pos_map)
{
   ...
   //Can be interpolated!
    ...
    efl_gfx_shape_stroke_color_set(
        obj,
    ...
    interv =
        interpolate(property_from.miterlimit, property_to.miterlimit, pos_map);
    efl_gfx_shape_stroke_miterlimit_set(obj, interv);

    efl_gfx_shape_stroke_dash_set(obj, dash, property_to.dash_length);
    efl_gfx_shape_stroke_cap_set(obj,
                                 (pos_map < 0.5) ? property_from.c
                                                 : property_to.c);
    efl_gfx_shape_stroke_join_set(obj,
                                  (pos_map < 0.5) ? property_from.j
                                                  : property_to.j);
...
EOLIAN static void
_efl_gfx_shape_stroke_scale_set(Eo *obj             EFL_UNUSED,
                                Efl_Gfx_Shape_Data *pd,
                                double              s)
{
...
_efl_gfx_shape_stroke_scale_get(const Eo *obj       EFL_UNUSED,
                                Efl_Gfx_Shape_Data *pd)
{
...
EOLIAN static void
_efl_gfx_shape_stroke_color_set(Eo *obj             EFL_UNUSED,
                                Efl_Gfx_Shape_Data *pd,
                                int                 r,
                                int                 g,
                                int                 b,
                                int                 a)
{
    ...
    if (err) ERR("Only handles premultiplied colors (0 <= R,G,B <= A <= 255)");
...
EOLIAN static void
_efl_gfx_shape_stroke_color_get(const Eo *obj       EFL_UNUSED,
                                Efl_Gfx_Shape_Data *pd,
                                int                *r,
                                int                *g,
                                int                *b,
...
EOLIAN static void
_efl_gfx_shape_stroke_width_set(Eo *obj             EFL_UNUSED,
                                Efl_Gfx_Shape_Data *pd,
                                double              w)
{
...
EOLIAN static void
_efl_gfx_shape_stroke_location_set(Eo *obj             EFL_UNUSED,
                                   Efl_Gfx_Shape_Data *pd,
                                   double              centered)
{
...
EOLIAN static double
_efl_gfx_shape_stroke_location_get(const Eo *obj       EFL_UNUSED,
                                   Efl_Gfx_Shape_Data *pd)
{
...
EOLIAN static void
_efl_gfx_shape_stroke_dash_set(Eo *obj             EFL_UNUSED,
                               Efl_Gfx_Shape_Data *pd,
                               const Efl_Gfx_Dash *dash,
                               unsigned int        length)
{
...
_efl_gfx_shape_stroke_cap_get(const Eo *obj EFL_UNUSED, Efl_Gfx_Shape_Data *pd)
{
...
_efl_gfx_shape_stroke_join_get(const Eo *obj EFL_UNUSED, Efl_Gfx_Shape_Data *pd)
{
...
_efl_gfx_shape_fill_rule_get(const Eo *obj EFL_UNUSED, Efl_Gfx_Shape_Data *pd)
{
    return pd->fill_rule;
}

EOLIAN static void
_efl_gfx_shape_efl_gfx_path_copy_from(Eo                 *obj,
                                      Efl_Gfx_Shape_Data *pd,
                                      const Eo           *dup_from)
{
    ...
    _efl_gfx_shape_stroke_dash_set(obj,
                                   pd,
                                   from->public.stroke.dash,
