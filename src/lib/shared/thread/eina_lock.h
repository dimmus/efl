 ...
 * @see eina_lock_free()
 */
static inline Efl_Bool eina_lock_new(Eina_Lock *mutex);
 ...
 * @since 1.19
 */
static inline Efl_Bool eina_lock_recursive_new(Eina_Lock *mutex);
 ...
 */
static inline Efl_Bool eina_condition_wait(Eina_Condition *cond);
 ...
 *
 * @return #EFL_TRUE on success, #EFL_FALSE otherwise. If the operation
 *         timed out, eina error will be set to @c ETIMEDOUT.
 *
 * @see eina_condition_wait()
 */
static inline Efl_Bool eina_condition_timedwait(Eina_Condition *cond, double t);
 ...
 */
static inline Efl_Bool eina_condition_broadcast(Eina_Condition *cond);
 ...
 */
static inline Efl_Bool eina_rwlock_new(Eina_RWLock *mutex);
 ...
 * @see eina_tls_free()
 */
static inline Efl_Bool eina_tls_new(Eina_TLS *key);
 ...
 * @see eina_tls_get()
 */
static inline Efl_Bool eina_tls_set(Eina_TLS key, const void *data);
 ...
 */
static inline Efl_Bool eina_semaphore_new(Eina_Semaphore *sem, int count_init);
 ...
 */
static inline Efl_Bool eina_semaphore_free(Eina_Semaphore *sem);
 ...
 */
static inline Efl_Bool eina_semaphore_lock(Eina_Semaphore *sem);
 ...
 */
static inline Efl_Bool eina_barrier_new(Eina_Barrier *barrier, int needed);
 ...
 *
 * @return #EFL_TRUE on success, else #EFL_FALSE otherwise.
 *
 */
 ...
 */
static inline Efl_Bool eina_spinlock_new(Eina_Spinlock *spinlock);
