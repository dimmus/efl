...
EINA_API Eina_Cow *eina_cow_add(const char  *name,
                                ...
                                Efl_Bool     gc) EFL_WARN_UNUSED_RESULT;
...
eina_cow_alloc(Eina_Cow *cow) EFL_WARN_UNUSED_RESULT;
 ...
 * @return EFL_TRUE if something was compacted, EFL_FALSE if nothing was.
 *
 ...
 */
EINA_API Efl_Bool eina_cow_gc(Eina_Cow *cow);
