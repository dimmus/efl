...
static Efl_Bool
_eina_file_win32_direct_ls_iterator_next(Eina_File_Direct_Iterator *it,
                                         void                     **data)
{
#ifdef UNICODE
    wchar_t *old_name;
...
EINA_API void
eina_file_map_populate(Eina_File *file          EFL_UNUSED,
                       Eina_File_Populate rule  EFL_UNUSED,
                       const void *map          EFL_UNUSED,
                       unsigned long int offset EFL_UNUSED,
                       unsigned long int length EFL_UNUSED)
{}
...
EINA_API int
eina_file_statat(void *container        EFL_UNUSED,
                 Eina_File_Direct_Info *info,
                 Eina_Stat             *st)
{
    struct __stat64 buf;
