 ...
 *
 * @return #EFL_TRUE if the @p level should be logged, else #EFL_FALSE.
 *
 * @see eina_log_level_set()
 */
static inline Efl_Bool eina_log_level_check(int level);

/**
 * @brief Checks if current thread is the main thread.
 *
 * If there is no thread support (compiled with --disable-pthreads) or
 * threads were not enabled, then #EFL_TRUE is returned. The only case where
 * #EFL_FALSE is returned is when threads were successfully enabled but the
 ...
 *
 * @param[in] disabled If #EFL_TRUE, color logging should be disabled.
 *
 ...
 *
 * @return If #EFL_TRUE, color logging is disabled.
 *
 ...
 *
 * @param[in] disabled If #EFL_TRUE, file name logging should be disabled.
 *
 ...
 *
 * @return If #EFL_TRUE, file name logging should be disabled.
 *
 ...
 *
 * @param[in] disabled If #EFL_TRUE, function name logging should be disabled.
 *
 ...
 *
 * @return If #EFL_TRUE, function name logging should be disabled.
 *
 ...
 *
 * @param[in] abort_on_critical If #EFL_TRUE, messages with level equal
 ...
 *
 * @return If #EFL_TRUE, any messages with level equal or smaller
 ...
 *        eina_log_abort_on_critical_get() returns #EFL_TRUE.
 *
