...
// get evlog
static Efl_Bool
_get_cb(Eina_Debug_Session *session EFL_UNUSED,
        int cid                     EFL_UNUSED,
        ...
        int size                    EFL_UNUSED)
{
    ...
    eina_debug_session_send(session,
                            cid,
                            _evlog_get_opcode,
                            resp_buf,
                            resp_size);
...
// enable evlog
static Efl_Bool
_start_cb(Eina_Debug_Session *session EFL_UNUSED,
          int cid                     EFL_UNUSED,
          void *buffer                EFL_UNUSED,
          int size                    EFL_UNUSED)
{
...
// stop evlog
static Efl_Bool
_stop_cb(Eina_Debug_Session *session EFL_UNUSED,
         int cid                     EFL_UNUSED,
         void *buffer                EFL_UNUSED,
         int size                    EFL_UNUSED)
{
...
eina_evlog_init(void)
{
...
#if defined(HAVE_CLOCK_GETTIME)
    {
        ...
        else _eina_evlog_time_clock_id = CLOCK_REALTIME;
    }
#endif
