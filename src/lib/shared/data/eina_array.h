 ...
 * @return #EFL_TRUE on success, #EFL_FALSE if allocation is necessary
 ...
 * @return EFL_TRUE if found otherwise returns EFL_FALSE.
 *
 * This function searches for the data pointer @p data inside @p array, returning @c EFL_TRUE if found.
 ...
 * @return #EFL_TRUE if it successfully iterated all items of the array.
 *
 * This function iterates over an array in order, calling @p cb for each
 * item.  @p cb should return #EFL_TRUE if the loop should continue, or
