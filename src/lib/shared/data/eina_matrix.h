 ...
 * @return @c EFL_TRUE if the two matrices are equal, @c EFL_FALSE otherwise.
 *
 * This function returns @c EFL_TRUE if the matrices @p m1 and @p m2
 * are equal, @c EFL_FALSE otherwise. No check is done on the matrices.
 *
 * @since 1.14
 */
EINA_API Efl_Bool eina_matrix3_equal(const Eina_Matrix3 *m1,
 ...
 * @return @c EFL_TRUE if matrix could be successfully created, @c EFL_FALSE otherwise.
 *
 ...
 */
EINA_API Efl_Bool eina_matrix3_quad_quad_map(Eina_Matrix3    *m,
                                             const Eina_Quad *src,
                                             const Eina_Quad *dst);
 ...
 * @since 1.14
 */
EINA_API Efl_Bool eina_matrix3_square_quad_map(Eina_Matrix3    *m,
                                               const Eina_Quad *q);
 ...
 * @param[out] m The transformation matrix to create.
 * @param[in] q The source quadrangle.
 * @return @c EFL_FALSE on successful transform creation, @c EFL_FALSE otherwise.
 *
 ...
 * @since 1.14
 */
EINA_API Efl_Bool eina_matrix3_quad_square_map(Eina_Matrix3    *m,
                                               const Eina_Quad *q);
 ...
 * @return @c EFL_FALSE if matrix could not be normalized, @c EFL_TRUE
 * otherwise.
 *
 ...
 * @since 1.16
 */
EINA_API Efl_Bool eina_matrix4_normalized(Eina_Matrix4       *out,
 ...
 * @param[in] in The matrix.
 * @return @c EFL_TRUE on success, @c EFL_FALSE otherwise.
 *
 * This function inverts the matrix @p in and stores the result in
 * @p out.  No check is done on @p in or @p out.  If @p in cannot be
 * inverted, then @c EFL_FALSE is returned.
 *
 * @since 1.16
 */
EINA_API Efl_Bool eina_matrix4_inverse(Eina_Matrix4       *out,
                                       const Eina_Matrix4 *in);
 ...
 * @since 1.17
 */
EINA_API void eina_matrix4_multiply(Eina_Matrix4       *out,
                                    const Eina_Matrix4 *mat_a,
                                    const Eina_Matrix4 *mat_b);
