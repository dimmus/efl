 ...
 * causes no error, it does return #EFL_FALSE, to notify it was not possible
 ...
 * types and return #EFL_FALSE in those cases, we omit this here for brevity.
 *
 ...
 *
 * On failure, #EFL_FALSE is returned.
 *
 * @see eina_value_flush()
 *
 * @since 1.2
 ...
 * @return #EFL_TRUE if converted, #EFL_FALSE otherwise.
 *
 ...
 *
 * @param[in] type Type reference.
 * @return #EFL_TRUE if valid, #EFL_FALSE otherwise.
 *
 ...
 * @param[out] is_empty #EFL_TRUE if optional is empty, #EFL_FALSE otherwise.
 * @return #EFL_TRUE on success, #EFL_FALSE otherwise.
 *
 * @since 1.17
 */
