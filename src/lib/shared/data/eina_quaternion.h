...
EINA_API void        eina_quaternion_f16p16_set(Eina_Quaternion *out,
                                                ...
                                                Eina_F16p16      y,
                                                Eina_F16p16      z,
                                                Eina_F16p16 w); /**< @since 1.15 */
EINA_API Eina_F16p16 eina_quaternion_f16p16_norm(
  const Eina_Quaternion_F16p16 *q); /**< @since 1.15 */
EINA_API void eina_quaternion_f16p16_negative(
  Eina_Quaternion_F16p16       *out,
...
EINA_API void eina_quaternion_f16p16_conjugate(
  Eina_Quaternion_F16p16       *out,
  const Eina_Quaternion_F16p16 *in); /**< @since 1.15 */
...
EINA_API void eina_quaternion_f16p16_nlerp(Eina_Quaternion_F16p16       *out,
                                           ...
                                           const Eina_Quaternion_F16p16 *b,
                                           Eina_F16p16 pos); /**< @since 1.15 */
EINA_API void eina_quaternion_f16p16_rotate(
  Eina_Point_3D_F16p16         *p,
  const Eina_Point_3D_F16p16   *center,
  const Eina_Quaternion_F16p16 *q); /**< @since 1.15 */
EINA_API void eina_quaternion_f16p16_rotation_matrix3_get(
  Eina_Matrix3_F16p16          *m,
  const Eina_Quaternion_F16p16 *q); /**< @since 1.15 */

EINA_API void
eina_quaternion_set(Eina_Quaternion *q, double x, double y, double z, double w);
EINA_API double
eina_quaternion_norm(const Eina_Quaternion *q); /**< @since 1.15 */
EINA_API void
...
EINA_API void eina_quaternion_rotation_matrix3_get(
  Eina_Matrix3          *m,
  const Eina_Quaternion *q); /**< @since 1.15 */
EINA_API void
