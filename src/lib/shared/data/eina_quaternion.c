...
eina_quaternion_f16p16_norm(const Eina_Quaternion_F16p16 *q)
{
  ...
  s = eina_f16p16_add(
    eina_f16p16_add(eina_f16p16_mul(q->w, q->w), eina_f16p16_mul(q->x, q->x)),
    eina_f16p16_add(eina_f16p16_mul(q->y, q->y), eina_f16p16_mul(q->z, q->z)));
...
eina_quaternion_f16p16_mul(Eina_Quaternion_F16p16       *out,
                           ...
                           const Eina_Quaternion_F16p16 *b)
{
  out->w = eina_f16p16_sub(
    eina_f16p16_sub(eina_f16p16_mul(a->w, b->w), eina_f16p16_mul(a->x, b->x)),
    eina_f16p16_sub(eina_f16p16_mul(a->y, b->y), eina_f16p16_mul(a->z, b->z)));
  out->x = eina_f16p16_add(
    eina_f16p16_add(eina_f16p16_mul(a->w, b->x), eina_f16p16_mul(a->x, b->w)),
    eina_f16p16_sub(eina_f16p16_mul(a->y, b->z), eina_f16p16_mul(a->z, b->y)));
  out->y = eina_f16p16_add(
    eina_f16p16_sub(eina_f16p16_mul(a->w, b->y), eina_f16p16_mul(a->x, b->z)),
    eina_f16p16_add(eina_f16p16_mul(a->y, b->w), eina_f16p16_mul(a->z, b->x)));
  out->z = eina_f16p16_add(
    eina_f16p16_add(eina_f16p16_mul(a->w, b->z), eina_f16p16_mul(a->x, b->y)),
    eina_f16p16_sub(eina_f16p16_mul(a->z, b->w), eina_f16p16_mul(a->y, b->x)));
}
...
eina_quaternion_f16p16_dot(const Eina_Quaternion_F16p16 *a,
                           const Eina_Quaternion_F16p16 *b)
{
  return eina_f16p16_add(
    eina_f16p16_add(eina_f16p16_mul(a->w, b->w), eina_f16p16_mul(a->x, b->x)),
    eina_f16p16_add(eina_f16p16_mul(a->y, b->y), eina_f16p16_mul(a->z, b->z)));
}
                                  ...
                                  const Eina_Quaternion_F16p16 *in)
{
  ...
  eina_quaternion_f16p16_scale(out,
                               in,
                               eina_f16p16_div(eina_f16p16_int_from(1), norm));
}
                            ...
                            Eina_F16p16                   pos)
{
  ...
  out->w =
    eina_f16p16_add(a->w, eina_f16p16_mul(eina_f16p16_sub(b->w, a->w), pos));
  out->x =
    eina_f16p16_add(a->x, eina_f16p16_mul(eina_f16p16_sub(b->x, a->x), pos));
  out->y =
    eina_f16p16_add(a->y, eina_f16p16_mul(eina_f16p16_sub(b->y, a->y), pos));
  out->z =
    eina_f16p16_add(a->z, eina_f16p16_mul(eina_f16p16_sub(b->z, a->z), pos));
}
                             ...
                             Eina_F16p16                   pos)
{
  ...
  pos2 = pos;
  if (eina_f16p16_sub(eina_f16p16_int_from(1), dot) >
      eina_f16p16_float_from(0.0000001))
  {
    Eina_F32p32 angle;
    Eina_F16p16 sangle;
    ...
    {
      pos1 = eina_f32p32_to_f16p16(eina_f32p32_div(
        eina_f32p32_sin(eina_f32p32_mul(eina_f16p16_to_f32p32(pos1), angle)),
        eina_f16p16_to_f32p32(sangle)));
      pos2 = eina_f32p32_to_f16p16(eina_f32p32_div(
        eina_f32p32_sin(eina_f32p32_mul(eina_f16p16_to_f32p32(pos2), angle)),
        eina_f16p16_to_f32p32(sangle)));
    }
  }
                             ...
                             Eina_F16p16                   pos)
{
  ...
  eina_quaternion_f16p16_scale(&left,
                               a,
                              ...
                              const Eina_Quaternion_F16p16 *q)
{
  ...
  uvx = eina_f16p16_sub(eina_f16p16_mul(q->y, z), eina_f16p16_mul(q->z, y));
  uvy = eina_f16p16_sub(eina_f16p16_mul(q->z, x), eina_f16p16_mul(q->x, z));
  uvz = eina_f16p16_sub(eina_f16p16_mul(q->x, y), eina_f16p16_mul(q->y, x));

  uuvx =
    eina_f16p16_sub(eina_f16p16_mul(q->y, uvz), eina_f16p16_mul(q->z, uvy));
  uuvy =
    eina_f16p16_sub(eina_f16p16_mul(q->z, uvx), eina_f16p16_mul(q->x, uvz));
  uuvz =
    eina_f16p16_sub(eina_f16p16_mul(q->x, uvy), eina_f16p16_mul(q->y, uvx));
  ...
  p->x =
    eina_f16p16_add(eina_f16p16_add(center->x, x), eina_f16p16_add(uvx, uuvx));
  p->y =
    eina_f16p16_add(eina_f16p16_add(center->y, y), eina_f16p16_add(uvy, uuvy));
  p->z =
    eina_f16p16_add(eina_f16p16_add(center->z, z), eina_f16p16_add(uvz, uuvz));
}
                                            ...
                                            const Eina_Quaternion_F16p16 *q)
{
  ...
  m->xx = eina_f16p16_sub(eina_f16p16_int_to(1), eina_f16p16_add(yy, zz));
  m->xy = eina_f16p16_add(xy, wz);
  m->xz = eina_f16p16_sub(xz, wy);
  m->yx = eina_f16p16_sub(xy, wz);
  m->yy = eina_f16p16_sub(eina_f16p16_int_to(1), eina_f16p16_add(xx, zz));
  m->yz = eina_f16p16_add(yz, wx);
  m->zx = eina_f16p16_add(xz, wy);
  m->zy = eina_f16p16_add(yz, wx);
  m->zz = eina_f16p16_sub(eina_f16p16_int_to(1), eina_f16p16_add(xx, yy));
}

EINA_API void
eina_quaternion_set(Eina_Quaternion *out,
                    double           x,
                    double           y,
                    double           z,
                    double           w)
...
EINA_API void
eina_quaternion_negative(Eina_Quaternion *out, const Eina_Quaternion *in)
{
  out->w = -in->w;
  out->x = -in->x;
  out->y = -in->y;
...
EINA_API void
eina_quaternion_scale(Eina_Quaternion *out, const Eina_Quaternion *a, double b)
{
  out->w = a->w * b;
  out->x = a->x * b;
  out->y = a->y * b;
...
EINA_API void
eina_quaternion_conjugate(Eina_Quaternion *out, const Eina_Quaternion *in)
{
  out->w = in->w;
  out->x = -in->x;
  out->y = -in->y;
...
EINA_API double
eina_quaternion_dot(const Eina_Quaternion *a, const Eina_Quaternion *b)
{
  return a->w * b->w + a->x * b->x + a->y * b->y + a->z * b->z;
}

EINA_API void
eina_quaternion_normalized(Eina_Quaternion *out, const Eina_Quaternion *in)
{
  double norm;
...
EINA_API void
eina_quaternion_rotation_matrix3_get(Eina_Matrix3 *m, const Eina_Quaternion *q)
{
  double x, y, z;
  double xx, xy, xz;
  double yy, yz;
...
eina_point_3d_combine(Eina_Point_3D       *out,
                      const Eina_Point_3D *a,
                      const Eina_Point_3D *b,
                      double               scale1,
                      double               scale2)
{
                           ...
                           const Eina_Matrix4 *m)
{
  ...
  if (EINA_DBL_EQ(m->ww, 0.0)) return EFL_FALSE;
  ...
  if (perspective)
  {
    if (fabs(n.xw) < DBL_EPSILON || fabs(n.yw) < DBL_EPSILON ||
        fabs(n.zw) < DBL_EPSILON)
    {
      ...
      if (!eina_matrix4_inverse(&ipm, &pm)) return EFL_FALSE;

      eina_matrix4_transpose(&tipm, &ipm);

      perspective->x =
        tipm.xx * tmp.x + tipm.yx * tmp.y + tipm.zx * tmp.z + tipm.wx * tmp.w;
      perspective->y =
        tipm.xy * tmp.x + tipm.yy * tmp.y + tipm.zy * tmp.z + tipm.wy * tmp.w;
      perspective->z =
        tipm.xz * tmp.x + tipm.yz * tmp.y + tipm.zz * tmp.z + tipm.wz * tmp.w;
      perspective->w =
        tipm.xw * tmp.x + tipm.yw * tmp.y + tipm.zw * tmp.z + tipm.ww * tmp.w;
    }
    else
    {
...
EINA_API void
eina_matrix3_quaternion_get(Eina_Quaternion *q, const Eina_Matrix3 *m)
{
  double tval;
  double w, x, y, z;
                           ...
                           const Eina_Point_3D   *skew)
{
  ...
  m->ww = perspective->w;
   ...
   // apply translation
  m->xw =
    translation->x * m->xx + translation->y * m->xy + translation->z * m->xz;
  m->yw =
    translation->x * m->yx + translation->y * m->yy + translation->z * m->yz;
  m->zw =
    translation->x * m->zx + translation->y * m->zy + translation->z * m->zz;
...
EINA_API void
eina_quaternion_subtract(Eina_Quaternion       *out,
                         const Eina_Quaternion *a,
                         const Eina_Quaternion *b)
{
  out->x = a->x - b->x;
...
{
  return (double)sqrt(
    (double)((v->x * v->x) + (v->y * v->y) + (v->z * v->z) + (v->w * v->w)));
}
...
EINA_API double
eina_quaternion_distance_square_get(const Eina_Quaternion *a,
                                    const Eina_Quaternion *b)
{
  Eina_Quaternion v;
...
EINA_API void
eina_quaternion_transform(Eina_Quaternion       *out,
                          const Eina_Quaternion *v,
                          const Eina_Matrix4    *m)
{
  Eina_Quaternion tmp;
