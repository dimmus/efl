...
static Efl_Bool
_eina_value_type_uchar_flush(const Eina_Value_Type *type EFL_UNUSED,
                             void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_uchar_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
...
static int
_eina_value_type_uchar_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_uchar_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  ...
                                  void                       *convert_mem)
{
  ...
  else if (convert == EINA_VALUE_TYPE_UINT)
  {
    ...
    return eina_value_type_pset(convert, convert_mem, &other_mem);
           ...
           (convert == EINA_VALUE_TYPE_TIMESTAMP))
  {
  ...
  else if (convert == EINA_VALUE_TYPE_CHAR)
  {
    ...
    if (EINA_UNLIKELY(v > (unsigned char)eina_value_char_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
...
static Efl_Bool
_eina_value_type_uchar_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  unsigned char *tmem = mem;
...
static Efl_Bool
_eina_value_type_uchar_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  unsigned char       *tmem = mem;
...
static Efl_Bool
_eina_value_type_uchar_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_ushort_flush(const Eina_Value_Type *type EFL_UNUSED,
                              void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_ushort_copy(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *src,
                             void                       *dst)
{
...
static int
_eina_value_type_ushort_compare(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *a,
                                const void                 *b)
{
...
static Efl_Bool
_eina_value_type_ushort_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                   const Eina_Value_Type      *convert,
                                   const void                 *type_mem,
                                   void                       *convert_mem)
{
  ...
  {
    unsigned char other_mem = v;
    if (EINA_UNLIKELY(v > eina_value_uchar_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_USHORT)
  {
...
static Efl_Bool
_eina_value_type_ushort_vset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             va_list                     args)
{
  unsigned short *tmem = mem;
...
static Efl_Bool
_eina_value_type_ushort_pset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             const void                 *ptr)
{
  unsigned short       *tmem = mem;
...
static Efl_Bool
_eina_value_type_ushort_pget(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *mem,
                             void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_uint_flush(const Eina_Value_Type *type EFL_UNUSED,
                            void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_uint_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
...
static int
_eina_value_type_uint_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
...
static Efl_Bool
_eina_value_type_uint_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
  ...
  {
    unsigned short other_mem = v;
    if (EINA_UNLIKELY(v > eina_value_ushort_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_UINT)
  {
  ...
  {
    int other_mem = v;
    if (EINA_UNLIKELY(v > (unsigned int)eina_value_int_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_LONG)
  {
...
static Efl_Bool
_eina_value_type_uint_vset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           va_list                     args)
{
  unsigned int *tmem = mem;
...
static Efl_Bool
_eina_value_type_uint_pset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           const void                 *ptr)
{
  unsigned int       *tmem = mem;
...
static Efl_Bool
_eina_value_type_uint_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_ulong_flush(const Eina_Value_Type *type EFL_UNUSED,
                             void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_ulong_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
...
static int
_eina_value_type_ulong_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_ulong_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
  ...
  {
    unsigned int other_mem = v;
    if (EINA_UNLIKELY(v > eina_value_uint_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if ((convert == EINA_VALUE_TYPE_ULONG) ||
           (convert == EINA_VALUE_TYPE_TIMESTAMP))
  ...
  {
    long other_mem = v;
    if (EINA_UNLIKELY(v > (unsigned long)eina_value_long_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_INT64)
  {
...
static Efl_Bool
_eina_value_type_ulong_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  unsigned long *tmem = mem;
...
static Efl_Bool
_eina_value_type_ulong_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  unsigned long       *tmem = mem;
...
static Efl_Bool
_eina_value_type_ulong_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_uint64_flush(const Eina_Value_Type *type EFL_UNUSED,
                              void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_uint64_copy(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *src,
                             void                       *dst)
{
...
static int
_eina_value_type_uint64_compare(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *a,
                                const void                 *b)
{
...
static Efl_Bool
_eina_value_type_uint64_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                   const Eina_Value_Type      *convert,
                                   const void                 *type_mem,
                                   void                       *convert_mem)
{
  ...
  {
    int64_t other_mem = v;
    if (EINA_UNLIKELY(v > (uint64_t)eina_value_int64_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_FLOAT)
  {
...
static Efl_Bool
_eina_value_type_uint64_vset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             va_list                     args)
{
  uint64_t *tmem = mem;
...
static Efl_Bool
_eina_value_type_uint64_pset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             const void                 *ptr)
{
  uint64_t       *tmem = mem;
...
static Efl_Bool
_eina_value_type_uint64_pget(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *mem,
                             void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_char_flush(const Eina_Value_Type *type EFL_UNUSED,
                            void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_char_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
  const char *s = src;
...
static int
_eina_value_type_char_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
...
static Efl_Bool
_eina_value_type_char_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
  ...
  {
    unsigned char other_mem = v;
    if (EINA_UNLIKELY(v < 0)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_USHORT)
  {
...
static Efl_Bool
_eina_value_type_char_vset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           va_list                     args)
{
  char *tmem = mem;
...
static Efl_Bool
_eina_value_type_char_pset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           const void                 *ptr)
{
  char       *tmem = mem;
...
static Efl_Bool
_eina_value_type_char_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
  const char *tmem = mem;
...
static Efl_Bool
_eina_value_type_short_flush(const Eina_Value_Type *type EFL_UNUSED,
                             void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_short_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
  const short *s = src;
...
static int
_eina_value_type_short_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_short_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
  ...
  {
    signed char other_mem = v;
    if (EINA_UNLIKELY(v < eina_value_char_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_char_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_SHORT)
  {
...
static Efl_Bool
_eina_value_type_short_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  short *tmem = mem;
...
static Efl_Bool
_eina_value_type_short_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  short       *tmem = mem;
...
static Efl_Bool
_eina_value_type_short_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_int_flush(const Eina_Value_Type *type EFL_UNUSED,
                           void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_int_copy(const Eina_Value_Type *type EFL_UNUSED,
                          const void                 *src,
                          void                       *dst)
{
  const int *s = src;
...
static int
_eina_value_type_int_compare(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *a,
                             const void                 *b)
{
  const int *ta = a, *tb = b;
...
static Efl_Bool
_eina_value_type_int_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                const Eina_Value_Type      *convert,
                                const void                 *type_mem,
                                void                       *convert_mem)
{
  ...
  {
    short other_mem = v;
    if (EINA_UNLIKELY(v < eina_value_short_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_short_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if ((convert == EINA_VALUE_TYPE_INT) ||
           (convert == EINA_VALUE_TYPE_ERROR))
...
static Efl_Bool
_eina_value_type_int_vset(const Eina_Value_Type *type EFL_UNUSED,
                          void                       *mem,
                          va_list                     args)
{
  int *tmem = mem;
...
static Efl_Bool
_eina_value_type_int_pset(const Eina_Value_Type *type EFL_UNUSED,
                          void                       *mem,
                          const void                 *ptr)
{
  int       *tmem = mem;
...
static Efl_Bool
_eina_value_type_int_pget(const Eina_Value_Type *type EFL_UNUSED,
                          const void                 *mem,
                          void                       *ptr)
{
  const int *tmem = mem;
...
static Efl_Bool
_eina_value_type_long_flush(const Eina_Value_Type *type EFL_UNUSED,
                            void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_long_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
  const long *s = src;
...
static int
_eina_value_type_long_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
...
static Efl_Bool
_eina_value_type_long_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
  ...
  else if (convert == EINA_VALUE_TYPE_UINT)
  {
    unsigned int other_mem = v;
    if (EINA_UNLIKELY(v < 0)) return EFL_FALSE;
    if (EINA_UNLIKELY((unsigned long)v > eina_value_uint_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if ((convert == EINA_VALUE_TYPE_ULONG) ||
           (convert == EINA_VALUE_TYPE_TIMESTAMP))
  ...
  {
    int other_mem = v;
    if (EINA_UNLIKELY(v < eina_value_int_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_int_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_LONG)
  {
...
static Efl_Bool
_eina_value_type_long_vset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           va_list                     args)
{
  long *tmem = mem;
...
static Efl_Bool
_eina_value_type_long_pset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           const void                 *ptr)
{
  long       *tmem = mem;
...
static Efl_Bool
_eina_value_type_long_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
  const long *tmem = mem;
...
static Efl_Bool
_eina_value_type_int64_flush(const Eina_Value_Type *type EFL_UNUSED,
                             void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_int64_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
  const int64_t *s = src;
...
static int
_eina_value_type_int64_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_int64_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
  ...
  {
    long other_mem = v;
    if (EINA_UNLIKELY(v < eina_value_long_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_long_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_INT64)
  {
...
static Efl_Bool
_eina_value_type_int64_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  int64_t *tmem = mem;
...
static Efl_Bool
_eina_value_type_int64_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  int64_t       *tmem = mem;
...
static Efl_Bool
_eina_value_type_int64_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_float_flush(const Eina_Value_Type *type EFL_UNUSED,
                             void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_float_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
  const float *s = src;
...
static int
_eina_value_type_float_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_float_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
  ...
  else if (convert == EINA_VALUE_TYPE_UINT64)
  {
    uint64_t other_mem = v;
    if (EINA_UNLIKELY(v < 0)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_uint64_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_CHAR)
  {
  ...
  {
    int64_t other_mem = v;
    if (EINA_UNLIKELY(v < eina_value_int64_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v > eina_value_int64_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_FLOAT)
  {
...
static Efl_Bool
_eina_value_type_float_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  float *tmem = mem;
...
static Efl_Bool
_eina_value_type_float_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  float       *tmem = mem;
...
static Efl_Bool
_eina_value_type_float_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_double_flush(const Eina_Value_Type *type EFL_UNUSED,
                              void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_double_copy(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *src,
                             void                       *dst)
{
  const double *s = src;
...
static int
_eina_value_type_double_compare(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *a,
                                const void                 *b)
{
...
static Efl_Bool
_eina_value_type_double_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                   const Eina_Value_Type      *convert,
                                   const void                 *type_mem,
                                   void                       *convert_mem)
{
...
static Efl_Bool
_eina_value_type_double_vset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             va_list                     args)
{
  double *tmem = mem;
...
static Efl_Bool
_eina_value_type_double_pset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             const void                 *ptr)
{
  double       *tmem = mem;
...
static Efl_Bool
_eina_value_type_double_pget(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *mem,
                             void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_string_common_setup(const Eina_Value_Type *type EFL_UNUSED,
                                     void                       *mem)
{
  const char **tmem = mem;
  *tmem             = NULL;
...
static int
_eina_value_type_string_common_compare(const Eina_Value_Type *type EFL_UNUSED,
                                       const void                 *a,
                                       const void                 *b)
{
...
static Efl_Bool
_eina_value_type_string_common_convert_to(const Eina_Value_Type *type
                                                                 EFL_UNUSED,
                                          const Eina_Value_Type *convert,
                                          const void            *type_mem,
                                          void                  *convert_mem)
{
  ...
  {
    float other_mem;
    if (sscanf(v, "%f", &other_mem) != 1) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_DOUBLE)
  {
    double other_mem;
    if (sscanf(v, "%lf", &other_mem) != 1) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_STRINGSHARE ||
           convert == EINA_VALUE_TYPE_STRING)
...
static Efl_Bool
_eina_value_type_string_common_pget(const Eina_Value_Type *type EFL_UNUSED,
                                    const void                 *mem,
                                    void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_stringshare_flush(const Eina_Value_Type *type EFL_UNUSED,
                                   void                       *mem)
{
  const char **tmem = mem;
  if (*tmem)
...
static Efl_Bool
_eina_value_type_stringshare_copy(const Eina_Value_Type *type EFL_UNUSED,
                                  const void                 *src,
                                  void                       *dst)
{
...
static Efl_Bool
_eina_value_type_stringshare_vset(const Eina_Value_Type *type EFL_UNUSED,
                                  void                       *mem,
                                  va_list                     args)
{
...
static Efl_Bool
_eina_value_type_stringshare_pset(const Eina_Value_Type *type EFL_UNUSED,
                                  void                       *mem,
                                  const void                 *ptr)
{
...
static Efl_Bool
_eina_value_type_stringshare_pget(const Eina_Value_Type *type EFL_UNUSED,
                                  const void                 *mem,
                                  void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_string_copy(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *src,
                             void                       *dst)
{
  const char *const *s = src;
...
static Efl_Bool
_eina_value_type_string_vset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             va_list                     args)
{
  char      **tmem = mem;
...
static Efl_Bool
_eina_value_type_string_pset(const Eina_Value_Type *type EFL_UNUSED,
                             void                       *mem,
                             const void                 *ptr)
{
  char             **tmem = mem;
...
static Efl_Bool
_eina_value_type_array_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
...
static int
_eina_value_type_array_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
  const Eina_Value_Type  *subtype;
  ...
  if ((!eva_a->array) && (!eva_b->array)) return 0;
  else if (!eva_a->array) return -1;
  else if (!eva_b->array) return 1;

  count_a = eina_inarray_count(eva_a->array);
  count_b = eina_inarray_count(eva_b->array);

  if (count_a <= count_b) count = count_a;
  else count = count_b;
...
static Efl_Bool
_eina_value_type_array_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
      ...
      (convert == EINA_VALUE_TYPE_STRINGSHARE))
  {
    ...
    else
    {
      ...
      for (; ptr < ptr_end; ptr += sz)
      {
        ...
        {
          r = subtype->convert_to(subtype,
                                  EINA_VALUE_TYPE_STRING,
                                  ptr,
                                  tmp.value.buf);
          if (r)
          {
            if (first) first = EFL_FALSE;
        ...
        if (!r)
        {
          ...
          else eina_strbuf_append_length(str, ", ?", 3);
        }
      }
...
static Efl_Bool
_eina_value_type_array_convert_from(const Eina_Value_Type *type,
                                    const Eina_Value_Type *convert,
                                    void                  *type_mem,
                                    const void            *convert_mem)
{
  ...
  if (!eina_value_type_pset(type, tmem, &desc)) return EFL_FALSE;

  buf = alloca(convert->value_size);
  if (!eina_value_type_pget(convert, convert_mem, &buf)) return EFL_FALSE;

  imem = eina_inarray_alloc_at(tmem->array, 0, 1);
  if (!imem) return EFL_FALSE;
...
static Efl_Bool
_eina_value_type_array_pset(const Eina_Value_Type *type,
                            void                  *mem,
                            const void            *ptr)
{
  Eina_Value_Array       *tmem = mem;
  ...
  if ((!tmem->subtype) && (!desc->subtype)) return EFL_TRUE;
  ...
  if (desc_array)
  {
    ...
    EINA_SAFETY_ON_FALSE_RETURN_VAL(desc_array->member_size ==
                                      desc->subtype->value_size,
                                    EFL_FALSE);
    ...
    if (!_eina_value_type_array_copy(type, desc, &tmp)) return EFL_FALSE;
  ...
  if (tmem->array)
  {
    ...
    eina_inarray_step_set(tmem->array,
                          sizeof(Eina_Inarray),
                          desc->subtype->value_size,
                          desc->step);
  }
  else
  {
    ...
    if (!tmem->array) return EFL_FALSE;
  }
...
static Efl_Bool
_eina_value_type_array_vset(const Eina_Value_Type *type,
                            void                  *mem,
                            va_list                args)
{
...
static Efl_Bool
_eina_value_type_array_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_list_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
  const Eina_Value_Type *subtype;
...
static int
_eina_value_type_list_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
  const Eina_Value_Type *subtype;
  ...
  else if (!eva_a->list) return -1;
  else if (!eva_b->list) return 1;
...
static Efl_Bool
_eina_value_type_list_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
...
static Efl_Bool
_eina_value_type_list_convert_from(const Eina_Value_Type *type,
                                   const Eina_Value_Type *convert,
                                   void                  *type_mem,
                                   const void            *convert_mem)
{
  ...
  EINA_SAFETY_ON_NULL_RETURN_VAL(node, EFL_FALSE);
  EINA_SAFETY_ON_FALSE_RETURN_VAL(node->data == (void *)1L, EFL_FALSE);
...
static Efl_Bool
_eina_value_type_list_pset(const Eina_Value_Type *type,
                           void                  *mem,
                           const void            *ptr)
{
  Eina_Value_List       *tmem = mem;
  ...
  if (desc->list)
  {
    ...
    if (!_eina_value_type_list_copy(type, desc, &tmp)) return EFL_FALSE;
...
static Efl_Bool
_eina_value_type_list_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_hash_flush_each(const Eina_Hash *hash EFL_UNUSED,
...
{
  struct _eina_value_type_hash_flush_each_ctx ctx = { tmem->subtype, EFL_TRUE };

  if (!tmem->hash) return EFL_TRUE;
...
static int
_eina_value_hash_key_cmp(const void *key1,
                         int         key1_len,
                         const void *key2,
                         int         key2_len)
{
...
static Efl_Bool
_eina_value_type_hash_copy_each(const Eina_Hash *hash EFL_UNUSED,
                                const void           *key,
                                void                 *_ptr,
                                void                 *user_data)
{
...
static Efl_Bool
_eina_value_type_hash_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
  const Eina_Value_Hash                     *s   = src;
  Eina_Value_Hash                           *d   = dst;
  struct _eina_value_type_hash_copy_each_ctx ctx = { s->subtype, d, EFL_TRUE };
  ...
  if (!_eina_value_type_hash_create(d)) return EFL_FALSE;
...
static Efl_Bool
_eina_value_type_hash_compare_each(const Eina_Hash *hash EFL_UNUSED,
                                   const void           *key,
                                   void                 *_ptr,
                                   void                 *user_data)
{
  ...
  if (!other_ptr) return EFL_TRUE;
  ctx->cmp = ctx->subtype->compare(ctx->subtype, self_ptr, other_ptr);
  return ctx->cmp == 0;
}

static int
_eina_value_type_hash_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
  const Eina_Value_Hash                        *eva_a = a, *eva_b = b;
  struct _eina_value_type_hash_compare_each_ctx ctx = { eva_a->subtype,
                                                        eva_b->hash,
                                                        0 };
  ...
  else if (!eva_a->hash) return -1;
  else if (!eva_b->hash) return 1;
...
static Efl_Bool
_eina_value_type_hash_convert_to_string_each(const Eina_Hash *hash EFL_UNUSED,
                                             const void           *_key,
                                             void                 *_ptr,
                                             void                 *user_data)
{
  ...
  if (ctx->first) ctx->first = EFL_FALSE;
  ...
  {
    r = ctx->subtype->convert_to(ctx->subtype,
                                 EINA_VALUE_TYPE_STRING,
                                 ptr,
                                 ctx->tmp.value.buf);
    if (r)
  ...
  if (!r) eina_strbuf_append_char(ctx->str, '?');

  return EFL_TRUE;
}

static Efl_Bool
_eina_value_type_hash_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
  ...
  else if ((tmem->hash) && (eina_hash_population(tmem->hash) == 1))
  {
    ...
    if (!it || !eina_iterator_next(it, &imem) ||
        !imem) /* shouldn't happen... */
    {
      ret = EFL_FALSE;
    }
    else
...
static Efl_Bool
_eina_value_type_hash_pset(const Eina_Value_Type *type,
                           void                  *mem,
                           const void            *ptr)
{
  Eina_Value_Hash       *tmem = mem;
  ...
  if (desc->hash)
  {
    ...
    if (!_eina_value_type_hash_copy(type, desc, &tmp)) return EFL_FALSE;
  ...
  tmem->subtype = desc->subtype;
  if (!_eina_value_type_hash_create(tmem)) return EFL_FALSE;
...
static Efl_Bool
_eina_value_type_hash_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_timeval_setup(const Eina_Value_Type *type EFL_UNUSED,
                               void                       *mem)
{
...
static Efl_Bool
_eina_value_type_timeval_flush(const Eina_Value_Type *type EFL_UNUSED,
                               void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_timeval_copy(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *src,
                              void                       *dst)
{
...
_eina_value_type_timeval_fix(const struct timeval *input)
{
...
static int
_eina_value_type_timeval_compare(const Eina_Value_Type *type EFL_UNUSED,
                                 const void                 *a,
                                 const void                 *b)
{
  ...
  if (va.tv_sec < vb.tv_sec) return -1;
  else if (va.tv_sec > vb.tv_sec) return 1;

  if (va.tv_usec < vb.tv_usec) return -1;
  else if (va.tv_usec > vb.tv_usec) return 1;

  return 0;
}

static Efl_Bool
_eina_value_type_timeval_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                    const Eina_Value_Type      *convert,
                                    const void                 *type_mem,
                                    void                       *convert_mem)
{
  ...
  if (convert == EINA_VALUE_TYPE_UCHAR)
  {
    ...
    if (EINA_UNLIKELY(v.tv_sec < 0)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_uchar_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_USHORT)
  {
    ...
    if (EINA_UNLIKELY(v.tv_sec < 0)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_ushort_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_UINT)
  {
  ...
  else if (convert == EINA_VALUE_TYPE_CHAR)
  {
    ...
    if (EINA_UNLIKELY(v.tv_sec < eina_value_char_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_char_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_SHORT)
  {
    short other_mem = v.tv_sec;
    if (EINA_UNLIKELY(v.tv_sec < eina_value_short_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_short_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if ((convert == EINA_VALUE_TYPE_INT) ||
           (convert == EINA_VALUE_TYPE_ERROR))
  {
    ...
    if (EINA_UNLIKELY(v.tv_sec < eina_value_int_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_int_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_LONG)
  {
    long other_mem = v.tv_sec;
    if (EINA_UNLIKELY(v.tv_sec < eina_value_long_min)) return EFL_FALSE;
    if (EINA_UNLIKELY(v.tv_sec > eina_value_long_max)) return EFL_FALSE;
    return eina_value_type_pset(convert, convert_mem, &other_mem);
  }
  else if (convert == EINA_VALUE_TYPE_INT64)
  {
...
static Efl_Bool
_eina_value_type_timeval_pset(const Eina_Value_Type *type EFL_UNUSED,
                              void                       *mem,
                              const void                 *ptr)
{
...
static Efl_Bool
_eina_value_type_timeval_vset(const Eina_Value_Type *type,
                              void                  *mem,
                              va_list                args)
{
...
static Efl_Bool
_eina_value_type_timeval_pget(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *mem,
                              void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_tm_flush(const Eina_Value_Type *type EFL_UNUSED,
                          void *mem                   EFL_UNUSED)
{
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_tm_copy(const Eina_Value_Type *type EFL_UNUSED,
                         const void                 *src,
                         void                       *dst)
{
...
static int
_eina_value_type_tm_compare(const Eina_Value_Type *type,
                            const void            *a,
                            const void            *b)
{
...
static Efl_Bool
_eina_value_type_tm_pset(const Eina_Value_Type *type EFL_UNUSED,
                         void                       *mem,
                         const void                 *ptr)
{
...
static Efl_Bool
_eina_value_type_tm_pget(const Eina_Value_Type *type,
                         const void            *mem,
                         void                  *ptr)
{
...
static Efl_Bool
_eina_value_type_tm_convert_to(const Eina_Value_Type *type,
                               const Eina_Value_Type *convert,
                               const void            *type_mem,
                               void                  *convert_mem)
{
...
_eina_value_type_blob_ops_get(const Eina_Value_Blob *blob)
{
  ...
  EINA_SAFETY_ON_FALSE_RETURN_VAL(blob->ops->version ==
...
_eina_value_type_blob_flush(const Eina_Value_Type *type EFL_UNUSED, void *mem)
{
  ...
  if ((ops) && (ops->free)) ops->free(ops, (void *)tmem->memory, tmem->size);
  tmem->memory = NULL;
  tmem->size   = 0;
  return EFL_TRUE;
}
...
static Efl_Bool
_eina_value_type_blob_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
  ...
  *d = *s;
  ...
  if ((ops) && (ops->copy))
  {
    ...
    if ((d->memory == NULL) && (s->size > 0)) return EFL_FALSE;
  }
...
static int
_eina_value_type_blob_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
  ...
  if (ta->size < tb->size) minsize = ta->size;
  else minsize = tb->size;

  return memcmp(ta->memory, tb->memory, minsize);
}

static Efl_Bool
_eina_value_type_blob_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
      ...
      convert == EINA_VALUE_TYPE_STRING)
  {
    ...
    Efl_Strbuf                       *str;
    const char                       *other_mem;
    Efl_Bool                          ret = EFL_FALSE, first = EFL_TRUE;
    ...
    if (!eina_strbuf_append_printf(str, "BLOB(%u, [", tmem->size)) goto error;
    ...
    for (; ptr < ptr_end; ptr++)
    {
      ...
      {
        first = EFL_FALSE;
        if (!eina_strbuf_append_printf(str, "%02hhx", *ptr)) goto error;
      }
      else
      {
        if (!eina_strbuf_append_printf(str, " %02hhx", *ptr)) goto error;
    ...
    if (!eina_strbuf_append(str, "])")) goto error;
...
static Efl_Bool
_eina_value_type_blob_convert_from(const Eina_Value_Type *type,
                                   const Eina_Value_Type *convert,
                                   void                  *type_mem,
                                   const void            *convert_mem)
{
...
static Efl_Bool
_eina_value_type_blob_pset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           const void                 *ptr)
{
  const Eina_Value_Blob_Operations *ops  = _eina_value_type_blob_ops_get(mem);
...
static Efl_Bool
_eina_value_type_blob_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_value_copy(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *src,
                            void                       *dst)
{
...
static int
_eina_value_type_value_compare(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *a,
                               const void                 *b)
{
...
static Efl_Bool
_eina_value_type_value_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                  const Eina_Value_Type      *convert,
                                  const void                 *type_mem,
                                  void                       *convert_mem)
{
  const Eina_Value *v = type_mem;
  return eina_value_type_convert_to(v->type,
                                    convert,
                                    eina_value_memory_get(v),
                                    convert_mem);
}

static Efl_Bool
_eina_value_type_value_convert_from(const Eina_Value_Type *type EFL_UNUSED,
                                    const Eina_Value_Type      *convert,
                                    void                       *type_mem,
                                    const void                 *convert_mem)
{
  Eina_Value *v = type_mem;
  return eina_value_type_convert_from(v->type,
                                      convert,
                                      eina_value_memory_get(v),
                                      convert_mem);
}
...
static Efl_Bool
_eina_value_type_value_vset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            va_list                     args)
{
  Eina_Value *dst = mem;
...
static Efl_Bool
_eina_value_type_value_pset(const Eina_Value_Type *type EFL_UNUSED,
                            void                       *mem,
                            const void                 *ptr)
{
  Eina_Value       *dst = mem;
...
static Efl_Bool
_eina_value_type_value_pget(const Eina_Value_Type *type EFL_UNUSED,
                            const void                 *mem,
                            void                       *ptr)
{
...
_eina_value_struct_operations_binsearch_find_member(
  const Eina_Value_Struct_Operations *ops EFL_UNUSED,
...
_eina_value_type_struct_ops_get(const Eina_Value_Struct *st)
{
  ...
  EINA_SAFETY_ON_FALSE_RETURN_VAL(st->desc->ops->version ==
                                    EINA_VALUE_STRUCT_OPERATIONS_VERSION,
                                  NULL);
  return st->desc->ops;
}
...
eina_value_struct_member_find(const Eina_Value_Struct *st, const char *name)
{
  ...
  if ((ops) && (ops->find_member)) return ops->find_member(ops, st->desc, name);
...
static Efl_Bool
_eina_value_type_struct_setup_member(const Eina_Value_Struct_Member *member,
...
static Efl_Bool
_eina_value_type_struct_flush_member(const Eina_Value_Struct_Member *member,
                                     Eina_Value_Struct              *st)
{
  unsigned char *base = st->memory;
...
_eina_value_type_struct_flush(const Eina_Value_Type *type EFL_UNUSED, void *mem)
{
  ...
  if ((!tmem->desc) || (!tmem->memory)) return EFL_TRUE;
  ...
  if ((ops) && (ops->free)) ops->free(ops, tmem->desc, tmem->memory);
  else free(tmem->memory);
...
static Efl_Bool
_eina_value_type_struct_copy_member(const Eina_Value_Struct_Member *member,
                                    const Eina_Value_Struct        *s,
                                    Eina_Value_Struct              *d)
{
...
static Efl_Bool
_eina_value_type_struct_copy(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *src,
                             void                       *dst)
{
  const Eina_Value_Struct_Operations *ops;
  ...
  *d = *s;
  ...
  if ((!s->desc) || (!s->memory)) return EFL_TRUE;

  ops = _eina_value_type_struct_ops_get(src);
  if ((ops) && (ops->copy))
  {
    d->memory = ops->copy(ops, s->desc, s->memory);
    if (d->memory == NULL) return EFL_FALSE;
    return EFL_TRUE;
  }

  if ((ops) && (ops->alloc)) d->memory = ops->alloc(ops, s->desc);
  else d->memory = malloc(s->desc->size);
  if (!d->memory)
  {
    return EFL_FALSE;
  }
  ...
  if (s->desc->member_count > 0)
  {
    ...
    for (; itr < itr_end; itr++)
      if (!_eina_value_type_struct_copy_member(itr, s, d)) goto error;
  }
  else
  {
    for (; itr->name != NULL; itr++)
...
error:
  ...
  if ((ops) && (ops->free)) ops->free(ops, s->desc, d->memory);
  else free(d->memory);
  return EFL_FALSE;
}

static inline int
_eina_value_type_struct_compare_member(const Eina_Value_Struct_Member *member,
                                       const Eina_Value_Struct        *ta,
                                       const Eina_Value_Struct        *tb)
{
...
static int
_eina_value_type_struct_compare(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *a,
                                const void                 *b)
{
  ...
  if ((!ta->memory) && (!tb->memory)) return 0;
  else if (!ta->memory) return -1;
  else if (!tb->memory) return 1;
  ...
  Efl_Strbuf                     *str)
{
  ...
  Efl_Bool             first = st->desc->members == member;
  Efl_Bool             r     = EFL_FALSE;
  ...
  if ((member->type) && (member->type->convert_to))
  {
    ...
    r = eina_value_type_convert_to(type,
                                   EINA_VALUE_TYPE_STRING,
                                   p + member->offset,
                                   &conv);
    if (r)
  ...
  if (!r) eina_strbuf_append_char(str, '?');
}

static Efl_Bool
_eina_value_type_struct_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                   const Eina_Value_Type      *convert,
                                   const void                 *type_mem,
                                   void                       *convert_mem)
{
      ...
      convert == EINA_VALUE_TYPE_STRING)
  {
    ...
    else
    {
      ...
      if (tmem->desc->member_count > 0)
      {
        ...
        itr_end = itr + tmem->desc->member_count;
        for (; itr < itr_end; itr++)
          _eina_value_type_struct_convert_to_string_member(tmem, itr, str);
      }
      else
      {
        for (; itr->name != NULL; itr++)
...
_eina_value_type_struct_desc_check(const Eina_Value_Struct_Desc *desc)
{
  ...
  EINA_SAFETY_ON_NULL_RETURN_VAL(desc, EFL_FALSE);
  EINA_SAFETY_ON_FALSE_RETURN_VAL(desc->version ==
  ...
  if (desc->member_count > 0)
  {
    ...
    for (; itr < itr_end; itr++)
    {
      ...
      EINA_SAFETY_ON_FALSE_RETURN_VAL(eina_value_type_check(itr->type),
                                      EFL_FALSE);
      EINA_SAFETY_ON_FALSE_RETURN_VAL(itr->type->value_size > 0, EFL_FALSE);

      member_end = itr->offset + itr->type->value_size;
      if (minsize < member_end) minsize = member_end;
    }
  }
  else
  {
  ...
  EINA_SAFETY_ON_FALSE_RETURN_VAL(minsize > 0, EFL_FALSE);
  EINA_SAFETY_ON_FALSE_RETURN_VAL(desc->size >= minsize, EFL_FALSE);
  return EFL_TRUE;
}

static Efl_Bool
_eina_value_type_struct_pset(const Eina_Value_Type *type,
                             void                  *mem,
                             const void            *ptr)
{
  const Eina_Value_Struct_Operations *ops;
  ...
  if (desc->memory)
  {
    ...
    if (!_eina_value_type_struct_copy(type, desc, &tmp)) return EFL_FALSE;
  ...
  if ((ops) && (ops->alloc)) tmem->memory = ops->alloc(ops, tmem->desc);
  else tmem->memory = malloc(tmem->desc->size);
  ...
  if (tmem->desc->member_count > 0)
  {
    ...
    itr_end = itr + tmem->desc->member_count;
    for (; itr < itr_end; itr++)
      if (!_eina_value_type_struct_setup_member(itr, tmem)) goto error;
  }
  else
  {
    for (; itr->name != NULL; itr++)
...
static Efl_Bool
_eina_value_type_struct_vset(const Eina_Value_Type *type,
                             void                  *mem,
                             va_list                args)
{
...
static Efl_Bool
_eina_value_type_struct_pget(const Eina_Value_Type *type EFL_UNUSED,
                             const void                 *mem,
                             void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_optional_setup(const Eina_Value_Type *type EFL_UNUSED,
                                void                       *mem)
{
  memset(mem, 0, type->value_size);
  return EFL_TRUE;
...
static Efl_Bool
_eina_value_type_optional_flush(const Eina_Value_Type *type EFL_UNUSED,
                                void *mem                   EFL_UNUSED)
{
  if (sizeof(Eina_Value_Optional_Outer) <= sizeof(Eina_Value_Union))
  {
    ...
    if (opt->subtype)
    {
      if (!eina_value_type_flush(opt->subtype, opt->value)) return EFL_FALSE;
      free(opt->value);
...
eina_value_optional_reset(Eina_Value *value)
{
  ...
  if (!mem) return EFL_FALSE;
  return _eina_value_type_optional_flush(EINA_VALUE_TYPE_OPTIONAL, mem);
}

EINA_API Eina_Value *
eina_value_optional_new(const Eina_Value_Type *subtype,
                         ...
                         const void *subvalue) EINA_ARG_NONNULL(1, 2, 3)
{
  ...
  if (sizeof(Eina_Value_Optional_Outer) <= sizeof(Eina_Value_Union))
  {
    ...
    if (!eina_value_type_setup(subtype, outer.value)) return EFL_FALSE;
    eina_value_type_pset(subtype, outer.value, subvalue);
    if (!eina_value_pset(value, &outer)) return EFL_FALSE;
  }
  else
  {
    ...
    if (!eina_value_type_setup(subtype, inner->value)) return EFL_FALSE;
    eina_value_type_pset(subtype, inner->value, subvalue);
    if (!eina_value_pset(value, &inner)) return EFL_FALSE;
  }
  ...
  EINA_ARG_NONNULL(1, 2, 3)
{
  if (sizeof(Eina_Value_Optional_Outer) <= sizeof(Eina_Value_Union))
  {
    ...
    if (!eina_value_pget(value, &outer)) return EFL_FALSE;
  ...
  else
  {
    ...
    if (!eina_value_pget(value, &inner)) return EFL_FALSE;

    if (inner) eina_value_type_copy(inner->subtype, inner->value, subvalue);
    else return EFL_FALSE;
  }
...
static Efl_Bool
_eina_value_type_optional_copy(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *src_raw,
                               void                       *dst_raw)
{
  if (sizeof(Eina_Value_Optional_Outer) <= sizeof(Eina_Value_Union))
  {
    const Eina_Value_Optional_Outer *src = src_raw;
    ...
    else memset(dst_raw, 0, sizeof(Eina_Value_Optional_Outer));
  }
  else if (src_raw)
  {
  ...
  else *(void **)dst_raw = NULL;
  return EFL_TRUE;
}

static int
_eina_value_type_optional_compare(const Eina_Value_Type *type EFL_UNUSED,
                                  const void                 *lhs_raw,
                                  const void                 *rhs_raw)
{
  if (sizeof(Eina_Value_Optional_Outer) <= sizeof(Eina_Value_Union))
  {
    const Eina_Value_Optional_Outer *lhs = lhs_raw, *rhs = rhs_raw;
    if (!lhs->subtype) return !rhs->subtype ? 0 : -1;
    else if (!rhs->subtype) return 1;
    else if (lhs->subtype != rhs->subtype)
      return lhs->subtype < rhs->subtype ? -1 : 1;
    else return eina_value_type_compare(lhs->subtype, lhs->value, rhs->value);
  }
  else
  {
    const Eina_Value_Optional_Inner *const *lhs_p = lhs_raw;
    const Eina_Value_Optional_Inner *const *rhs_p = rhs_raw;

    if (!*lhs_p) return *rhs_p ? -1 : 0;
    else if (!*rhs_p) return 1;
    else if ((*lhs_p)->subtype != (*rhs_p)->subtype)
      return (*lhs_p)->subtype < (*rhs_p)->subtype ? -1 : 1;
    else
      return eina_value_type_compare((*lhs_p)->subtype,
                                     (*lhs_p)->value,
                                     (*rhs_p)->value);
  }
}
...
static Efl_Bool
_eina_value_type_optional_pset(const Eina_Value_Type *type EFL_UNUSED,
                               void                       *mem,
                               const void                 *ptr)
{
...
static Efl_Bool
_eina_value_type_optional_pget(const Eina_Value_Type *type EFL_UNUSED,
                               const void                 *mem,
                               void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_eina_error_convert_to(const Eina_Value_Type *type,
                                       const Eina_Value_Type *convert,
                                       const void            *type_mem,
                                       void                  *convert_mem)
{
...
static Efl_Bool
_eina_value_type_file_copy(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *src,
                           void                       *dst)
{
...
static int
_eina_value_type_file_compare(const Eina_Value_Type *type EFL_UNUSED,
                              const void                 *a,
                              const void                 *b)
{
...
static Efl_Bool
_eina_value_type_file_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                 const Eina_Value_Type      *convert,
                                 const void                 *type_mem,
                                 void                       *convert_mem)
{
...
static Efl_Bool
_eina_value_type_file_convert_from(const Eina_Value_Type *type EFL_UNUSED,
                                   const Eina_Value_Type      *convert,
                                   void                       *type_mem,
                                   const void                 *convert_mem)
{
      ...
      (convert == EINA_VALUE_TYPE_STRINGSHARE))
  {
    ...
    if (!filename) return EFL_FALSE;
    *f = eina_file_open(filename, EFL_FALSE);
    return !!(*f);
  }
...
static Efl_Bool
_eina_value_type_file_pset(const Eina_Value_Type *type EFL_UNUSED,
                           void                       *mem,
                           const void                 *ptr)
{
  Eina_File      **d = mem;
...
static Efl_Bool
_eina_value_type_file_pget(const Eina_Value_Type *type EFL_UNUSED,
                           const void                 *mem,
                           void                       *ptr)
{
...
static Efl_Bool
_eina_value_type_rectangle_setup(const Eina_Value_Type *type EFL_UNUSED,
                                 void                       *mem)
{
...
static Efl_Bool
_eina_value_type_rectangle_copy(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *src,
                                void                       *dst)
{
...
static int
_eina_value_type_rectangle_compare(const Eina_Value_Type *type EFL_UNUSED,
                                   const void                 *a,
                                   const void                 *b)
{
...
static Efl_Bool
_eina_value_type_rectangle_convert_to(const Eina_Value_Type *type EFL_UNUSED,
                                      const Eina_Value_Type      *convert,
                                      const void                 *type_mem,
                                      void                       *convert_mem)
{
      ...
      (convert == EINA_VALUE_TYPE_STRINGSHARE))
  {
    ...
    snprintf(str, 1024, "[ %i, %i, %i, %i ]", tr->x, tr->y, tr->w, tr->h);
...
static Efl_Bool
_eina_value_type_rectangle_convert_from(const Eina_Value_Type *type EFL_UNUSED,
                                        const Eina_Value_Type      *convert,
                                        void                       *type_mem,
                                        const void                 *convert_mem)
{
      ...
      (convert == EINA_VALUE_TYPE_STRINGSHARE))
  {
    ...
    ret = sscanf(buf, "[ %i, %i, %i, %i ]", &r->x, &r->y, &r->w, &r->h);

    if (ret <= 0) return EFL_FALSE;
    return EFL_TRUE;
  }
...
static Efl_Bool
_eina_value_type_rectangle_pset(const Eina_Value_Type *type EFL_UNUSED,
                                void                       *mem,
                                const void                 *ptr)
{
...
static Efl_Bool
_eina_value_type_rectangle_vset(const Eina_Value_Type *type,
                                void                  *mem,
                                va_list                args)
{
...
static Efl_Bool
_eina_value_type_rectangle_pget(const Eina_Value_Type *type EFL_UNUSED,
                                const void                 *mem,
                                void                       *ptr)
{
...
static const Eina_Value_Type _EINA_VALUE_TYPE_BASICS[] = {
  { EINA_VALUE_TYPE_VERSION,
   ...
   "unsigned char",         _eina_value_type_uchar_setup,
   _eina_value_type_uchar_flush,       _eina_value_type_uchar_copy,
   _eina_value_type_uchar_compare,         _eina_value_type_uchar_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_uchar_vset,       _eina_value_type_uchar_pset,
   _eina_value_type_uchar_pget        },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(unsigned short),
   "unsigned short",        _eina_value_type_ushort_setup,
   _eina_value_type_ushort_flush,      _eina_value_type_ushort_copy,
   _eina_value_type_ushort_compare,        _eina_value_type_ushort_convert_to,
   NULL,      /* no convert from */
      _eina_value_type_ushort_vset,      _eina_value_type_ushort_pset,
   _eina_value_type_ushort_pget       },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(unsigned int),
   "unsigned int",          _eina_value_type_uint_setup,
   _eina_value_type_uint_flush,        _eina_value_type_uint_copy,
   _eina_value_type_uint_compare,          _eina_value_type_uint_convert_to,
   NULL,        /* no convert from */
        _eina_value_type_uint_vset,        _eina_value_type_uint_pset,
   _eina_value_type_uint_pget         },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(unsigned long),
   "unsigned long",         _eina_value_type_ulong_setup,
   _eina_value_type_ulong_flush,       _eina_value_type_ulong_copy,
   _eina_value_type_ulong_compare,         _eina_value_type_ulong_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_ulong_vset,       _eina_value_type_ulong_pset,
   _eina_value_type_ulong_pget        },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(uint64_t),
   "uint64_t",        _eina_value_type_uint64_setup,
   _eina_value_type_uint64_flush,      _eina_value_type_uint64_copy,
   _eina_value_type_uint64_compare,        _eina_value_type_uint64_convert_to,
   NULL,      /* no convert from */
      _eina_value_type_uint64_vset,      _eina_value_type_uint64_pset,
   _eina_value_type_uint64_pget       },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(char),
   "char",          _eina_value_type_char_setup,
   _eina_value_type_char_flush,        _eina_value_type_char_copy,
   _eina_value_type_char_compare,          _eina_value_type_char_convert_to,
   NULL,        /* no convert from */
        _eina_value_type_char_vset,        _eina_value_type_char_pset,
   _eina_value_type_char_pget         },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(short),
   "short",         _eina_value_type_short_setup,
   _eina_value_type_short_flush,       _eina_value_type_short_copy,
   _eina_value_type_short_compare,         _eina_value_type_short_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_short_vset,       _eina_value_type_short_pset,
   _eina_value_type_short_pget        },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(int),
   "int",           _eina_value_type_int_setup,
   _eina_value_type_int_flush,         _eina_value_type_int_copy,
   _eina_value_type_int_compare,           _eina_value_type_int_convert_to,
   NULL,         /* no convert from */
         _eina_value_type_int_vset,         _eina_value_type_int_pset,
   _eina_value_type_int_pget          },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(long),
   "long",          _eina_value_type_long_setup,
   _eina_value_type_long_flush,        _eina_value_type_long_copy,
   _eina_value_type_long_compare,          _eina_value_type_long_convert_to,
   NULL,        /* no convert from */
        _eina_value_type_long_vset,        _eina_value_type_long_pset,
   _eina_value_type_long_pget         },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(int64_t),
   "int64_t",         _eina_value_type_int64_setup,
   _eina_value_type_int64_flush,       _eina_value_type_int64_copy,
   _eina_value_type_int64_compare,         _eina_value_type_int64_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_int64_vset,       _eina_value_type_int64_pset,
   _eina_value_type_int64_pget        },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(float),
   "float",         _eina_value_type_float_setup,
   _eina_value_type_float_flush,       _eina_value_type_float_copy,
   _eina_value_type_float_compare,         _eina_value_type_float_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_float_vset,       _eina_value_type_float_pset,
   _eina_value_type_float_pget        },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(double),
   "double",        _eina_value_type_double_setup,
   _eina_value_type_double_flush,      _eina_value_type_double_copy,
   _eina_value_type_double_compare,        _eina_value_type_double_convert_to,
   NULL,      /* no convert from */
      _eina_value_type_double_vset,      _eina_value_type_double_pset,
   _eina_value_type_double_pget       },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(const char *),
   "stringshare", _eina_value_type_string_common_setup,
   _eina_value_type_stringshare_flush, _eina_value_type_stringshare_copy,
   _eina_value_type_string_common_compare, _eina_value_type_string_common_convert_to,
   NULL, /* no convert from */
 _eina_value_type_stringshare_vset, _eina_value_type_stringshare_pset,
   _eina_value_type_stringshare_pget  },
  { EINA_VALUE_TYPE_VERSION,
   sizeof(char *),
   "string", _eina_value_type_string_common_setup,
   _eina_value_type_string_flush,      _eina_value_type_string_copy,
   _eina_value_type_string_common_compare, _eina_value_type_string_common_convert_to,
   NULL,      /* no convert from */
  ...
  { EINA_VALUE_TYPE_VERSION,
   sizeof(unsigned long),
   "timestamp",         _eina_value_type_ulong_setup,
   _eina_value_type_ulong_flush,       _eina_value_type_ulong_copy,
   _eina_value_type_ulong_compare,         _eina_value_type_ulong_convert_to,
   NULL,       /* no convert from */
       _eina_value_type_ulong_vset,       _eina_value_type_ulong_pset,
  ...
  { EINA_VALUE_TYPE_VERSION,
   sizeof(Eina_Error),
   "Eina_Error",           _eina_value_type_int_setup,
   _eina_value_type_int_flush,         _eina_value_type_int_copy,
   _eina_value_type_int_compare,    _eina_value_type_eina_error_convert_to,
   NULL,         /* no convert from */
         _eina_value_type_int_vset,         _eina_value_type_int_pset,
   _eina_value_type_int_pget          }
};
...
static void
_eina_value_blob_operations_malloc_free(const Eina_Value_Blob_Operations *ops
                                                    EFL_UNUSED,
                                        void       *memory,
                                        size_t size EFL_UNUSED)
{
  free(memory);
}

static void *
_eina_value_blob_operations_malloc_copy(const Eina_Value_Blob_Operations *ops
                                                    EFL_UNUSED,
                                        const void *memory,
                                        size_t      size)
{
...
eina_value_init(void)
{
  ...
  _eina_value_log_dom =
    eina_log_domain_register("eina_value", EINA_LOG_COLOR_DEFAULT);
  ...
  _eina_value_mp = eina_mempool_add(_eina_value_mp_choice,
                                    "value",
                                    NULL,
                                    sizeof(Eina_Value),
                                    32);
  ...
  EINA_SAFETY_ON_FALSE_RETURN_VAL((sizeof(_EINA_VALUE_TYPE_BASICS) /
                                   sizeof(_EINA_VALUE_TYPE_BASICS[0])) == 16,
                                  EFL_FALSE);
  ...
  EINA_ERROR_VALUE_FAILED =
    eina_error_msg_static_register("Eina_Value failed to copy/convert.");
...
eina_value_shutdown(void)
{
  ...
  EINA_ITERATOR_FOREACH(it, imp)
  {
    ...
    fprintf(stderr,
            "There is still %i Eina_Value in pool of size %i\n",
            imp->references,
            imp->size);
    ...
    EINA_ITERATOR_FOREACH(mit, value)
    {
      if (value->type)
      {
        ...
        fprintf(stderr,
                "Value %p of type '%s' containing '%s' still allocated.\n",
                value,
                value->type->name,
                str);
        free(str);
  ...
  else eina_hash_free(_eina_value_inner_mps);
  eina_lock_release(&_eina_value_inner_mps_lock);
  eina_lock_free(&_eina_value_inner_mps_lock);
...
EINA_API const Eina_Value_Struct_Operations
...
eina_value_copy(const Eina_Value *value, Eina_Value *copy)
{
  ...
  EINA_SAFETY_ON_FALSE_RETURN_VAL(eina_value_type_check(value->type),
                                  EFL_FALSE);
  EINA_SAFETY_ON_NULL_RETURN_VAL(copy, EFL_FALSE);
  EINA_SAFETY_ON_NULL_RETURN_VAL(value->type->copy, EFL_FALSE);

  type = value->type;
  if (!eina_value_setup(copy, type)) return EFL_FALSE;

  src = eina_value_memory_get(value);
  dst = eina_value_memory_get(copy);
  ret = type->copy(type, src, dst);
  if (!ret) eina_value_flush(copy);
...
eina_value_convert(const Eina_Value *value, Eina_Value *convert)
{
  ...
  EINA_SAFETY_ON_NULL_RETURN_VAL(value, EFL_FALSE);
  EINA_SAFETY_ON_NULL_RETURN_VAL(convert, EFL_FALSE);
  EINA_SAFETY_ON_FALSE_RETURN_VAL(eina_value_type_check(value->type),
                                  EFL_FALSE);
  ...
  if ((!ret) && (convert_type->convert_from))
    ret = convert_type->convert_from(convert_type, type, convert_mem, type_mem);
...
eina_value_to_string(const Eina_Value *value)
{
  ...
  if (!eina_value_setup(&tmp, EINA_VALUE_TYPE_STRING)) return NULL;
  if (!eina_value_convert(value, &tmp)) return NULL;
...
EINA_API Eina_Value *
eina_value_hash_new(const Eina_Value_Type *subtype,
...
{
  EINA_SAFETY_ON_NULL_RETURN_VAL(type, EFL_FALSE);
