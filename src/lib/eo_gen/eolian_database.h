...
static inline void eolian_state_vlog(const Eolian_State  *state,
                                     const Eolian_Object *obj,
                                     const char          *fmt,
                                     va_list args) EINA_ARG_NONNULL(1, 3);
static inline void
eolian_state_log(const Eolian_State *state, const char *fmt, ...)
  EINA_ARG_NONNULL(1, 2) EINA_PRINTF(2, 3);
static inline void eolian_state_log_obj(const Eolian_State  *state,
                                        const Eolian_Object *obj,
                                        const char          *fmt,
...
static inline void
eolian_state_vlog(const Eolian_State  *state,
                  const Eolian_Object *obj,
                  const char          *fmt,
                  va_list              args)
{
  Efl_Strbuf *sb = eina_strbuf_new();
...
static inline void
eolian_state_log_obj(const Eolian_State  *state,
                     const Eolian_Object *obj,
                     const char          *fmt,
                     ...)
{
...
struct _Eolian_Class
{
  ...
  Eina_List *
    requires; /* a list of required other classes only used internally */
  Eina_List *callables; /* internal for now */
  Efl_Bool   class_ctor_enable : 1;
  Efl_Bool   class_dtor_enable : 1;
};
...
struct _Eolian_Function
{
  ...
  Eolian_Class         *klass;
  Efl_Bool
    obj_is_const : 1; /* True if the object has to be const. Useful for a few methods. */
  Efl_Bool get_return_no_unused : 1; /* also used for methods */
  Efl_Bool set_return_no_unused : 1;
  Efl_Bool get_return_move      : 1;
  Efl_Bool set_return_move      : 1;
  Efl_Bool get_return_by_ref    : 1;
  Efl_Bool set_return_by_ref    : 1;
  Efl_Bool is_static            : 1;
};
...
struct _Eolian_Function_Parameter
{
  ...
  Efl_Bool optional : 1; /* True if this argument is optional */
  Efl_Bool by_ref   : 1;
  Efl_Bool move     : 1;
};
...
struct _Eolian_Implement
{
  ...
  Efl_Bool               is_prop_get      : 1;
  Efl_Bool               is_prop_set      : 1;
  Efl_Bool               get_pure_virtual : 1;
  Efl_Bool               set_pure_virtual : 1;
  Efl_Bool               get_auto         : 1;
  Efl_Bool               set_auto         : 1;
  Efl_Bool               get_empty        : 1;
  Efl_Bool               set_empty        : 1;
};
...
Efl_Bool database_validate(const Eolian_Unit *src);
Efl_Bool database_check(const Eolian_State *state);
/* if isdep is EFL_TRUE, parse as a dependency of current unit */
void database_defer(Eolian_State *state, const char *fname, Efl_Bool isdep);
...
void database_type_to_str(const Eolian_Type *tp,
                          Efl_Strbuf        *buf,
                          const char        *name,
                          Eolian_C_Type_Type ctype,
                          Efl_Bool           by_ref);
void database_typedecl_to_str(const Eolian_Typedecl *tp, Efl_Strbuf *buf);

Eolian_Typedecl *database_type_decl_find(const Eolian_Unit *src,
                                         const Eolian_Type *tp);

Efl_Bool database_type_is_ownable(const Eolian_Unit  *unit,
                                  const Eolian_Type  *tp,
                                  Efl_Bool            allow_void,
                                  const Eolian_Type **otp);

/* expressions */

typedef void (*Expr_Obj_Cb)(const Eolian_Object *obj, void *data);

Eolian_Value database_expr_eval(const Eolian_Unit     *unit,
                                Eolian_Expression     *expr,
                                Eolian_Expression_Mask mask,
                                Expr_Obj_Cb            cb,
                                void                  *data);
Eolian_Value database_expr_eval_type(const Eolian_Unit *unit,
                                     Eolian_Expression *expr,
...
void     database_function_constructor_add(Eolian_Function    *func,
                                           const Eolian_Class *klass);
Efl_Bool database_function_is_type(Eolian_Function     *fid,
