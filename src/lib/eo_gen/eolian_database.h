...
struct _Eolian_Function
{
   ...
   Eina_List *ctor_of;
   Eolian_Class *klass;
   Efl_Bool obj_is_const :1; /* True if the object has to be const. Useful for a few methods. */
...
void database_type_to_str(const Eolian_Type *tp, Efl_Strbuf *buf, const char *name, Eolian_C_Type_Type ctype, Efl_Bool by_ref);
...
Efl_Bool database_type_is_ownable(const Eolian_Unit *unit, const Eolian_Type *tp, Efl_Bool allow_void, const Eolian_Type **otp);
...
Efl_Bool database_function_is_type(Eolian_Function *fid, Eolian_Function_Type ftype);
