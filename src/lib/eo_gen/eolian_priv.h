...
_eolian_log_line(const char *file, int line, int column, const char *str)
{
  ...
  {
    fprintf(stderr,
            EINA_COLOR_RED "eolian" EINA_COLOR_RESET ": " EINA_COLOR_WHITE
                           "%s" EINA_COLOR_RESET ":%d:%d: " EINA_COLOR_ORANGE
                           "%s\n" EINA_COLOR_RESET,
            file,
            line,
            column,
...
_eolian_log(const char *str)
{
  ...
  {
    fprintf(stderr,
            EINA_COLOR_RED "eolian" EINA_COLOR_RESET ": " EINA_COLOR_ORANGE
                           "%s\n" EINA_COLOR_RESET,
            str);
  }
  else
