 ...
 * @since 1.15
 */
EINA_API char *eina_environment_home_get(void);
 ...
 * @since 1.15
 */
EINA_API char *eina_environment_tmp_get(void);
 ...
 * @since 1.19
 */
static inline Efl_Bool eina_dbl_exact(double a, double b);
 ...
 * @since 1.19
 */
static inline Efl_Bool eina_flt_exact(float a, float b);
