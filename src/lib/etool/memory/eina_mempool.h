 ...
 * @param[in] mp The mempool
 * @param[in] element The data to free
 * @return #EFL_TRUE if the element is a valid element of the mempool, #EFL_FALSE otherwise
 *
 * @since 1.20
 */
static inline Efl_Bool eina_mempool_from(Eina_Mempool *mp, void *element);
