 ...
 *
 * @return #EFL_TRUE on success, #EFL_FALSE otherwise (@a cell is @c NULL).
 *
 ...
 *
 * @return #EFL_TRUE on success, #EFL_FALSE otherwise (@a m is @c NULL,
 ...
 * call @c free_func() on the existing value, if one exists.
 *
 * @return #EFL_TRUE on success, #EFL_FALSE otherwise (@a m is @c NULL, indexes are not valid).
 *
 * @see eina_matrixsparse_cell_data_replace()
 */
 ...
 * last remaining cell contained.
 */
EINA_API Efl_Bool eina_matrixsparse_cell_clear(Eina_Matrixsparse_Cell *cell);
