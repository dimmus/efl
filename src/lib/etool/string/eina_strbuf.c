...
EINA_API Efl_Bool
eina_strbuf_append_strftime(Efl_Strbuf *buf, const char *format, const struct tm *tm)
{
   char *outputbuf;
...
EINA_API Efl_Bool
eina_strbuf_insert_strftime(Efl_Strbuf *buf, const char *format, const struct tm *tm, size_t pos)
{
   char *outputbuf;
