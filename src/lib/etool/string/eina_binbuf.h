 ...
 * @param[in] ro The passed string will not be touched if set to #EFL_TRUE.
 * @return Newly allocated string buffer instance, or @c NULL on error.
 *
 ...
 *
 * If @p ro is #EFL_TRUE, then @p str will be treated as read-only.
 ...
 *        eina_binbuf_expand().
 * @return #EFL_TRUE on success, #EFL_FALSE on failure, such as
