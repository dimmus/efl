...
static inline void _eo_log_obj_init(void) { }
static inline void _eo_log_obj_shutdown(void) { }
static inline void _eo_log_obj_ref_op(const _Eo_Object *obj EFL_UNUSED, Eo_Ref_Op ref_op EFL_UNUSED) { }
void _eo_log_obj_report(const Eo_Id id EFL_UNUSED, int log_level EFL_UNUSED, const char *func_name EFL_UNUSED, const char *file EFL_UNUSED, int line EFL_UNUSED) { }
#endif
 ...
 */
static void
_vtable_merge_defined_api(Eo_Vtable *dest, const Eo_Vtable *src, Efl_Bool *hitmap)
{
...
_vtable_func_set(Eo_Vtable *vtable, const _Efl_Class *klass,
                 ...
                 Eo_Op_Func_Type func, Efl_Bool allow_same_override)
{
   op_type_funcs *fsrc;
   unsigned short class_id = EFL_OBJECT_OP_CLASS_PART(op);
   unsigned short func_id = EFL_OBJECT_OP_FUNC_PART(op);
...
_eo_kls_itr_next(const _Efl_Class *orig_kls, const _Efl_Class *cur_klass,
                 Efl_Object_Op op, Efl_Bool super)
{
 ...
 * use when validating. */
static Efl_Bool
_eo_class_funcs_set(Eo_Vtable *vtable, const Efl_Object_Ops *ops, const _Efl_Class *hierarchy_klass, const _Efl_Class *klass, Efl_Bool override_only, unsigned int class_id, Efl_Bool *hitmap)
{
   unsigned int i, j;
   ...
   for (i = 0, j = 0, op_desc = op_descs; i < ops->count; i++, op_desc++)
     {
        ...
        if (!_vtable_func_set(vtable, klass, override_class, op2, op_desc->func, EFL_TRUE))
          return EFL_FALSE;
     }
   return EFL_TRUE;
}
...
efl_class_functions_set(const Efl_Class *klass_id, const Efl_Object_Ops *object_ops, const Efl_Object_Property_Reflection_Ops *reflection_table)
{
   ...
   return _eo_class_funcs_set(&klass->vtable, object_ops, klass, klass, EFL_FALSE, klass->class_id, hitmap);
err_funcs:
...
static Eo *
_efl_add_internal_start_do(const char *file, int line, const Efl_Class *klass_id, Eo *parent_id, Efl_Bool ref, Efl_Bool is_fallback, Efl_Substitute_Ctor_Cb substitute_ctor, void *sub_ctor_data)
{
...
EO_API Eo *
_efl_add_internal_start(const char *file, int line, const Efl_Class *klass_id, Eo *parent_id, Efl_Bool ref, Efl_Bool is_fallback)
{
   return _efl_add_internal_start_do(file, line, klass_id, parent_id, ref, is_fallback, NULL, NULL);
}

EO_API Eo * _efl_add_internal_start_bindings(const char *file, int line, const Efl_Class *klass_id, Eo *parent_id, Efl_Bool ref, Efl_Bool is_fallback, Efl_Substitute_Ctor_Cb substitute_ctor, void *sub_ctor_data)
{
   ...
   if (ops)
     {
        ...
        if (!_eo_class_funcs_set(vtable, ops, obj->klass, klass, EFL_TRUE, obj->klass->class_id, hitmap))
          {
...
static inline void
_efl_data_xunref_internal(_Eo_Object *obj EFL_UNUSED, void *data EFL_UNUSED, const _Eo_Object *ref_obj EFL_UNUSED)
{
#ifdef EO_DEBUG
   const _Efl_Class *klass = obj->klass;
   Eo_Xref_Node *xref = NULL;
...
efl_object_init(void)
{
   ...
   efl_object_optional_cow =
         eina_cow_add("Efl Object Optional Data", sizeof(Efl_Object_Optional),
                      64, &efl_object_optional_cow_default, EFL_TRUE);
...
static Efl_Bool
_eo_value_convert_to(const Eina_Value_Type *type EFL_UNUSED, const Eina_Value_Type *convert, const void *type_mem, void *convert_mem)
{
...
static Efl_Bool
_eo_value_copy(const Eina_Value_Type *type EFL_UNUSED, const void *mem, void *ptr)
{
   Eo * const *src = mem;
   Eo **dst = ptr;
