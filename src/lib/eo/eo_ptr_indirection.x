...
static void
_eo_id_mem_protect(void *ptr, Efl_Bool may_not_write)
{
# ifdef HAVE_MMAP
#  ifdef HAVE_VALGRIND
...
# define   PROTECT(_ptr_)   _eo_id_mem_protect((_ptr_), EFL_TRUE)
# define UNPROTECT(_ptr_)   _eo_id_mem_protect((_ptr_), EFL_FALSE)
#else
