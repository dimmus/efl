                                ...
                                int r, int g, int b, int a)
{
   ...
   if (a > 255) { a = 255; err = EFL_TRUE; }
   if (a < 0) { a = 0; err = EFL_TRUE; }
   if (r > a) { r = a; err = EFL_TRUE; }
   if (r < 0) { r = 0; err = EFL_TRUE; }
   if (g > a) { g = a; err = EFL_TRUE; }
   if (g < 0) { g = 0; err = EFL_TRUE; }
   if (b > a) { b = a; err = EFL_TRUE; }
   if (b < 0) { b = 0; err = EFL_TRUE; }
   if (err)
