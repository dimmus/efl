...
struct _Efl_File_Data
{
   ...
   Efl_Bool setting : 1; /* set when this file is internally calling methods to avoid infinite recursion */
   Efl_Bool loaded : 1; /* whether the currently set file properties have been loaded */
};
