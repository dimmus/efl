...
typedef struct _Ecore_Event_Message_Handler_Data
    Ecore_Event_Message_Handler_Data;
...
_ecore_event_filters_call(Eo *obj, Efl_Loop_Data *pd)
{
    ...
    Eo                               *ecore_event_handler =
        efl_provider_find(obj, ECORE_EVENT_MESSAGE_HANDLER_CLASS);
...
_ecore_event_message_handler_message_type_add(
    Eo                                  *obj,
    Ecore_Event_Message_Handler_Data *pd EFL_UNUSED)
{
...
EOLIAN static int
_ecore_event_message_handler_type_new(Eo *obj EFL_UNUSED,
                                      Ecore_Event_Message_Handler_Data *pd)
{
    Eina_Inlist **tmp;
    int           evnum;
...
EOLIAN static void *
_ecore_event_message_handler_handler_add(Eo *obj EFL_UNUSED,
                                         Ecore_Event_Message_Handler_Data *pd,
                                         int                               type,
                                         void                             *func,
                                         void                             *data)
{
    ...
    EINA_SAFETY_ON_TRUE_RETURN_VAL((type <= 0) ||
                                       (type > pd->event_type_count) || (!func),
                                   NULL);
...
EOLIAN static void *
_ecore_event_message_handler_handler_prepend(
    Eo *obj                           EFL_UNUSED,
    Ecore_Event_Message_Handler_Data *pd,
    int                               type,
    void                             *func,
...
EOLIAN static void *
_ecore_event_message_handler_handler_del(Eo *obj EFL_UNUSED,
                                         Ecore_Event_Message_Handler_Data *pd,
                                         void *handler)
{
    Handler *h = handler;
...
EOLIAN static void *
_ecore_event_message_handler_handler_data_get(
    Eo *obj                              EFL_UNUSED,
    Ecore_Event_Message_Handler_Data *pd EFL_UNUSED,
    void                                *handler)
{
...
EOLIAN static void *
_ecore_event_message_handler_handler_data_set(
    Eo *obj                              EFL_UNUSED,
    Ecore_Event_Message_Handler_Data *pd EFL_UNUSED,
    void                                *handler,
    void                                *data)
...
EOLIAN static void *
_ecore_event_message_handler_filter_add(Eo *obj EFL_UNUSED,
                                        Ecore_Event_Message_Handler_Data *pd,
                                        void *func_start,
                                        void *func_filter,
                                        void *func_end,
...
EOLIAN static void *
_ecore_event_message_handler_filter_del(Eo *obj EFL_UNUSED,
                                        Ecore_Event_Message_Handler_Data *pd,
                                        void *filter)
{
    Filter *f = filter;
...
EOLIAN static int
_ecore_event_message_handler_current_type_get(
    Eo *obj                           EFL_UNUSED,
    Ecore_Event_Message_Handler_Data *pd)
{
...
EOLIAN static void *
_ecore_event_message_handler_current_event_get(
    Eo *obj                           EFL_UNUSED,
    Ecore_Event_Message_Handler_Data *pd)
{
...
_ecore_event_message_handler_efl_object_constructor(
    Eo                               *obj,
    Ecore_Event_Message_Handler_Data *pd)
{
...
EOLIAN static void
_ecore_event_message_handler_efl_object_destructor(
    Eo                               *obj,
    Ecore_Event_Message_Handler_Data *pd)
{
    Handler *h;
    ...
    Efl_Loop_Message                 *message)
{
    ...
    ecore_event_message_data_steal(message,
                                   &type,
                                   &data,
                                   &free_func,
                                   &free_data);
    ...
    efl_event_callback_call(
        obj,
        ECORE_EVENT_MESSAGE_HANDLER_EVENT_MESSAGE_ECORE_EVENT,
        message);
...
_flush_cb(void *data, void *handler EFL_UNUSED, void *message)
{
    ...
    if (!efl_isa(message, ECORE_EVENT_MESSAGE_CLASS)) return EFL_TRUE;
    ecore_event_message_data_get(message, &evtype, NULL, NULL, NULL);
    return *type != evtype;
}

EOLIAN static void
_ecore_event_message_handler_type_flush(Eo *obj,
                                        Ecore_Event_Message_Handler_Data *pd
                                            EFL_UNUSED,
                                        int type)
{
