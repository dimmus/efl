...
EOLIAN static void
_efl_io_sizer_fd_sizer_fd_set(Eo *o                 EFL_UNUSED,
...
_efl_io_sizer_fd_efl_io_sizer_resize(Eo                      *o,
                                     Efl_Io_Sizer_Fd_Data *pd EFL_UNUSED,
                                     uint64_t                 size)
{
...
_efl_io_sizer_fd_efl_io_sizer_size_get(const Eo                *o,
                                       Efl_Io_Sizer_Fd_Data *pd EFL_UNUSED)
{
    int         fd = efl_io_sizer_fd_get(o);
    struct stat st;
