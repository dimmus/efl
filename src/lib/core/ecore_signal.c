...
static void _ecore_signal_waitpid(Efl_Bool once, siginfo_t info);
        ...
        while (1)
        {
            ...
            switch (sdata.sig)
            {
                ...
                case SIGALRM:
                    break;
                case SIGCHLD:
                    _ecore_signal_waitpid(EFL_FALSE, sdata.info);
                    break;
                case SIGUSR1:
                case SIGUSR2:
                    {
                        ...
                        if (e)
                        {
                            ...
                            e->data = sdata.info;
                            ecore_event_add(ECORE_EVENT_SIGNAL_USER,
                                            e,
                                            _ecore_signal_generic_free,
                                            NULL);
                        }
                ...
                case SIGHUP:
                    {
                        ...
                        {
                            e->data = sdata.info;
                            ecore_event_add(ECORE_EVENT_SIGNAL_HUP,
                                            e,
                                            _ecore_signal_generic_free,
                                            NULL);
                        }
                ...
                case SIGTERM:
                    {
                        ...
                        if (e)
                        {
                            ...
                            e->data = sdata.info;
                            ecore_event_add(ECORE_EVENT_SIGNAL_EXIT,
                                            e,
                                            _ecore_signal_generic_free,
                                            NULL);
                        }
                ...
                case SIGPWR:
                    {
                        ...
                        {
                            e->data = sdata.info;
                            ecore_event_add(ECORE_EVENT_SIGNAL_POWER,
                                            e,
                                            _ecore_signal_generic_free,
                                            NULL);
                        }
...
static void
_ecore_signal_waitpid(Efl_Bool once, siginfo_t info)
{
    pid_t pid;
    int   status;
    ...
    while ((pid = waitpid(-1, &status, WNOHANG)) > 0)
    {
        ...
        if (e)
        {
                             ...
                             (ECORE_EXE_PIPE_READ | ECORE_EXE_PIPE_ERROR)))
            {
                ...
                ecore_event_add(ECORE_EXE_EVENT_DEL,
                                e,
