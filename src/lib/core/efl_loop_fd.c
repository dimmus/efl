...
static int
_efl_loop_fd_fd_get(const Eo *obj EFL_UNUSED, Efl_Loop_Fd_Data *pd)
{
...
static int
_efl_loop_fd_fd_file_get(const Eo *obj EFL_UNUSED, Efl_Loop_Fd_Data *pd)
{
...
_check_fd_event_catcher_add(void *data, const Efl_Event *event)
{
    ...
    if (need_reset) _efl_loop_fd_reset(event->object, fd);
}
...
static void
_efl_loop_fd_efl_object_parent_set(Eo               *obj,
                                   Efl_Loop_Fd_Data *pd,
                                   Efl_Object       *parent)
{
