...
struct _Ecore_Getopt_Desc_Callback
{
   Efl_Bool                         (*func)(const Ecore_Getopt *parser,
 ...
 */
EAPI Efl_Bool  ecore_getopt_help_category(FILE *fp, const Ecore_Getopt *info, const char *category);
 ...
 */
EAPI Efl_Bool  ecore_getopt_callback_geometry_parse(const Ecore_Getopt *parser, const Ecore_Getopt_Desc *desc, const char *str, void *data, Ecore_Getopt_Value *storage);
 ...
 * @c callback_data value is ignored, you can safely use @c NULL.
 */
EAPI Efl_Bool  ecore_getopt_callback_size_parse(const Ecore_Getopt *parser, const Ecore_Getopt_Desc *desc, const char *str, void *data, Ecore_Getopt_Value *storage);
