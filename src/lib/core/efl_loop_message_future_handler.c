...
typedef struct _Efl_Loop_Message_Future_Handler_Data
    Efl_Loop_Message_Future_Handler_Data;
...
_efl_loop_message_future_handler_message_type_add(
    Eo                                      *obj,
    Efl_Loop_Message_Future_Handler_Data *pd EFL_UNUSED)
{
...
_efl_loop_message_future_handler_efl_object_constructor(
    Eo                                      *obj,
    Efl_Loop_Message_Future_Handler_Data *pd EFL_UNUSED)
{
...
EOLIAN static void
_efl_loop_message_future_handler_efl_object_destructor(
    Eo                                      *obj,
    Efl_Loop_Message_Future_Handler_Data *pd EFL_UNUSED)
{
...
EOLIAN static void
_efl_loop_message_future_handler_efl_loop_message_handler_message_call(
    Eo                                      *obj,
    Efl_Loop_Message_Future_Handler_Data *pd EFL_UNUSED,
