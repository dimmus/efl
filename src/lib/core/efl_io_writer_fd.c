...
EOLIAN static void
_efl_io_writer_fd_writer_fd_set(Eo *o                  EFL_UNUSED,
...
_efl_io_writer_fd_efl_io_writer_write(Eo                       *o,
                                      Efl_Io_Writer_Fd_Data *pd EFL_UNUSED,
                                      Eina_Slice               *ro_slice,
...
EOLIAN static void
_efl_io_writer_fd_efl_io_writer_can_write_set(Eo                    *o,
                                              Efl_Io_Writer_Fd_Data *pd,
                                              Efl_Bool               can_write)
{
