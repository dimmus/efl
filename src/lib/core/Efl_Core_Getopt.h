#ifndef _CORE_GETOPT_H
#define _CORE_GETOPT_H
...
/**
 * @ingroup Ecore
 * @defgroup Core_Getopt_Group Ecore Getopt
 *
...
/**
 * @typedef Core_Getopt_Desc_Arg_Requirement
...
typedef struct _Core_Getopt_Desc_Callback Core_Getopt_Desc_Callback;
 ...
 * @brief Structure used when action is CORE_GETOPT_ACTION_STORE. It contains
 ...
 * @brief Structure used when action is CORE_GETOPT_ACTION_CALLBACK. It
...
/**
 * @brief Definition for macro that fills an option in Core_Getopt_Desc table.
 *
 ...
 */
#define CORE_GETOPT_STORE(shortname, longname, help, type)      \
  CORE_GETOPT_STORE_FULL(shortname, longname, help, NULL, type, \
                          CORE_GETOPT_DESC_ARG_REQUIREMENT_YES, {})
/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type string.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_STR(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_STR)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type boolean.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_BOOL(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_BOOL)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type short.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_SHORT(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_SHORT)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type int.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_INT(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_INT)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type long.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_LONG(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_LONG)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type ushort.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_USHORT(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_USHORT)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type uint.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_UINT(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_UINT)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type ulong.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_ULONG(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_ULONG)

/**
 * @brief Definition for macro that fill Core_Getopt_Desc table with an option of type double.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_DOUBLE(shortname, longname, help) \
  CORE_GETOPT_STORE(shortname, longname, help, CORE_GETOPT_TYPE_DOUBLE)

/**
 * Definition for macro that helps to fill the Core_Getopt_Desc table with a metavar after
 * the description of the option.
 */
#define CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, type) \
  CORE_GETOPT_STORE_FULL(shortname, longname, help, metavar, type,          \
                          CORE_GETOPT_DESC_ARG_REQUIREMENT_YES, {})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type string and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 ...
 */
#define CORE_GETOPT_STORE_METAVAR_STR(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_STR)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type boolean and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_BOOL(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_BOOL)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type short and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_SHORT(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_SHORT)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type int and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_INT(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_INT)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type long and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_LONG(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_LONG)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned short and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_USHORT(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_USHORT)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned int and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_UINT(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_UINT)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned long and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_ULONG(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_ULONG)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type double and metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param metavar The metavar message concerning the parameter of the option.
 */
#define CORE_GETOPT_STORE_METAVAR_DOUBLE(shortname, longname, help, metavar) \
  CORE_GETOPT_STORE_METAVAR(shortname, longname, help, metavar, CORE_GETOPT_TYPE_DOUBLE)

/**
 * Definition for macro that helps to fill the Core_Getopt_Desc table with a default value.
 */
#define CORE_GETOPT_STORE_DEF(shortname, longname, help, type, default_value) \
  CORE_GETOPT_STORE_FULL(shortname, longname, help, NULL, type,               \
                          CORE_GETOPT_DESC_ARG_REQUIREMENT_OPTIONAL,          \
                          default_value)

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type string and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 ...
 */
#define CORE_GETOPT_STORE_DEF_STR(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                          \
                         CORE_GETOPT_TYPE_STR,                              \
                         {.strv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type boolean and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_BOOL(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                           \
                         CORE_GETOPT_TYPE_BOOL,                              \
                         {.boolv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type short and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_SHORT(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                            \
                         CORE_GETOPT_TYPE_SHORT,                              \
                         {.shortv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type int and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_INT(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                          \
                         CORE_GETOPT_TYPE_INT,                              \
                         {.intv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type long and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_LONG(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                           \
                         CORE_GETOPT_TYPE_LONG,                              \
                         {.longv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned short and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_USHORT(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                             \
                         CORE_GETOPT_TYPE_USHORT,                              \
                         {.ushortv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned int and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_UINT(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                           \
                         CORE_GETOPT_TYPE_UINT,                              \
                         {.uintv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type unsigned long and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_ULONG(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                            \
                         CORE_GETOPT_TYPE_ULONG,                              \
                         {.ulongv = default_value})

/**
 * @brief Definition for filling Core_Getopt_Desc table with an option of type double and default value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 * @param default_value The default value for the parameter of the option.
 */
#define CORE_GETOPT_STORE_DEF_DOUBLE(shortname, longname, help, default_value) \
  CORE_GETOPT_STORE_DEF(shortname, longname, help,                             \
                         CORE_GETOPT_TYPE_DOUBLE,                              \
                         {.doublev = default_value})

/**
 * @brief Definition for filling full string type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full boolean type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full short type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full int type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full long type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full unsigned short type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full unsigned int type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full unsigned long type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling full double type option description in Core_Getopt_Desc table.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling Core_Getopt_Desc table with a constant value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 ...
 */
#define CORE_GETOPT_STORE_CONST(shortname, longname, help, value)   \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_STORE_CONST, \
   {.store_const = value}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a true boolean value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_TRUE(shortname, longname, help)          \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_STORE_TRUE, \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a false boolean value.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_STORE_FALSE(shortname, longname, help)          \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_STORE_FALSE, \
   {.dummy = NULL}}
 ...
 */
#define CORE_GETOPT_CHOICE(shortname, longname, help, choices_array) \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_CHOICE,       \
   {.choices = choices_array}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a choice.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling Core_Getopt_Desc table with an append action.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 ...
 */
#define CORE_GETOPT_APPEND(shortname, longname, help, sub_type) \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_APPEND,  \
   {.append_type = sub_type}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with an append action and a metavar.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 ...
 */
#define CORE_GETOPT_APPEND_METAVAR(shortname, longname, help, metavar, type) \
  {shortname, longname, help, metavar, CORE_GETOPT_ACTION_APPEND,            \
   {.append_type = type}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with an count action.
 *
 ...
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_COUNT(shortname, longname, help)          \
  {shortname, longname, help, NULL, CORE_GETOPT_ACTION_COUNT, \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with an callback action and argument requirements.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling Core_Getopt_Desc table with an callback action and no arguments.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling Core_Getopt_Desc table with an callback action.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
...
/**
 * @brief Definition for filling Core_Getopt_Desc table with a help action.
 *
 * @param shortname The help option short name.
 * @param longname The help option long name.
 */
#define CORE_GETOPT_HELP(shortname, longname)            \
  {shortname, longname, "show this message.", "CATEGORY", \
   CORE_GETOPT_ACTION_HELP,                              \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a version action.
 *
 * @param shortname The version option short name.
 * @param longname The version option long name.
 */
#define CORE_GETOPT_VERSION(shortname, longname)      \
  {shortname, longname, "show program version.", NULL, \
   CORE_GETOPT_ACTION_VERSION,                        \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a copyright action.
 *
 * @param shortname The copyright option short name.
 * @param longname The copyright option long name.
 */
#define CORE_GETOPT_COPYRIGHT(shortname, longname) \
  {shortname, longname, "show copyright.", NULL,    \
   CORE_GETOPT_ACTION_COPYRIGHT,                   \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a license action.
 *
 * @param shortname The license option short name.
 * @param longname The license option long name.
 */
#define CORE_GETOPT_LICENSE(shortname, longname) \
  {shortname, longname, "show license.", NULL,    \
   CORE_GETOPT_ACTION_LICENSE,                   \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a break action.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 */
#define CORE_GETOPT_BREAK(shortname, longname) \
  {shortname, longname, "stop parsing options.", NULL,    \
   CORE_GETOPT_ACTION_BREAK,                   \
   {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a break action with help message.
 *
 * @param shortname The option short name.
 * @param longname The option long name.
 * @param help The help message concerning this option.
 */
#define CORE_GETOPT_BREAK_STR(shortname, longname, help) \
  {shortname, longname, help, NULL,    \
   CORE_GETOPT_ACTION_BREAK,                   \
   {.dummy = NULL}}

#define CORE_GETOPT_CATEGORY(name, help) \
  {0, name, help, NULL, CORE_GETOPT_ACTION_CATEGORY, {.dummy = NULL}}

/**
 * @brief Definition for filling Core_Getopt_Desc table with a sentinel to indicate the end of descriptions.
 *
 */
#define CORE_GETOPT_SENTINEL {0, NULL, NULL, NULL, 0, {.dummy = NULL}}
 ...
 */
#define CORE_GETOPT_VALUE_STR(val)      {.strp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_BOOL(val)     {.boolp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_SHORT(val)    {.shortp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_INT(val)      {.intp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_LONG(val)     {.longp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_USHORT(val)   {.ushortp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_UINT(val)     {.uintp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_ULONG(val)    {.ulongp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_DOUBLE(val)   {.doublep = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_PTR(val)      {.ptrp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_PTR_CAST(val) {.ptrp = (void **)&(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_LIST(val)     {.listp = &(val)}
 ...
 * @param val The value to store.
 */
#define CORE_GETOPT_VALUE_NONE {.ptrp = NULL}
 ...
 * action @c CORE_GETOPT_ACTION_STORE and non required arguments
 * (others than @c CORE_GETOPT_DESC_ARG_REQUIREMENT_YES), are expected
 ...
 * executed:
 *   - @c CORE_GETOPT_ACTION_HELP
 *   - @c CORE_GETOPT_ACTION_VERSION
 *   - @c CORE_GETOPT_ACTION_COPYRIGHT
 *   - @c CORE_GETOPT_ACTION_LICENSE
 *
 * Just @c CORE_GETOPT_ACTION_APPEND will allocate memory and thus
 ...
 * that is, for @c CORE_GETOPT_TYPE_STR it will contain a copy of the
 * argument, @c CORE_GETOPT_TYPE_INT a pointer to an allocated
 * integer and so on.
 *
 * If parser is in strict mode (see @c Core_Getopt->strict), then any
 ...
 * empty), then you must call core_getopt_parse_positional() with the
 ...
 *        retrieved with core_app_args_get().
 ...
 * parser->descs, same as with core_getopt_parse().
 *
 * All values are expected to be initialized before use.
 *
 * Unlike the core_getopt_parse(), only the following options are
 * supported:
 *  - @c CORE_GETOPT_ACTION_STORE
 *  - @c CORE_GETOPT_ACTION_CHOICE
 *  - @c CORE_GETOPT_ACTION_APPEND
 *  - @c CORE_GETOPT_ACTION_CALLBACK
 *
 * There is a special case for @c CORE_GETOPT_ACTION_APPEND as it
 ...
 * CORE_GETOPT_TYPE_STR it will contain a copy of the argument, @c
 * CORE_GETOPT_TYPE_INT a pointer to an allocated integer and so on.
 *
 * If parser is in strict mode (see @c Core_Getopt->strict), then any
 * error will abort parsing and @c -1 is returned. Otherwise it will try
 * to continue as far as possible.
 ...
 *        return of core_getopt_parse(). If less than 1, will try to
 ...
 */
EAPI Eina_List *Core_getopt_list_free(Eina_List *list);

/**
 * Helper Core_getopt callback to parse geometry (x:y:w:h).
 *
 ...
 *
 * This is a helper function to be used with CORE_GETOPT_CALLBACK_*().
 *
