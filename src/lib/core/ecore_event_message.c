...
EOLIAN static void
_ecore_event_message_data_set(Eo *obj                   EFL_UNUSED,
                              Ecore_Event_Message_Data *pd,
                              int                       type,
                              void                     *data,
                              void                     *free_func,
                              void                     *free_data)
...
EOLIAN static void
_ecore_event_message_data_get(const Eo *obj             EFL_UNUSED,
                              Ecore_Event_Message_Data *pd,
                              int                      *type,
                              void                    **data,
                              void                    **free_func,
...
EOLIAN static void
_ecore_event_message_data_steal(Eo *obj                   EFL_UNUSED,
                                Ecore_Event_Message_Data *pd,
                                int                      *type,
                                void                    **data,
                                void                    **free_func,
...
_ecore_event_message_efl_object_constructor(Eo *obj,
                                            Ecore_Event_Message_Data *pd
                                                EFL_UNUSED)
{
...
EOLIAN static void
_ecore_event_message_efl_object_destructor(Eo *obj EFL_UNUSED,
                                           Ecore_Event_Message_Data *pd
                                               EFL_UNUSED)
{
    if (pd->ev)
