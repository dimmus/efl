...
_efl_cubic_bezier_interpolator_efl_interpolator_interpolate(
...
EOLIAN static void
_efl_cubic_bezier_interpolator_control_points_set(
  Eo *eo_obj                          EFL_UNUSED,
...
EOLIAN static void
_efl_cubic_bezier_interpolator_control_points_get(
  const Eo *eo_obj                    EFL_UNUSED,
  Efl_Cubic_Bezier_Interpolator_Data *pd,
  Eina_Vector2                       *p1,
  Eina_Vector2                       *p2)
{
...
_efl_cubic_bezier_interpolator_efl_object_constructor(
  Eo                                 *eo_obj,
  Efl_Cubic_Bezier_Interpolator_Data *pd)
{
