...
static Efl_Loop *
_efl_loop_consumer_loop_get(const Eo                  *obj,
                            Efl_Loop_Consumer_Data *pd EFL_UNUSED)
{
...
static void
_efl_loop_consumer_efl_object_parent_set(Eo                        *obj,
                                         Efl_Loop_Consumer_Data *pd EFL_UNUSED,
                                         Efl_Object                *parent)
{
...
static Eina_Future *
_efl_loop_consumer_future_resolved(const Eo                  *obj,
                                   Efl_Loop_Consumer_Data *pd EFL_UNUSED,
                                   Eina_Value                 result)
{
...
static Eina_Future *
_efl_loop_consumer_future_rejected(const Eo                  *obj,
                                   Efl_Loop_Consumer_Data *pd EFL_UNUSED,
                                   Eina_Error                 error)
{
...
static Eina_Promise *
_efl_loop_consumer_promise_new(const Eo                  *obj,
                               Efl_Loop_Consumer_Data *pd EFL_UNUSED)
{
