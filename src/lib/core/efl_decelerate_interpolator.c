...
_efl_decelerate_interpolator_efl_interpolator_interpolate(
  Eo *eo_obj                           EFL_UNUSED,
  Efl_Decelerate_Interpolator_Data *pd EFL_UNUSED,
  double                               progress)
{
  if ((progress < 0.0) || (progress > 1.0)) return progress;

  return core_animator_pos_map(progress,
                               CORE_POS_MAP_DECELERATE_FACTOR,
                               pd->slope,
                               0);
}

EOLIAN static void
_efl_decelerate_interpolator_slope_set(Eo *eo_obj EFL_UNUSED,
...
EOLIAN static double
_efl_decelerate_interpolator_slope_get(const Eo *eo_obj EFL_UNUSED,
                                       Efl_Decelerate_Interpolator_Data *pd
                                         EFL_UNUSED)
{
  return pd->slope;
...
_efl_decelerate_interpolator_efl_object_constructor(
  Eo                               *eo_obj,
  Efl_Decelerate_Interpolator_Data *pd)
{
