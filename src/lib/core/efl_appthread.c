...
_efl_appthread_efl_io_closer_closed_get(const Eo *obj       EFL_UNUSED,
...
EOLIAN static Eina_Error
_efl_appthread_efl_io_reader_read(Eo                 *obj,
                                  Efl_Appthread_Data *pd,
...
EOLIAN static void
_efl_appthread_efl_io_reader_can_read_set(Eo                 *obj,
                                          Efl_Appthread_Data *pd,
                                          Efl_Bool            can_read)
{
  ...
  if (can_read) efl_loop_handler_active_set(pd->fd.in_handler, 0);
  else
    efl_loop_handler_active_set(pd->fd.in_handler, EFL_LOOP_HANDLER_FLAGS_READ);
  efl_event_callback_call(obj, EFL_IO_READER_EVENT_CAN_READ_CHANGED, &can_read);
}

EOLIAN static Efl_Bool
_efl_appthread_efl_io_reader_can_read_get(const Eo *obj       EFL_UNUSED,
                                          Efl_Appthread_Data *pd)
{
...
EOLIAN static void
_efl_appthread_efl_io_reader_eos_set(Eo                 *obj,
                                     Efl_Appthread_Data *pd,
                                     Efl_Bool            is_eos)
{
...
EOLIAN static Efl_Bool
_efl_appthread_efl_io_reader_eos_get(const Eo *obj       EFL_UNUSED,
                                     Efl_Appthread_Data *pd)
{
...
EOLIAN static Eina_Error
_efl_appthread_efl_io_writer_write(Eo                 *obj,
                                   Efl_Appthread_Data *pd,
                                   Eina_Slice         *slice,
...
EOLIAN static void
_efl_appthread_efl_io_writer_can_write_set(Eo                 *obj,
                                           Efl_Appthread_Data *pd,
                                           Efl_Bool            can_write)
{
...
EOLIAN static Efl_Bool
_efl_appthread_efl_io_writer_can_write_get(const Eo *obj       EFL_UNUSED,
                                           Efl_Appthread_Data *pd)
{
  return pd->fd.can_write;
}

void _appthread_threadio_call(Eo                 *obj,
                              Efl_Appthread_Data *pd,
                              void               *func_data,
...
EOLIAN static void
_efl_appthread_efl_threadio_call(Eo                 *obj,
                                 Efl_Appthread_Data *pd,
                                 void               *func_data,
                                 EflThreadIOCall     func,
                                 Eina_Free_Cb        func_free_cb)
...
void *_appthread_threadio_call_sync(Eo                 *obj,
                                    Efl_Appthread_Data *pd,
                                    void               *func_data,
...
EOLIAN static void *
_efl_appthread_efl_threadio_call_sync(Eo                 *obj,
                                      Efl_Appthread_Data *pd,
                                      void               *func_data,
                                      EflThreadIOCallSync func,
                                      Eina_Free_Cb        func_free_cb)
