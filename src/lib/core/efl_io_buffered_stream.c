...
static void
_efl_io_buffered_stream_copier_progress(void                  *data,
                                        const Efl_Event *event EFL_UNUSED)
{
  Eo *o = data;
...
static void
_efl_io_buffered_stream_incoming_can_read_changed(void            *data,
...
static void
_efl_io_buffered_stream_incoming_slice_changed(void *data,
                                               const Efl_Event *event
                                                 EFL_UNUSED)
{
  Eo *o = data;
...
EFL_CALLBACKS_ARRAY_DEFINE(
  _efl_io_buffered_stream_incoming_cbs,
  { EFL_IO_READER_EVENT_CAN_READ_CHANGED,
    _efl_io_buffered_stream_incoming_can_read_changed },
  { EFL_IO_QUEUE_EVENT_SLICE_CHANGED,
    _efl_io_buffered_stream_incoming_slice_changed });
...
static void
_efl_io_buffered_stream_receiver_done(void                  *data,
                                      const Efl_Event *event EFL_UNUSED)
{
  Eo *o = data;
  if (efl_io_closer_closed_get(o)) return; /* already closed (or closing) */
...
EFL_CALLBACKS_ARRAY_DEFINE(
  _efl_io_buffered_stream_receiver_cbs,
...
static void
_efl_io_buffered_stream_outgoing_can_write_changed(void            *data,
                                                   const Efl_Event *event)
{
  Eo *o = data;
  if (efl_io_closer_closed_get(o)) return; /* already closed (or closing) */
...
EFL_CALLBACKS_ARRAY_DEFINE(
  _efl_io_buffered_stream_outgoing_cbs,
  { EFL_IO_WRITER_EVENT_CAN_WRITE_CHANGED,
    _efl_io_buffered_stream_outgoing_can_write_changed });

static void
_efl_io_buffered_stream_sender_done(void                  *data,
                                    const Efl_Event *event EFL_UNUSED)
{
  Eo                          *o  = data;
  Efl_Io_Buffered_Stream_Data *pd = efl_data_scope_get(o, MY_CLASS);
  size_t                       pending =
    pd->receiver ? efl_io_copier_pending_size_get(pd->receiver) : 0;
...
EFL_CALLBACKS_ARRAY_DEFINE(
  _efl_io_buffered_stream_sender_cbs,
  { EFL_IO_COPIER_EVENT_PROGRESS, _efl_io_buffered_stream_copier_progress },
...
_efl_io_buffered_stream_inner_io_del(void *data, const Efl_Event *event)
{
  ...
  if (pd->inner_io == event->object) pd->inner_io = NULL;
}

EFL_CALLBACKS_ARRAY_DEFINE(_efl_io_buffered_stream_inner_io_cbs,
                           { EFL_EVENT_DEL,
                             _efl_io_buffered_stream_inner_io_del });

EOLIAN static Efl_Object *
_efl_io_buffered_stream_efl_object_finalize(Eo                          *o,
                                              ...
                                              Efl_Io_Buffered_Stream_Data *pd)
{
  ...
  if (pd->inner_io)
  {
    efl_event_callback_array_del(pd->inner_io,
                                 _efl_io_buffered_stream_inner_io_cbs(),
                                 o);
    if (efl_parent_get(pd->inner_io) == o) efl_parent_set(pd->inner_io, NULL);
    else efl_unref(pd->inner_io); /* do not del, just take our ref */
    pd->inner_io = NULL;
  }
...
_efl_io_buffered_stream_efl_io_closer_close(Eo                          *o,
                                            Efl_Io_Buffered_Stream_Data *pd)
{
  Eina_Error err = 0;
  ...
  pd->is_closing = EFL_TRUE;

  if (pd->outgoing)
  {
    efl_io_queue_eos_mark(pd->outgoing);
    efl_io_copier_flush(pd->sender, EFL_FALSE, EFL_TRUE);
  }

   /* line delimiters may be holding a last chunk of data */
  if (pd->receiver) efl_io_copier_flush(pd->receiver, EFL_FALSE, EFL_TRUE);
...
_efl_io_buffered_stream_efl_io_closer_closed_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_closer_close_on_exec_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_closer_close_on_exec_set(
  Eo *o                        EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd,
  Efl_Bool                     value)
{
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_closer_close_on_invalidate_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static void
_efl_io_buffered_stream_efl_io_closer_close_on_invalidate_set(
  Eo *o                        EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd,
  Efl_Bool                     value)
{
...
EOLIAN static Eina_Error
_efl_io_buffered_stream_efl_io_reader_read(Eo                          *o,
                                           Efl_Io_Buffered_Stream_Data *pd,
                                           Eina_Rw_Slice *rw_slice)
{
  ...
  if (!pd->incoming)
  {
    WRN("%p reading from inner_io %p (%s) that doesn't implement "
        "Efl.Io.Reader",
        o,
        pd->inner_io,
        efl_class_name_get(efl_class_get(pd->inner_io)));
    return EINVAL;
  }
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_reader_can_read_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
  return pd->can_read;
...
EOLIAN static void
_efl_io_buffered_stream_efl_io_reader_can_read_set(
  Eo                             *o,
  Efl_Io_Buffered_Stream_Data *pd EFL_UNUSED,
  Efl_Bool                        can_read)
{
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_reader_eos_get(const Eo *o EFL_UNUSED,
                                              Efl_Io_Buffered_Stream_Data *pd)
{
  return pd->eos;
}
                                              ...
                                              Efl_Bool is_eos)
{
  ...
  if ((!pd->sender) || efl_io_copier_done_get(pd->sender))
  {
    ...
    DBG("%p eos, waiting for sender process %zd to call 'finished'",
        o,
        pending);
  efl_unref(o);
}
...
EOLIAN static Eina_Error
_efl_io_buffered_stream_efl_io_writer_write(Eo                          *o,
                                            Efl_Io_Buffered_Stream_Data *pd,
                                            Eina_Slice                  *slice,
                                            Eina_Slice *remaining)
{
  ...
  if (!pd->outgoing)
  {
    WRN("%p writing to inner_io %p (%s) that doesn't implement "
        "Efl.Io.Writer",
        o,
        pd->inner_io,
        efl_class_name_get(efl_class_get(pd->inner_io)));
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_efl_io_writer_can_write_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
  return pd->can_write;
...
EOLIAN static void
_efl_io_buffered_stream_efl_io_writer_can_write_set(
  Eo                             *o,
  Efl_Io_Buffered_Stream_Data *pd EFL_UNUSED,
  Efl_Bool                        can_write)
{
...
EOLIAN static void
_efl_io_buffered_stream_inner_io_set(Eo                          *o,
                                     Efl_Io_Buffered_Stream_Data *pd,
                                     Efl_Object                  *io)
{
  Efl_Bool is_reader, is_writer;
  ...
  if (is_reader)
  {
    DBG("%p inner_io=%p (%s) is Efl.Io.Reader",
        o,
        io,
        efl_class_name_get(efl_class_get(io)));
    pd->incoming = efl_add(
      EFL_IO_QUEUE_CLASS,
      o,
  ...
  {
    DBG("%p inner_io=%p (%s) is not Efl.Io.Reader",
        o,
        io,
        efl_class_name_get(efl_class_get(io)));
    efl_io_reader_eos_set(o, EFL_TRUE);
  ...
  if (is_writer)
  {
    DBG("%p inner_io=%p (%s) is Efl.Io.Writer",
        o,
        io,
        efl_class_name_get(efl_class_get(io)));
    pd->outgoing = efl_add(
    ...
    DBG("%p inner_io=%p (%s) is not Efl.Io.Writer",
        o,
        io,
        efl_class_name_get(efl_class_get(io)));
}
...
EOLIAN static Efl_Object *
_efl_io_buffered_stream_inner_io_get(const Eo *o                  EFL_UNUSED,
                                     Efl_Io_Buffered_Stream_Data *pd)
{
  return pd->inner_io;
}
...
EOLIAN static void
_efl_io_buffered_stream_max_queue_size_input_set(
  Eo *o                        EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd,
  size_t                       max_queue_size_input)
{
  if (!pd->incoming)
  {
    DBG("%p inner_io=%p (%s) is not Efl.Io.Reader, limit=%zu ignored",
        o,
        pd->inner_io,
        efl_class_name_get(efl_class_get(pd->inner_io)),
...
_efl_io_buffered_stream_max_queue_size_input_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static void
_efl_io_buffered_stream_max_queue_size_output_set(
  Eo *o                        EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd,
  size_t                       max_queue_size_output)
{
  if (!pd->outgoing)
  {
    DBG("%p inner_io=%p (%s) is not Efl.Io.Writer, limit=%zu ignored",
        o,
        pd->inner_io,
        efl_class_name_get(efl_class_get(pd->inner_io)),
        max_queue_size_output);
    return;
  }
...
EOLIAN static size_t
_efl_io_buffered_stream_max_queue_size_output_get(
  const Eo *o                  EFL_UNUSED,
  Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static void
_efl_io_buffered_stream_line_delimiter_set(Eo *o EFL_UNUSED,
                                           Efl_Io_Buffered_Stream_Data *pd,
                                           Eina_Slice                   slice)
{
  if (!pd->receiver)
  {
    DBG("%p inner_io=%p (%s) is not Efl.Io.Reader, slice=" EINA_SLICE_FMT
        " ignored",
        o,
        pd->inner_io,
        efl_class_name_get(efl_class_get(pd->inner_io)),
...
_efl_io_buffered_stream_line_delimiter_get(const Eo *o EFL_UNUSED,
                                           Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static void
_efl_io_buffered_stream_timeout_inactivity_set(Eo *o EFL_UNUSED,
                                               Efl_Io_Buffered_Stream_Data *pd,
                                               double seconds)
{
  if (pd->receiver) efl_io_copier_timeout_inactivity_set(pd->receiver, seconds);
  if (pd->sender) efl_io_copier_timeout_inactivity_set(pd->sender, seconds);
}

EOLIAN static double
_efl_io_buffered_stream_timeout_inactivity_get(const Eo *o EFL_UNUSED,
                                               Efl_Io_Buffered_Stream_Data *pd)
{
  if (pd->receiver) return efl_io_copier_timeout_inactivity_get(pd->receiver);
  if (pd->sender) return efl_io_copier_timeout_inactivity_get(pd->sender);
  return 0.0;
}

EOLIAN static void
_efl_io_buffered_stream_read_chunk_size_set(Eo *o EFL_UNUSED,
                                            Efl_Io_Buffered_Stream_Data *pd,
                                            size_t                       size)
{
  if (pd->sender)
...
EOLIAN static size_t
_efl_io_buffered_stream_read_chunk_size_get(const Eo *o EFL_UNUSED,
                                            Efl_Io_Buffered_Stream_Data *pd)
{
...
EOLIAN static size_t
_efl_io_buffered_stream_pending_write_get(const Eo *o EFL_UNUSED,
                                          Efl_Io_Buffered_Stream_Data *pd)
{
  if (!pd->outgoing) return 0;
...
EOLIAN static size_t
_efl_io_buffered_stream_pending_read_get(const Eo *o EFL_UNUSED,
                                         Efl_Io_Buffered_Stream_Data *pd)
{
  if (!pd->incoming) return 0;
...
EOLIAN static void
_efl_io_buffered_stream_progress_get(const Eo *o                  EFL_UNUSED,
                                     Efl_Io_Buffered_Stream_Data *pd,
                                     size_t                      *pr,
                                     size_t                      *pw)
{
...
EOLIAN static Eina_Slice
_efl_io_buffered_stream_slice_get(const Eo *o                  EFL_UNUSED,
                                  Efl_Io_Buffered_Stream_Data *pd)
{
  Eina_Slice slice = {};

  if (pd->incoming) slice = efl_io_queue_slice_get(pd->incoming);

  return slice;
}

EOLIAN static void
_efl_io_buffered_stream_discard(Eo *o                        EFL_UNUSED,
                                Efl_Io_Buffered_Stream_Data *pd,
                                size_t                       amount)
{
...
EOLIAN static void
_efl_io_buffered_stream_clear(Eo *o EFL_UNUSED, Efl_Io_Buffered_Stream_Data *pd)
{
  if (!pd->incoming) return;
...
EOLIAN static Efl_Bool
_efl_io_buffered_stream_flush(Eo                          *o,
                              Efl_Io_Buffered_Stream_Data *pd,
                              Efl_Bool                     may_block,
                              Efl_Bool ignore_line_delimiter)
{
  size_t   pending;
  Efl_Bool ret;

  EINA_SAFETY_ON_TRUE_RETURN_VAL(efl_io_closer_closed_get(o), EFL_FALSE);

  if (!pd->outgoing) return EFL_TRUE;

  pending = efl_io_queue_usage_get(pd->outgoing);
  if (!pending) return EFL_TRUE;
  ...
  DBG("%p attempt to flush %zu bytes, may_block=%hhu, "
      "ignore_line_delimiter=%hhu...",
      o,
      pending,
      may_block,
      ignore_line_delimiter);
  ret = efl_io_copier_flush(pd->sender, may_block, ignore_line_delimiter);
  DBG("%p flushed, ret=%hhu, still pending=%zu",
      o,
      ret,
      efl_io_queue_usage_get(pd->outgoing));
