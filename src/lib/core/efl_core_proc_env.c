...
_efl_core_proc_env_efl_core_env_env_get(const Eo               *obj,
                                        ...
                                        const char             *var)
{
    if (!pd->in_sync) _sync((Eo *)obj, pd);
    return efl_core_env_get(efl_super(obj, MY_CLASS), var);
}

EOLIAN static void
_efl_core_proc_env_efl_core_env_env_set(Eo                     *obj,
                                        Efl_Core_Proc_Env_Data *pd,
                                        const char             *var,
                                        const char             *value)
{
...
EOLIAN static void
_efl_core_proc_env_efl_core_env_unset(Eo                     *obj,
                                      Efl_Core_Proc_Env_Data *pd,
                                      const char             *key)
{
...
_efl_core_proc_env_efl_object_constructor(Eo                        *obj,
                                          Efl_Core_Proc_Env_Data *pd EFL_UNUSED)
{
