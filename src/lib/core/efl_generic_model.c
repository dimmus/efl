...
static Efl_Bool
_stringshared_keys_free(const Eina_Hash *hash EFL_UNUSED,
                        const void           *key,
...
_efl_generic_model_efl_model_properties_get(const Eo *obj           EFL_UNUSED,
...
static Eina_Future *
_efl_generic_model_efl_model_property_set(Eo                     *obj,
                                          Efl_Generic_Model_Data *pd,
                                          const char             *property,
                                          Eina_Value             *value)
{
    ...
    if (!exist)
    {
        ...
        if (!exist) goto value_failed;

        if (!eina_hash_direct_add(pd->properties,
                                  eina_stringshare_ref(prop),
                                  exist))
            goto hash_failed;
    }

    if (!eina_value_copy(value, exist)) goto value_failed;
...
static Eina_Future *
_efl_generic_model_efl_model_children_slice_get(Eo                     *obj,
                                                Efl_Generic_Model_Data *pd,
                                                unsigned int            start,
                                                unsigned int            count)
{
...
static unsigned int
_efl_generic_model_efl_model_children_count_get(const Eo *obj EFL_UNUSED,
                                                Efl_Generic_Model_Data *pd)
{
...
static void
_efl_generic_model_efl_model_child_del(Eo                     *obj,
                                       Efl_Generic_Model_Data *sd,
                                       Eo                     *child)
{
    Efl_Model   *data;
    Eina_List   *l;
