 ...
 *
 * Errors are reported with a EFL_FALSE value for Eina_Success_Flag
 * return and success with a EFL_TRUE.
 */
typedef Efl_Bool Eina_Success_Flag;
 ...
 * @return #EFL_TRUE if successful, otherwise #EFL_FALSE on error
 *
