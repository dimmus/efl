...
EINA_API Efl_Bool
eina_simple_xml_parse(const char *buf, unsigned buflen, Efl_Bool strip, Eina_Simple_XML_Cb func, const void *data)
{
...
static inline void
_eina_simple_xml_node_dump_indent(Efl_Strbuf *buf, const char *indent, unsigned level)
{
...
static void
_eina_simple_xml_node_tag_attributes_append(Efl_Strbuf *buf, Eina_Simple_XML_Node_Tag *tag)
{
...
static void _eina_simple_xml_node_dump(Efl_Strbuf *buf, Eina_Simple_XML_Node *node, const char *indent, unsigned level);

static void
_eina_simple_xml_node_children_dump(Efl_Strbuf *buf, Eina_Simple_XML_Node_Tag *tag, const char *indent, unsigned level)
{
...
static void
_eina_simple_xml_node_dump(Efl_Strbuf *buf, Eina_Simple_XML_Node *node, const char *indent, unsigned level)
{
   switch (node->type)
     {
