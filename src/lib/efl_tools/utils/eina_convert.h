 ...
 *
 * If the string is invalid #EFL_FALSE is returned, otherwise #EFL_TRUE is
 * returned.
 */
 ...
 * respectively by @p m and @p e.
 *
 * If the string is invalid, #EFL_FALSE is returned,
 * otherwise @p fp is computed and #EFL_TRUE is returned.
 *
