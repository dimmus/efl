 ...
 * reclamation.
 */
EINA_API Efl_Bool eina_quadtree_del(Eina_QuadTree_Item *object);

/**
 * @brief Marks an object within the quadtree as needing changed.
 *
 * @param[in,out] object The object that has changed.
 * @return #EFL_TRUE if change successfully noted, or #EFL_FALSE otherwise.
 */
EINA_API Efl_Bool eina_quadtree_change(Eina_QuadTree_Item *object);

/**
 * @brief Sets @p object invisible.
 *
 * @param[in,out] object The item within the quadtree to hide.
 * @return #EFL_TRUE if @p object was successfully hidden, or
 *         #EFL_FALSE if it wasn't in the quadtree.
 */
EINA_API Efl_Bool eina_quadtree_hide(Eina_QuadTree_Item *object);

/**
 * @brief Sets @p object to visible.
 *
 * @param[in,out] object The item within the quadtree to show.
 * @return #EFL_TRUE if @p object was successfully shown, or
 *         #EFL_FALSE if it wasn't in the quadtree.
 */
EINA_API Efl_Bool eina_quadtree_show(Eina_QuadTree_Item *object);
