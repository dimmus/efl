 ...
 */
EINA_API Efl_Bool eina_iterator_lock(Eina_Iterator *iterator) EINA_ARG_NONNULL(1);
 ...
 * @warning None of the existing eina data structures are lockable.
 */
EINA_API Efl_Bool eina_iterator_unlock(Eina_Iterator *iterator) EINA_ARG_NONNULL(1);
