...
Efl_Bool _eina_debug_cpu_init(void);
Efl_Bool _eina_debug_cpu_shutdown(void);

Efl_Bool _eina_debug_bt_init(void);
Efl_Bool _eina_debug_bt_shutdown(void);

Efl_Bool _eina_debug_timer_init(void);
Efl_Bool _eina_debug_timer_shutdown(void);
#endif
