        ...
        case EOLIAN_TYPEDECL_STRUCT_OPAQUE:
            {
                ...
                char                           *fn =
                    eo_gen_c_full_name_get(eolian_typedecl_c_name_get(tp));
                ...
                EINA_ITERATOR_FOREACH(membs, memb)
                {
                    ...
                    {
                        const char *nl =
                            strrchr(eina_strbuf_string_get(buf), '\n');
                        if (nl)
                        {
                            Efl_Strbuf *fbuf = eo_gen_docs_full_gen(state,
                                                                    fdoc,
                                                                    NULL,
                                                                    strlen(nl));
                            if (fbuf)
        ...
        case EOLIAN_TYPEDECL_FUNCTION_POINTER:
           ...
           /* Return type */
                const Eolian_Type *rtp =
                    eolian_function_return_type_get(fid,
                                                    EOLIAN_FUNCTION_POINTER);
                if (!rtp) eina_strbuf_append(buf, "void ");
                else
                {
                    Eina_Stringshare *ct = eolian_function_return_c_type_get(
                        fid,
                        EOLIAN_FUNCTION_POINTER);
