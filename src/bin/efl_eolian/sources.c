...
static void
_append_defval(Efl_Strbuf *buf, const Eolian_Expression *exp, const Eolian_Type *tp, const char *ctp)
{
   if (exp)
     {
...
static void
_generate_normal_free(Efl_Strbuf **buf, const Eolian_Type *type, const Efl_Strbuf *parameter, const char *additional_intention)
{
...
static void
_generate_loop_content(Efl_Strbuf **buf, const Eolian_Type *inner_type, const Efl_Strbuf *iter_param)
{
   eina_strbuf_append(*buf, "     {\n");
...
static void
_generate_iterative_free(Efl_Strbuf **buf, const Eolian_Type *type, const Eolian_Type *inner_type, Eolian_Function_Parameter *parameter, Efl_Strbuf *param)
{
...
static int
_gen_function_param_fallback(Eina_Iterator *itr, Efl_Strbuf *fallback_free_ownership, Efl_Strbuf *param_call)
{
...
static void
_gen_reflect_get(Efl_Strbuf *buf, const char *cnamel,
...
static void
_gen_reflect_set(Efl_Strbuf *buf, const char *cnamel,
                 const Eolian_Function_Parameter *pr,
                 const Eolian_Function *fid, Eina_Hash *refh)
{
   const Eolian_Type *valt = eolian_parameter_type_get(pr);
...
static void
_emit_class_function(Efl_Strbuf *buf, const Eolian_Function *fid, const Eolian_Function_Type ftype, const Eolian_Type *rtp, const char *rtpn, Efl_Strbuf *params_full,
                     const char *ocnamel, const char *func_suffix, Efl_Strbuf *params, const char *function_name)
{
...
_gen_func(const Eolian_Class *cl, const Eolian_Function *fid,
          Eolian_Function_Type ftype, Efl_Strbuf *buf,
          const Eolian_Implement *impl, Eina_Hash *refh)
{
   ...
   Efl_Strbuf *params_full = eina_strbuf_new(); /* T par1, U par2, ... for decl */
   Efl_Strbuf *params_full_imp = eina_strbuf_new(); /* as above, for impl */
   Efl_Strbuf *params_init = eina_strbuf_new(); /* default value inits */
   Efl_Strbuf *fallback_free_ownership = eina_strbuf_new(); /* list of function calls that are freeing the owned parameters, or doing nothing on the normal parameters, NULL if there is nothing owned*/
...
_gen_opfunc(const Eolian_Function *fid, Eolian_Function_Type ftype,
            Efl_Strbuf *buf, const Eolian_Implement *impl, Efl_Bool pinit,
...
static void
_gen_reflop(const Eolian_Function *fid, Efl_Strbuf *buf, const char *cnamel, Eina_Hash *refh)
{
...
_gen_params(const Eolian_Function *fid, Eolian_Function_Type ftype,
            Efl_Bool var_as_ret, Efl_Strbuf *params, Efl_Strbuf *params_full)
{
   Efl_Bool is_prop = (ftype == EOLIAN_PROP_GET || ftype == EOLIAN_PROP_SET);
