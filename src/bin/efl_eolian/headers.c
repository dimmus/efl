...
static int
_gen_param(Efl_Strbuf *buf, Eolian_Function_Parameter *pr,
...
void
eo_gen_params(Eina_Iterator *itr, Efl_Strbuf *buf,
              Efl_Strbuf **flagbuf, int *nidx, Eolian_Function_Type ftype)
{
...
_gen_func(const Eolian_State *state, const Eolian_Function *fid,
          Eolian_Function_Type ftype, Efl_Strbuf *buf, char *cnameu)
{
                  ...
                  Efl_Strbuf *buf)
{
   ...
   if (doc)
     {
        Efl_Strbuf *cdoc = eo_gen_docs_full_gen(state, doc,
   ...
   EINA_ITERATOR_FOREACH(itr, ev)
     {
        ...
        Efl_Strbuf *evdbuf = eo_gen_docs_event_gen(state, ev,
