...
static void
source_client_complex_method_call_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   DBus_Arg *arg;
...
static void
source_client_simple_method_call_no_reply_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   DBus_Arg *arg;
   Efl_Strbuf *full_signature = eina_strbuf_new();
...
static void
source_client_simple_method_call_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   DBus_Arg *arg;
   Efl_Strbuf *full_signature = eina_strbuf_new();
   Efl_Strbuf *args_call = eina_strbuf_new();
...
static void
source_client_complex_method_callback_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
...
static void
source_client_simple_method_callback_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   Efl_Strbuf *full_signature = eina_strbuf_new();
   DBus_Arg *arg;
...
static void
source_client_method_generate(const DBus_Method *method, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   if (!method->no_reply)
     {
...
static void
source_client_signal_generate(const DBus_Signal *sig, Efl_Strbuf *c_code, Efl_Strbuf * h, Efl_Strbuf *c_init_function, Efl_Strbuf *c_header)
{
   DBus_Arg *arg;
   Efl_Strbuf *full_signature = eina_strbuf_new();
   ...
   EINA_INLIST_FOREACH(sig->args, arg)
     {
        ...
        eina_strbuf_append_printf(h, "   %s%s;\n", dbus_type2c_type2(arg->type, EFL_FALSE), arg->c_name);
...
static void
source_client_property_generate_get(const DBus_Property *prop, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   //callback
   eina_strbuf_append_printf(c_code, "\nstatic void\n%s(void *data, const Eldbus_Message *msg, Eldbus_Pending *pending)\n{\n", prop->cb_name);
   eina_strbuf_append_printf(c_code, "   void *user_data = eldbus_pending_data_del(pending, \"__user_data\");\n");
...
static void
source_client_property_generate_set(const DBus_Property *prop, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
   //callback
...
static void
source_client_property_generate(const DBus_Property *prop, Efl_Strbuf *c_code, Efl_Strbuf *h)
{
