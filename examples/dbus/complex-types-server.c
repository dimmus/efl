...
static Eldbus_Message *
_receive_array_of_string_int_with_size(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
...
static Eldbus_Message *
_receive_variant(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
...
static Eldbus_Message *
_send_variant(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
...
static Eldbus_Message *
_send_array(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
   Eldbus_Message_Iter *iter, *array;
...
static Eldbus_Message *
_plus_one(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
   int num;
...
static Eldbus_Message *
_double_container(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
...
static Efl_Bool
_properties_get(const Eldbus_Service_Interface *iface EFL_UNUSED, const char *propname, Eldbus_Message_Iter *iter, const Eldbus_Message *request_msg EFL_UNUSED, Eldbus_Message **error EFL_UNUSED)
{
...
static Eldbus_Message *
_properties_set(const Eldbus_Service_Interface *iface EFL_UNUSED, const char *propname, Eldbus_Message_Iter *iter, const Eldbus_Message *msg)
{
   char *type;
