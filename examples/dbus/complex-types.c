...
static void
set_property_resp2(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   const char *errname;
   const char *errmsg;
...
static void
get_property_resp2(void *data, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
...
static void
on_send_array_int(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
...
static void
on_send_variant(void *data EFL_UNUSED, const Eldbus_Message *msg EFL_UNUSED, Eldbus_Pending *pending EFL_UNUSED)
{
   printf("on_send_variant()\n\n");
}

static void
on_receive_array(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   const char *errname;
   const char *errmsg;
