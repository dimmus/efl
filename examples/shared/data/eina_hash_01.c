//Compile with:
//gcc -g -Wall eina_hash_01.c -o eina_hash_01 `pkg-config --cflags --libs shared`
...
static Efl_Bool
_phone_book_foreach_cb(const Eina_Hash *phone_book EFL_UNUSED, const void *key,
		       void *data, void *fdata EFL_UNUSED)
{
   ...
   // Return EFL_FALSE to stop this callback from being called
   return EFL_TRUE;
}
