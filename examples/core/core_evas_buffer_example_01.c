 ...
 *
 * @verbatim
 * gcc -o core_evas_buffer_example_01 core_evas_buffer_example_01.c `pkg-config --libs --cflags evas ecore-evas evas-software-buffer`
 * @endverbatim
 *
 */
            ...
            const char *dest)
{
   ...
   pixels = core_evas_buffer_pixels_get(ee);
...
main(void)
{
   ...
   ee = core_evas_buffer_new(WIDTH, HEIGHT);
   if (!ee) goto error;
