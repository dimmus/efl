 ...
 * in core_con_eet_server_example.c and core_con_eet_client_example.c.
 * The structure for the descriptor is defined in core_con_eet_descriptor_example.h.
 */
...
{
   core_con_eet_register(eet_svr, EXAMPLE_STREAM, _ece_example_descriptor);
}
