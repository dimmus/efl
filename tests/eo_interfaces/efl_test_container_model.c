                            ...
                            const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   ...
   efl_assert_fail_if(eina_value_type_get(&v) != EINA_VALUE_TYPE_ARRAY);
   ...
   EINA_VALUE_ARRAY_FOREACH(&v, len, i, child)
     {
        ...
        efl_assert_fail_if(eina_value_type_get(value_int) != EINA_VALUE_TYPE_INT);
        efl_assert_fail_if(eina_value_type_get(value_str) != EINA_VALUE_TYPE_STRING);
...
TEST(efl_test_container_model_values)
{
