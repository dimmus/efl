...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t2)
{
   ...
   thq1 = eina_thread_queue_new();
   if (!thq1) fail();
   th = ecore_thread_feedback_run(thspeed2_do, NULL, NULL, NULL, NULL, EFL_TRUE);
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t7)
{
   ...
   eth1 = ecore_thread_feedback_run(thspeed7_do, NULL, NULL, NULL, NULL, EFL_TRUE);
   for (;;)
     {
        char buf;
...
void ecore_test_ecore_thread_eina_thread_queue(TCase *tc EFL_UNUSED)
{
...
void ecore_test_ecore_thread_eina_thread_queue2(TCase *tc EFL_UNUSED)
{
