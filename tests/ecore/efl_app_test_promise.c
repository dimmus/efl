...
static Eina_Value
_chain_stop(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   int *i = data;
...
static Eina_Value
_chain_no_error(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   Eina_Value new_v;
...
static Eina_Value
_chain_error(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   int *i = data;
...
static Eina_Value
_cancel_cb(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   Eina_Value new_v;
...
static Eina_Value
_inner_resolve(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   Eina_Value new_v;
...
static Eina_Value
_inner_fail(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
...
static void
_inner_promise_cancel(void *data EFL_UNUSED, const Eina_Promise *dead_ptr EFL_UNUSED)
{
...
static Eina_Value
_future_promise_create(void *data, const Eina_Value v EFL_UNUSED, const Eina_Future *dead_future EFL_UNUSED)
{
   Eina_Promise *p;
...
static Eina_Value
_inner_future_last(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   if (data)
     ERROR_CHECK(v, DEFAULT_ERROR);
   else
...
static Eina_Value
_convert_check(void *data EFL_UNUSED, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   const char *number;
   VALUE_TYPE_CHECK(v, EINA_VALUE_TYPE_STRING);
...
static Eina_Value
_future_all_count(void *data, const Eina_Value v, const Eina_Future *dead EFL_UNUSED)
{
...
static Eina_Value
_promise_empty_done(void *data, const Eina_Value value, const Eina_Future *dead_future EFL_UNUSED)
{
   Efl_Bool *pdone = data;
...
EFL_START_TEST(efl_test_promise_future_all)
{
   ...
   fail_if(!eina_future_then(eina_future_all_array(futures), _all_cb, &len, NULL));
   ecore_main_loop_begin();
   ecore_shutdown();
...
static void
_eo_future_free(Eo *eo, void *data EFL_UNUSED, const Eina_Future *dead EFL_UNUSED)
{
...
static Eina_Value
_eo_chain_stop(void *data EFL_UNUSED, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   int ivalue = 0;
   VALUE_TYPE_CHECK(v, EINA_VALUE_TYPE_INT);
   fail_if(!eina_value_get(&v, &ivalue));
...
static Eina_Value
_eo_future_link_success(Eo *eo EFL_UNUSED, void *data EFL_UNUSED, const Eina_Value v)
{
...
static Eina_Value
_eo_link_chain_end(void *data EFL_UNUSED, const Eina_Value v, const Eina_Future *dead EFL_UNUSED)
{
   int *err_called = data;
...
static Eina_Value
_err_ignored(void *data EFL_UNUSED, const Eina_Value v, const Eina_Future *f EFL_UNUSED)
{
...
static Eina_Value
_log_quit(void *data EFL_UNUSED, const Eina_Value v, const Eina_Future *dead EFL_UNUSED)
{
   int ivalue;
...
static Eina_Value
_future_race_all_null_cb(void *data, const Eina_Value v, const Eina_Future *dead EFL_UNUSED)
{
   int err;
   int *cb_called = data;
   ...
   for (i = 0; i < len; i++)
     {
        futures[i] = eina_future_then(_int_future_get(),
                                      _future_race_all_null_cb, &cb_called, NULL);
        fail_if(!futures[i]);
     }
...
static Eina_Value
test_error_not_reached(Eo *o EFL_UNUSED, void *data EFL_UNUSED, Eina_Error error EFL_UNUSED)
{
   abort();
...
static Eina_Value
test_not_reached(Eo *o EFL_UNUSED, void *data EFL_UNUSED, const Eina_Value value)
{
   abort();
...
efl_main_test(void *data EFL_UNUSED, const Efl_Event *ev)
{
   ...
   f = efl_future_chain(ev->object, efl_loop_idle(ev->object),
                        ...
                        { .success_type = EINA_VALUE_TYPE_INT, .success = test_got_int , .error = test_error_not_reached, NULL },
