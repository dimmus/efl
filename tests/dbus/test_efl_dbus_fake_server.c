...
static Efl_Bool _fakse_server_property_get(const Efl_Dbus_Service_Interface *, const char *, Efl_Dbus_Message_Iter *, const Efl_Dbus_Message *, Efl_Dbus_Message **);
...
_fake_server_sum(const Efl_Dbus_Service_Interface *iface EFL_UNUSED, const Efl_Dbus_Message *msg)
{
   int a, b;
...
_fake_server_ping(const Efl_Dbus_Service_Interface *iface , const Efl_Dbus_Message *msg)
{
   ...
   Core_Timer *timer = core_timer_add(0.1, _fake_server_send_pong_signal, iface);
