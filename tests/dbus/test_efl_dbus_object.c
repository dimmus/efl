...
static void
_object_message_cb(void *data, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
...
static void
_peer_ping_cb(void *data, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   int *user_data = data;
...
static void
_machine_id_get(void *data, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   int *user_data = data;
