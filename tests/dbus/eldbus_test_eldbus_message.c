...
static Efl_Bool
_ecore_loop_close(void *data EFL_UNUSED)
{
...
_swap_value(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
...
static Eldbus_Message *
_receive_container_data(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
   Eldbus_Message_Iter *array1;
   const char *txt;

   Efl_Bool fail = EFL_FALSE;
   if (eldbus_message_arguments_get(msg, "as", &array1))
     {
        int int_iter = 0;
        while (eldbus_message_iter_get_and_next(array1, 's', &txt))
          {
        ...
        if (!fail)
          {
             ...
             Eldbus_Message_Iter *array2 = eldbus_message_iter_container_new(iter, 'a', "i");
             if (array2)
               {
                  eldbus_message_iter_fixed_array_append(array2, 'i', numbers, EINA_C_ARRAY_LENGTH(numbers));
                  eldbus_message_iter_container_close(iter, array2);
               }
          }
     }
...
static Eldbus_Message *
_send_bool(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
...
static void
_on_send_array_int(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
...
static Eldbus_Message *
_send_array_int(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   Eldbus_Message *reply = eldbus_message_method_return_new(msg);
...
static void
_response_message_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
...
static void
_message_method_cb(void *data EFL_UNUSED, const Eldbus_Message *msg EFL_UNUSED, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_activatable_list_response_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_signal_name_owner_changed(void *data EFL_UNUSED, const Eldbus_Message *msg)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_response_owner_has_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_message_without_body_cb(void *data EFL_UNUSED, const Eldbus_Message *msg EFL_UNUSED, Eldbus_Pending *pending EFL_UNUSED)
{
}

static void
_message_response_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_message_vget_response_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_name_request(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   unsigned int reply;
   const char *errname, *errmsg;
   if (!eldbus_message_error_get(msg, &errname, &errmsg))
...
static void
_response_swap_value(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
...
static void
_response_swap_iter_vget(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   int swap_value;
...
static void
_container_receive_cb(void *data EFL_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        ecore_timer_del(timeout);
...
static void
_hello_cb(void *data, const Eldbus_Message *msg EFL_UNUSED, Eldbus_Pending *pending EFL_UNUSED)
{
   int *user_data = data;
...
EFL_START_TEST(utc_eldbus_message_arguments_vget_p)
{
   ...
   Efl_Bool is_arguments_append = eldbus_message_arguments_append(message, "s", bus);
...
EFL_START_TEST(utc_eldbus_message_container_p)
{
   ...
   Efl_Bool is_container_iter_closed = eldbus_message_iter_container_close(iter, container_iter);
