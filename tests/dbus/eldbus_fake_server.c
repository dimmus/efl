...
static Efl_Bool _fakse_server_property_get(const Eldbus_Service_Interface *, const char *, Eldbus_Message_Iter *, const Eldbus_Message *, Eldbus_Message **);
...
_fake_server_sum(const Eldbus_Service_Interface *iface EFL_UNUSED, const Eldbus_Message *msg)
{
   int a, b;
...
_fakse_server_property_get(const Eldbus_Service_Interface *iface,
                           ...
                           const Eldbus_Message *request_msg EFL_UNUSED,
                           Eldbus_Message **error EFL_UNUSED)
{
