...
_setup(void)
{
   ...
   fake_server_object = efl_add(EFL_DBUS_MODEL_OBJECT_CLASS, efl_main_loop_get(),
   ...
   fake_server_proxy = efl_dbus_model_proxy_from_object_get(fake_server_object, FAKE_SERVER_INTERFACE);
}
...
{
   Efl_Dbus_Model_Arguments *method1 = efl_model_nth_child_get(fake_server_proxy, 0);
   Efl_Dbus_Model_Arguments *method2 = efl_model_nth_child_get(fake_server_proxy, 1);
   Efl_Dbus_Model_Arguments *signal1 = efl_model_nth_child_get(fake_server_proxy, 2);

   const char *actual_method1_name = efl_dbus_model_arguments_arg_name_get(method1);
   const char *actual_method2_name = efl_dbus_model_arguments_arg_name_get(method2);
   const char *actual_signal1_name = efl_dbus_model_arguments_arg_name_get(signal1);
