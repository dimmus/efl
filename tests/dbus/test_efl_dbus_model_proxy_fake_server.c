...
EFL_START_TEST(property_get)
{
    ...
    efl_event_callback_add(fake_server_proxy,
                           ...
                           _property_ready,
                           NULL);
    value = efl_model_property_get(fake_server_proxy,
...
EFL_START_TEST(children_slice_get)
{
    ...
    if (strcmp(FAKE_SERVER_SUM_METHOD_NAME, actual_method1_name) == 0)
        ck_assert(strcmp(FAKE_SERVER_PING_METHOD_NAME, actual_method2_name) ==
                  0);
    else
        ck_assert(strcmp(FAKE_SERVER_SUM_METHOD_NAME, actual_method2_name) ==
                  0);
