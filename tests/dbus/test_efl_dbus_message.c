...
_swap_value(const Efl_Dbus_Service_Interface *iface EFL_UNUSED, const Efl_Dbus_Message *msg)
{
...
static Efl_Dbus_Message *
_receive_container_data(const Efl_Dbus_Service_Interface *iface EFL_UNUSED, const Efl_Dbus_Message *msg)
{
   Efl_Dbus_Message *reply = efl_dbus_message_method_return_new(msg);
        ...
        if (!fail)
          {
             ...
             Efl_Dbus_Message_Iter *array2 = efl_dbus_message_iter_container_new(iter, 'a', "i");
             if (array2)
               {
                  efl_dbus_message_iter_fixed_array_append(array2, 'i', numbers, EINA_C_ARRAY_LENGTH(numbers));
...
static void
_on_send_array_int(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
...
static void
_response_message_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
...
static void
_message_method_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg EFL_UNUSED, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_activatable_list_response_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_response_owner_has_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_message_without_body_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg EFL_UNUSED, Efl_Dbus_Pending *pending EFL_UNUSED)
{
}

static void
_message_response_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_message_vget_response_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_name_request(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   unsigned int reply;
   const char *errname, *errmsg;
   if (!efl_dbus_message_error_get(msg, &errname, &errmsg))
...
static void
_response_swap_value(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
...
static void
_response_swap_iter_vget(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   int swap_value;
...
static void
_container_receive_cb(void *data EFL_UNUSED, const Efl_Dbus_Message *msg, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   if (timeout != NULL)
     {
        core_timer_del(timeout);
...
static void
_hello_cb(void *data, const Efl_Dbus_Message *msg EFL_UNUSED, Efl_Dbus_Pending *pending EFL_UNUSED)
{
   int *user_data = data;
...
EFL_START_TEST(utc_efl_dbus_message_arguments_vget_p)
{
   ...
   Efl_Bool is_arguments_append = efl_dbus_message_arguments_append(message, "s", bus);
...
EFL_START_TEST(utc_efl_dbus_message_container_p)
{
   ...
   Efl_Bool is_container_iter_closed = efl_dbus_message_iter_container_close(iter, container_iter);
