...
static const Efl_Test_Case etc[] = {
  ...
  { "efl_dbus_test_fake_server_efl_dbus_model_proxy", efl_dbus_test_fake_server_efl_dbus_model_proxy },
  ...
  { "efl_dbus_test_efl_dbus_signal_handler", efl_dbus_test_efl_dbus_signal_handler },
  { "efl_dbus_test_efl_dbus_proxy", efl_dbus_test_efl_dbus_proxy },
  { "efl_dbus_test_efl_dbus_pending_cancel", efl_dbus_test_efl_dbus_pending_cancel },
  { NULL, NULL }
};
