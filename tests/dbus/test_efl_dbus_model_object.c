...
static Eina_Value
_expect_error(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
...
#if 0
static Eina_Value
_one_child(void *data, const Eina_Value v, const Eina_Future *dead_future EFL_UNUSED)
{
   Eo **child = data;
