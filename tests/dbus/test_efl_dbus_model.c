...
{
   Eo *connection = efl_add(EFL_DBUS_MODEL_CONNECTION_CLASS, efl_main_loop_get(),
                            efl_dbus_model_connect(efl_added, EFL_DBUS_CONNECTION_TYPE_SESSION, NULL, EFL_FALSE));
...
create_object(void)
{
   Eo *object = efl_add(EFL_DBUS_MODEL_OBJECT_CLASS, efl_main_loop_get(),
                        efl_dbus_model_connect(efl_added, EFL_DBUS_CONNECTION_TYPE_SESSION, NULL, EFL_FALSE),
...
static Eina_Value
_leave(void *data EFL_UNUSED, const Eina_Value v,
...
efl_dbus_model_proxy_from_object_get(Efl_Dbus_Model_Object *object, const char *interface_name)
{
   Eina_Future *future = NULL;
   Eo *proxy = NULL;
   Eina_Value *array;
...
_efl_dbus_model_arguments_from_proxy_get(Efl_Dbus_Model_Proxy *proxy, const char *method_name, const Efl_Class *klass)
{
   Eina_Future *future = NULL;
   Eo *child = NULL;
   Eina_Value *array;
...
efl_dbus_model_method_from_proxy_get(Efl_Dbus_Model_Proxy *proxy, const char *method_name)
{
   return _efl_dbus_model_arguments_from_proxy_get(proxy, method_name, EFL_DBUS_MODEL_METHOD_CLASS);
}

Efl_Dbus_Model_Signal *
efl_dbus_model_signal_from_proxy_get(Efl_Dbus_Model_Proxy *proxy, const char *signal_name)
{
   return _efl_dbus_model_arguments_from_proxy_get(proxy, signal_name, EFL_DBUS_MODEL_SIGNAL_CLASS);
}
