...
_efl_dbus_model_arguments_from_proxy_get(Efl_Dbus_Model_Proxy *proxy,
...
void
check_efl_model_property_int_eq(Efl_Model  *efl_model,
                                const char *property,
                                int         expected_value)
{
...
void
check_efl_model_property_int_set(Efl_Model  *efl_model,
                                 const char *property,
                                 int         value)
{
