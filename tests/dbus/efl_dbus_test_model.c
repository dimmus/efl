...
create_connection(void)
{
   Eo *connection = efl_add(ELDBUS_MODEL_CONNECTION_CLASS, efl_main_loop_get(),
                            efl_dbus_model_connect(efl_added, EFL_DBUS_CONNECTION_TYPE_SESSION, NULL, EINA_FALSE));
...
create_object(void)
{
   Eo *object = efl_add(ELDBUS_MODEL_OBJECT_CLASS, efl_main_loop_get(),
                        efl_dbus_model_connect(efl_added, EFL_DBUS_CONNECTION_TYPE_SESSION, NULL, EINA_FALSE),
                        efl_dbus_model_object_bus_set(efl_added, ELDBUS_FDO_BUS),
                        efl_dbus_model_object_path_set(efl_added, ELDBUS_FDO_PATH));
...
{
   return _efl_dbus_model_arguments_from_proxy_get(proxy, method_name, ELDBUS_MODEL_METHOD_CLASS);
}

Efl_Dbus_Model_Signal *
efl_dbus_model_signal_from_proxy_get(Efl_Dbus_Model_Proxy *proxy, const char *signal_name)
{
   return _efl_dbus_model_arguments_from_proxy_get(proxy, signal_name, ELDBUS_MODEL_SIGNAL_CLASS);
}
