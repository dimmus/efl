...
_setup(void)
{
   ...
   pong_signal = efl_dbus_model_signal_from_proxy_get(fake_server_proxy, FAKE_SERVER_PONG_SIGNAL_NAME);
...
{
   Efl_Dbus_Model_Method *ping_method = efl_dbus_model_method_from_proxy_get(fake_server_proxy, FAKE_SERVER_PING_METHOD_NAME);
