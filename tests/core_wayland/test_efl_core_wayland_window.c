...
#ifdef GL_GLES
static void
_test_activated_frame_cb(Ecore_Wl_Window *win EFL_UNUSED, uint32_t timestamp EFL_UNUSED, void *data)
{
   Test_Data *td = data;
...
static Efl_Bool
_test_activated_configure_complete(void *data, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   Test_Data *td = data;

   td->frame_callback_handler = ecore_wl_window_frame_callback_add(td->win, _test_activated_frame_cb, td);
   ecore_wl_window_commit(td->win, EFL_TRUE);
...
static Efl_Bool
_test_activated_window_activate(void *data EFL_UNUSED, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   //TC Pass
   core_main_loop_quit();
...
static void
_test_commit_frame_cb(Ecore_Wl_Window *win EFL_UNUSED, uint32_t timestamp EFL_UNUSED, void *data)
{
   Test_Data *td = data;
   td->frame_callback_count++;
   core_main_loop_quit();
...
static Efl_Bool
_test_commit_configure_complete(void *data, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   Test_Data *td = data;

   td->frame_callback_handler = ecore_wl_window_frame_callback_add(td->win, _test_commit_frame_cb, td);
   ecore_wl_window_commit(td->win, EFL_TRUE);
...
static void
_test_frame_callback_frame_cb(Ecore_Wl_Window *win EFL_UNUSED, uint32_t timestamp EFL_UNUSED, void *data)
{
   Test_Data *td = data;
   td->frame_callback_count++;
...
static Efl_Bool
_test_frame_callback_configure_complete(void *data, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   Test_Data *td = data;

   td->frame_callback_handler = ecore_wl_window_frame_callback_add(td->win, _test_frame_callback_frame_cb, td);
   ecore_wl_window_commit(td->win, EFL_TRUE);
...
static Efl_Bool
_test_hide_window_hide(void *data EFL_UNUSED, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   //TC pass
   core_main_loop_quit();
...
static Efl_Bool
_test_show_window_show(void *data EFL_UNUSED, int type EFL_UNUSED, void *event EFL_UNUSED)
{
   //TC pass
   core_main_loop_quit();
...
static Efl_Bool
_test_update_window_configure(void *data EFL_UNUSED, int type EFL_UNUSED, void *event EFL_UNUSED)
{
...
static Efl_Bool
_test_update_window_configure_complete(void *data EFL_UNUSED, int type EFL_UNUSED, void *event EFL_UNUSED)
{
