...
static void
__eolian_override_b_set(Eo *obj        EFL_UNUSED,
                        Override_Data *pd,
                        int idx        EFL_UNUSED,
                        float          a,
                        char           b,
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV(override_b_set,
                                   EFL_FUNC_CALL(idx, a, b, c),
                                   int   idx,
                                   float a,
                                   char  b,
                                   int   c);

void _override_b_get(const Eo      *obj,
                     Override_Data *pd,
                     int            idx,
                     float         *a,
                     char          *b,
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV_CONST(override_b_get,
                                         EFL_FUNC_CALL(idx, a, b, c),
                                         int    idx,
                                         float *a,
                                         char  *b,
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV(override_c_set,
                                   EFL_FUNC_CALL(idx, c),
                                   int idx,
                                   int c);

static int
__eolian_override_c_get(const Eo *obj     EFL_UNUSED,
                        Override_Data *pd EFL_UNUSED,
                        int idx           EFL_UNUSED)
{
    return 50;
}
...
EAPI EAPI_WEAK
EFL_FUNC_BODYV_CONST(override_c_get, int, 50, EFL_FUNC_CALL(idx), int idx);
EAPI EAPI_WEAK EFL_VOID_FUNC_BODY(override_foo);

static void
__eolian_override_bar(Eo *obj           EFL_UNUSED,
                      Override_Data *pd EFL_UNUSED,
                      int idx           EFL_UNUSED,
                      int              *a,
                      char            **str)
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV(override_bar,
                                   EFL_FUNC_CALL(idx, a, str),
                                   int    idx,
                                   int   *a,
                                   char **str);
...
static void
__eolian_override_base_z_set(Eo *obj        EFL_UNUSED,
                             Override_Data *pd,
                             int            a,
                             char           b,
                             float          c)
...
static void
__eolian_override_base_z_get(const Eo *obj  EFL_UNUSED,
                             Override_Data *pd,
                             int           *a,
                             char          *b,
                             float         *c)
