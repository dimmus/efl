...
static void
_owning_test1_ownership_fallback(Eina_List     *test1,
                                 Eina_Iterator *test2,
                                 Eina_Hash     *test3,
                                 Eina_Accessor *test4)
{
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV_FALLBACK(
    owning_test1, _owning_test1_ownership_fallback(test1, test2, test3, test4);
    ,
    EFL_FUNC_CALL(test1, test2, test3, test4),
    Eina_List     *test1,
    Eina_Iterator *test2,
    Eina_Hash     *test3,
    Eina_Accessor *test4);
...
void
_owning_test2(Eo *obj, Owning_Data *pd, Eina_List *test1, Eina_Hash *test2);
...
EAPI EAPI_WEAK EFL_VOID_FUNC_BODYV_FALLBACK(
    ...
    , EFL_FUNC_CALL(test1, test2), Eina_List *test1, Eina_Hash *test2);
