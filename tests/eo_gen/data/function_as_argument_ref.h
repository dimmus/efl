...
EAPI EAPI_WEAK void function_as_argument_set_cb(Eo          *obj,
                                                void        *cb_data,
                                                SimpleFunc   cb,
                                                Eina_Free_Cb cb_free_cb);

EAPI EAPI_WEAK char *function_as_argument_call_cb(Eo *obj, int a, double b)
  EFL_TRANSFER_OWNERSHIP EFL_WARN_UNUSED_RESULT;
