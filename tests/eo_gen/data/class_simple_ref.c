...
Efl_Bool _class_simple_a_set(Eo *obj, Evas_Simple_Data *pd, int value);
...
EAPI EAPI_WEAK EFL_FUNC_BODYV(efl_canvas_object_simple_a_set,
                              Efl_Bool,
                              EFL_TRUE /* true */,
                              EFL_FUNC_CALL(value),
                              int value);
...
static char *
__eolian_class_simple_foo(Eo               *obj,
                          Evas_Simple_Data *pd,
                          int               a,
                          char             *b,
                          double           *c,
...
EAPI EAPI_WEAK EFL_FUNC_BODYV(efl_canvas_object_simple_foo,
                              char *,
                              NULL /* null */,
                              EFL_FUNC_CALL(a, b, c, d),
                              int     a,
                              char   *b,
                              double *c,
                              int    *d);
...
#  define CLASS_SIMPLE_EXTRA_OPS
    ...
    static const Efl_Object_Property_Reflection refl_table[] = {
        {"a",
         __eolian_class_simple_a_set_reflect, __eolian_class_simple_a_get_reflect},
    };
