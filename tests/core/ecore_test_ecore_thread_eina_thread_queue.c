...
static void
th1_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
static void
th2_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t1)
{
    ...
    if (!thq2) fail();
    eth1 = ecore_thread_feedback_run(th1_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth2 = ecore_thread_feedback_run(th2_do, NULL, NULL, NULL, NULL, EFL_TRUE);
...
static void
thspeed2_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    Msg2 *msg;
    void *ref;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t2)
{
    ...
    thq1 = eina_thread_queue_new();
    if (!thq1) fail();
    th = ecore_thread_feedback_run(thspeed2_do,
                                   NULL,
                                   NULL,
                                   NULL,
                                   NULL,
...
static void
th31_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
static void
th32_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t3)
{
    ...
    eth1 = ecore_thread_feedback_run(th31_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth2 = ecore_thread_feedback_run(th32_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    for (;;)
    {
...
static void
th41_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
static void
th42_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 10000;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t4)
{
    ...
    thq1 = eina_thread_queue_new();
    if (!thq1) fail();
    eth1 = ecore_thread_feedback_run(th41_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth2 = ecore_thread_feedback_run(th42_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    for (;;)
    {
        Msg4 *msg;
        void *ref;
...
static void
th51_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
static void
th52_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t5)
{
    ...
    thq2 = eina_thread_queue_new();
    if (!thq2) fail();
    eth1 = ecore_thread_feedback_run(th51_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth2 = ecore_thread_feedback_run(th52_do, NULL, NULL, NULL, NULL, EFL_TRUE);
...
static void
th61_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int val = 100;
...
static void
th62_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int cnt = 0;
...
static void
th63_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    int cnt = 0;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t6)
{
    ...
    thq1 = eina_thread_queue_new();
    fail_if(!thq1);
    eth1 = ecore_thread_feedback_run(th61_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth2 = ecore_thread_feedback_run(th62_do, NULL, NULL, NULL, NULL, EFL_TRUE);
    eth3 = ecore_thread_feedback_run(th63_do, NULL, NULL, NULL, NULL, EFL_TRUE);
...
static void
thspeed7_do(void *data EFL_UNUSED, Ecore_Thread *th)
{
    Msg7 *msg;
    void *ref;
    int   i;
...
EFL_START_TEST(ecore_test_ecore_thread_eina_thread_queue_t7)
{
    ...
    eth1 = ecore_thread_feedback_run(thspeed7_do,
                                     NULL,
                                     NULL,
                                     NULL,
                                     NULL,
...
void
ecore_test_ecore_thread_eina_thread_queue(TCase *tc EFL_UNUSED)
{
...
void
ecore_test_ecore_thread_eina_thread_queue2(TCase *tc EFL_UNUSED)
{
