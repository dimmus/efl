...
static Efl_Bool _anim_cb(void *data EFL_UNUSED, double pos)
{
...
Efl_Bool test_pos(Core_Pos_Map posmap, double v1, double v2, double (*testmap)(double val, double v1, double v2))
{
  double pos;
  double res1;
  double res2;
...
double _linear(double val, double v1 EFL_UNUSED, double v2 EFL_UNUSED)
{
  return val;
}

double _accel(double val, double v1 EFL_UNUSED, double v2 EFL_UNUSED)
{
  return 1 - sin(M_PI_2 + val * M_PI_2);
}

double _decel(double val, double v1 EFL_UNUSED, double v2 EFL_UNUSED)
{
  return  sin(val * M_PI_2);
}

double _sinusoidal(double val, double v1 EFL_UNUSED, double v2 EFL_UNUSED)
{
...
static Efl_Bool _animator_cb(void *data)
{
   Efl_Bool *called = data;
...
static Efl_Bool _switch_cb(void* data EFL_UNUSED)
{
   core_animator_custom_tick();
   return CORE_CALLBACK_CANCEL;
}

static Efl_Bool _quit_cb(void* data EFL_UNUSED)
{
   core_main_loop_quit();
   return CORE_CALLBACK_CANCEL;
}
...
EFL_START_TEST(core_test_begin_end_tick)
{
   ...
   core_animator_custom_source_tick_begin_callback_set(_animator_called_cb, &is_begin_cb_called);
   core_animator_custom_source_tick_end_callback_set(_animator_called_cb, &is_end_cb_called);
