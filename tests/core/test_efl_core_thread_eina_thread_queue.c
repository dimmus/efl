...
EFL_START_TEST(core_test_core_thread_eina_thread_queue_t7)
{
   ...
   eth1 = core_thread_feedback_run(thspeed7_do, NULL, NULL, NULL, NULL, EFL_TRUE);
   for (;;)
     {
        char buf;
...
void core_test_core_thread_eina_thread_queue(TCase *tc EFL_UNUSED)
{
...
void core_test_core_thread_eina_thread_queue2(TCase *tc EFL_UNUSED)
{
