...
static void
_complex_class_complex_interface_i_test_set(Eo *obj             EFL_UNUSED,
                                            Complex_Class_Data *pd,
                                            int                 i)
{
  pd->i = i;
}
...
static int
_complex_class_complex_interface_i_test_get(const Eo *obj       EFL_UNUSED,
                                            Complex_Class_Data *pd)
{
  return pd->i;
}
...
static int
_complex_mixin_m_test_get(const Eo *obj EFL_UNUSED, Complex_Mixin_Data *pd)
{
  return pd->i;
}

static void
_complex_mixin_m_test_set(Eo *obj EFL_UNUSED, Complex_Mixin_Data *pd, int i)
{
  pd->i = i;
}
...
#  define COMPLEX_CLASS_EXTRA_OPS
  ...
  EFL_OPS_DEFINE(
    ops,
    EFL_OBJECT_OP_FUNC(complex_interface_i_test_set,
                       _complex_class_complex_interface_i_test_set),
    EFL_OBJECT_OP_FUNC(complex_interface_i_test_get,
                       _complex_class_complex_interface_i_test_get),
...
EFL_DEFINE_CLASS(complex_class_class_get,
                 &_complex_class_class_desc,
                 EO_CLASS,
                 COMPLEX_INTERFACE_INTERFACE,
                 COMPLEX_MIXIN_MIXIN,
                 NULL);
...
#  define COMPLEX_INTERFACE_EXTRA_OPS
  ...
  static const Efl_Object_Property_Reflection refl_table[] = {
    { "i_test",
     __eolian_complex_interface_i_test_set_reflect, __eolian_complex_interface_i_test_get_reflect },
  };
  static const Efl_Object_Property_Reflection_Ops rops = { refl_table,
                                                           EINA_C_ARRAY_LENGTH(
                                                             refl_table) };
  ropsp                                                = &rops;
...
EFL_DEFINE_CLASS(complex_interface_interface_get,
                 &_complex_interface_class_desc,
                 NULL,
                 NULL);
...
#  define COMPLEX_MIXIN_EXTRA_OPS
  ...
  static const Efl_Object_Property_Reflection refl_table[] = {
    { "m_test",
     __eolian_complex_mixin_m_test_set_reflect, __eolian_complex_mixin_m_test_get_reflect },
  };
  static const Efl_Object_Property_Reflection_Ops rops = { refl_table,
                                                           EINA_C_ARRAY_LENGTH(
                                                             refl_table) };
...
EFL_DEFINE_CLASS(complex_mixin_mixin_get,
                 &_complex_mixin_class_desc,
                 NULL,
                 NULL);
