...
static void
_complex_class_complex_interface_i_test_set(Eo *obj EFL_UNUSED, Complex_Class_Data *pd, int i)
{
   pd->i = i;
}

static int
_complex_class_complex_interface_i_test_get(const Eo *obj EFL_UNUSED, Complex_Class_Data *pd)
{
   return pd->i;
}
