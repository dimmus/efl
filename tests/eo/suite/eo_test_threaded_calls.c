...
static int
_v_get(Eo *obj EFL_UNUSED, void *class_data)
{
...
static void
_try_swap_stack(Eo *obj EFL_UNUSED, void *class_data)
{
  Thread_Test_Public_Data *pd = class_data;
...
static Eo *
_constructor(Eo *obj, void *class_data EFL_UNUSED, int v)
{
  Thread_Test_Public_Data *pd = class_data;
...
static void *
_thread_job(void *data, Eina_Thread t EFL_UNUSED)
{
  Eo *obj;
  ...
  obj =
    efl_add_ref(THREAD_TEST_CLASS, NULL, thread_test_constructor(efl_added, v));
...
EFL_START_TEST(eo_threaded_calls_test)
{
  ...
  fail_if(!eina_thread_create(&threads[0],
                              EINA_THREAD_NORMAL,
                              -1,
                              _thread_job,
                              (void *)(uintptr_t)0));
  fail_if(!eina_thread_create(&threads[1],
                              EINA_THREAD_NORMAL,
                              -1,
                              _thread_job,
                              (void *)(uintptr_t)1));
...
void
eo_test_threaded_calls(TCase *tc)
{
