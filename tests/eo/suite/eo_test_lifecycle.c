...
{
    OwnershipEventsCounter counter = {
        0,
    };
    Eo *obj = efl_add_ref(SIMPLE_CLASS, NULL);
    ...
    efl_event_callback_add(obj,
                           ...
                           _ownership_shared_event,
                           &counter);
    efl_event_callback_add(obj,
                           EFL_EVENT_OWNERSHIP_UNIQUE,
                           _ownership_unique_event,
                           &counter);
    efl_event_callback_add(obj,
                           EFL_EVENT_INVALIDATE,
                           _invalidate_ownership_event,
                           &counter);
...
EFL_START_TEST(eo_test_alive_get)
{
    Efl_Bool res;
    Eo      *par = efl_add_ref(SIMPLE_CLASS, NULL);
    Eo      *obj = efl_add(SIMPLE_CLASS, par, res = efl_alive_get(efl_added));
