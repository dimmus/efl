...
static int
_a_get(Eo *obj, void *class_data EFL_UNUSED)
{
  int a = 0;
...
static const Efl_Class_Description class_desc = {
  EO_VERSION, "Comp", EFL_CLASS_TYPE_REGULAR, 0, _class_initializer, NULL, NULL
};

EFL_DEFINE_CLASS(comp_class_get, &class_desc, EO_CLASS, SIMPLE_CLASS, NULL);
