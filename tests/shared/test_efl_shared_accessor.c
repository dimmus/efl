...
EFL_START_TEST(efl_shared_accessor_array_simple)
{
    Eina_Accessor *it;
    Eina_Array    *ea;
    int           *tmp;
    ...
    fail_if(eina_accessor_data_get(it, 100, (void **)&tmp) != EFL_TRUE);
    fail_if(!tmp);
    fail_if(*tmp != 100);
...
EFL_START_TEST(efl_shared_accessor_inlist_simple)
{
    ...
    fail_if(eina_accessor_data_get(it, 5, (void **)&tmp) != EFL_TRUE);
    fail_if(eina_accessor_data_get(it, 3, (void **)&tmp) != EFL_TRUE);
    fail_if(tmp->i != 1664);
    fail_if(eina_accessor_data_get(it, 3, (void **)&tmp) != EFL_TRUE);
    fail_if(tmp->i != 1664);
    fail_if(eina_accessor_data_get(it, 1, (void **)&tmp) != EFL_TRUE);
    fail_if(tmp->i != 42);
...
EFL_START_TEST(efl_shared_accessor_list_simple)
{
    Eina_List     *list = NULL;
    Eina_Accessor *it;
    ...
    fail_if(eina_accessor_data_get(it, 5, (void **)&j) != EFL_TRUE);
    fail_if(*j != 1);
    fail_if(eina_accessor_data_get(it, 3, (void **)&j) != EFL_TRUE);
    fail_if(*j != 6);
    fail_if(eina_accessor_data_get(it, 3, (void **)&j) != EFL_TRUE);
    fail_if(*j != 6);
    fail_if(eina_accessor_data_get(it, 1, (void **)&j) != EFL_TRUE);
    fail_if(*j != 7);
    fail_if(eina_accessor_data_get(it, 5, (void **)&j) != EFL_TRUE);
    fail_if(*j != 1);
...
EFL_START_TEST(efl_shared_accessor_carray_simple_ptr)
{
    Eina_Accessor *it;
    int            data[] = { 6, 9, 42, 1, 7, 1337, 81, 1664 };
    int            j, c;
...
EFL_START_TEST(efl_shared_accessor_carray_simple)
{
    Eina_Accessor *it;
    int            data[] = { 6, 9, 42, 1, 7, 1337, 81, 1664 };
    int           *j, c;
...
{
    tcase_add_test(tc, efl_shared_accessor_array_simple);
    tcase_add_test(tc, efl_shared_accessor_inlist_simple);
    tcase_add_test(tc, efl_shared_accessor_list_simple);
    tcase_add_test(tc, efl_shared_accessor_carray_simple_ptr);
    tcase_add_test(tc, efl_shared_accessor_carray_simple);
}
