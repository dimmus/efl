...
EFL_START_TEST(efl_shared_magic_simple)
{
...
#  endif
  ...
  fail_if(strcmp(eina_magic_string_get(EINA_MAGIC_TEST), EINA_MAGIC_STRING) !=
          0);
...
void
eina_test_magic(TCase *tc EFL_UNUSED)
{
#ifdef EINA_MAGIC_DEBUG
  tcase_add_test(tc, efl_shared_magic_simple);
#endif
}
