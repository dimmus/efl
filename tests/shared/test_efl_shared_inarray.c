...
EFL_START_TEST(efl_shared_inarray_test_simple)
{
...
EFL_START_TEST(efl_shared_inarray_test_alloc_at)
{
    Eina_Inarray *array;
    int          *member;
    int           i;
...
EFL_START_TEST(efl_shared_inarray_test_insert_sort)
{
    Eina_Inarray *array;
    int           i, pos;
...
EFL_START_TEST(efl_shared_inarray_test_sort)
{
    Eina_Inarray *array;
    int           i;
...
EFL_START_TEST(efl_shared_inarray_test_reverse)
{
    Eina_Inarray *array;
    int           i;
...
EFL_START_TEST(efl_shared_inarray_test_itr)
{
    Eina_Inarray  *array;
    Eina_Iterator *it;
    Eina_Accessor *ac;
...
EFL_START_TEST(efl_shared_inarray_test_search)
{
    Eina_Inarray *iarr;
...
{
    tcase_add_test(tc, efl_shared_inarray_test_simple);
    tcase_add_test(tc, efl_shared_inarray_test_alloc_at);
    tcase_add_test(tc, efl_shared_inarray_test_insert_sort);
    tcase_add_test(tc, efl_shared_inarray_test_sort);
    tcase_add_test(tc, efl_shared_inarray_test_reverse);
    tcase_add_test(tc, efl_shared_inarray_test_itr);
    tcase_add_test(tc, efl_shared_inarray_test_search);
}
