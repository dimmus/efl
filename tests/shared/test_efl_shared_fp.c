...
EFL_START_TEST(efl_shared_fp_cos)
{
    Eina_F32p32 fc;
    Eina_F32p32 fl;
    Eina_F32p32 step;
...
EFL_START_TEST(efl_shared_fp_sin)
{
    Eina_F32p32 fc;
    Eina_F32p32 fl;
    Eina_F32p32 step;
...
EFL_START_TEST(efl_shared_fp_mul)
{
    Eina_F32p32 fc1, fc2;
    Eina_F32p32 fresult;
    double      dc1, dc2;
...
EFL_START_TEST(efl_shared_fp_div)
{
    Eina_F32p32 fc1, fc2;
    Eina_F32p32 fresult;
    double      dc1, dc2;
...
{
    tcase_add_test(tc, efl_shared_fp_cos);
    tcase_add_test(tc, efl_shared_fp_sin);
    tcase_add_test(tc, efl_shared_fp_mul);
    tcase_add_test(tc, efl_shared_fp_div);
}
