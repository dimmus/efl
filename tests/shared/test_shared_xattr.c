...
TEST(test_xattr_set)
{
    ...
    efl_assert_fail_if(ret_str == NULL);
    efl_assert_fail_if(len == 0);
    efl_assert_fail_if(strcmp(ret_str, data1) != 0);
    free(ret_str);
    ...
    efl_assert_fail_if(ret_str == NULL);
    efl_assert_fail_if(len == 0);
    efl_assert_fail_if(strcmp(ret_str, data2) != 0);
    free(ret_str);

    ret = eina_xattr_del(test_file_path, attribute1);
    efl_assert_fail_if(ret != EFL_TRUE);

    ret = eina_xattr_fd_set(fd,
                            attribute1,
                            data1,
                            strlen(data1),
                            EINA_XATTR_CREATED);
...
TEST(test_xattr_types)
{
    ...
    ret = eina_xattr_string_set(test_file_path,
                                str_attr,
                                str_data,
                                EINA_XATTR_INSERT);
    efl_assert_fail_if(ret != EFL_TRUE);
    ...
    efl_assert_fail_if(ret_str == NULL);
    efl_assert_fail_if(strcmp(ret_str, str_data) != 0);
    free(ret_str);

    ret = eina_xattr_int_set(test_file_path,
                             int_attr,
                             int_data,
                             EINA_XATTR_INSERT);
    efl_assert_fail_if(ret != EFL_TRUE);
    ...
    efl_assert_fail_if(ret != EFL_TRUE);
    efl_assert_fail_if(int_data != int_ret);

    ret = eina_xattr_double_set(test_file_path,
                                double_attr,
                                double_data,
                                EINA_XATTR_INSERT);
    efl_assert_fail_if(ret != EFL_TRUE);
    ...
    efl_assert_fail_if(ret != EFL_TRUE);
    efl_assert_fail_if(!EINA_DBL_EQ(double_data, double_ret));
