...
EFL_START_TEST(efl_shared_binshare_simple)
{
  const char *t0;
  const char *t1;
...
EFL_START_TEST(efl_shared_binshare_small)
{
  char buf[4];
  int  i;
...
EFL_START_TEST(efl_shared_binshare_test_share)
{
  const char *t0;
  const char *t1;
...
EFL_START_TEST(efl_shared_binshare_putstuff)
{
  const char *tmp;
  int         i;
...
EFL_START_TEST(efl_shared_binshare_collision)
{
  Eina_Array *ea;
  char        buffer[50];
  int         i;
...
{
  tcase_add_test(tc, efl_shared_binshare_simple);
  tcase_add_test(tc, efl_shared_binshare_small);
  tcase_add_test(tc, efl_shared_binshare_test_share);
  tcase_add_test(tc, efl_shared_binshare_collision);
  tcase_add_test(tc, efl_shared_binshare_putstuff);
}
