...
EFL_START_TEST(efl_shared_unicode_utf8)
{
  ...
  ind = 0;
  fail_if((eina_unicode_utf8_get_next("\xC2\x80", &ind) != 0x80) || (ind != 2));
  ind = 0;
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_get_next("\xF8\x88\x80\x80\x80", &ind) != 0x200000) ||
    (ind != 5));
  ind = 0;
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_get_next("\xFB\xBF\xBF\xBF\xBF", &ind) != 0x3FFFFFF) ||
    (ind != 5));
  ind = 0;
...
#define _INCOMPLETE_SEQUENCES(first, conti, len)                              \
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_get_next("\xFC\x80\x80\x80\x80\xAF", &ind) != 0xDCFC) ||
    (ind != 1));
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_get_next("\xFC\x83\xBF\xBF\xBF\xBF", &ind) != 0xDCFC) ||
    (ind != 1));
