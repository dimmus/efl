...
EFL_START_TEST(efl_shared_range_intersect_union_test)
{
...
EFL_START_TEST(efl_shared_range_contains_test)
{
    Eina_Range r1 = EINA_RANGE(0, 10);
...
EFL_START_TEST(efl_shared_range_equal_test)
{
    Eina_Range r1 = EINA_RANGE(0, 10);
...
{
    tcase_add_test(tc, efl_shared_range_intersect_union_test);
    tcase_add_test(tc, efl_shared_range_contains_test);
    tcase_add_test(tc, efl_shared_range_equal_test);
}
