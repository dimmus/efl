...
EFL_START_TEST(efl_shared_ustringshare_simple)
{
...
EFL_START_TEST(efl_shared_ustringshare_test_share)
{
    const Eina_Unicode *t0;
    const Eina_Unicode *t1;
...
EFL_START_TEST(efl_shared_ustringshare_putstuff)
{
    ...
    for (i = 100; i > 0; --i)
    {
        ...
        fail_if((int)eina_unicode_strlen(build) !=
...
{
    tcase_add_test(tc, efl_shared_ustringshare_simple);
    tcase_add_test(tc, efl_shared_ustringshare_test_share);
    tcase_add_test(tc, efl_shared_ustringshare_putstuff);
}
