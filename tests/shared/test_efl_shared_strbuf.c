...
EFL_START_TEST(efl_shared_test_strbuf_simple)
{
   Efl_Strbuf *buf;
   char *txt;
   Eina_Slice ro_slice;
...
EFL_START_TEST(efl_shared_test_strbuf_manage_simple)
{
   Efl_Strbuf *buf;
   char *txt;
#define TEST_TEXT \
...
EFL_START_TEST(efl_shared_test_strbuf_remove)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_append)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_insert)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_replace)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_realloc)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_append_realloc)
{
   Efl_Strbuf *buf;
...
EFL_START_TEST(efl_shared_test_strbuf_prepend_realloc)
{
   Efl_Strbuf *buf;
   const size_t runs = 3 * 10;
...
EFL_START_TEST(efl_shared_test_strbuf_trim)
{
   Efl_Strbuf *buf;
   const char *str;
...
EFL_START_TEST(efl_shared_test_strbuf_tolower)
{
   Efl_Strbuf *buf;
   const char *str;
...
EFL_START_TEST(efl_shared_test_strbuf_substr_get)
{
...
EFL_START_TEST(efl_shared_test_strbuf_prepend_print)
{
   Efl_Bool ret;
   Efl_Strbuf *buf;
   const char *str;
...
EFL_START_TEST(efl_shared_test_strbuf_release_test)
{
   Efl_Strbuf *buf;
   char *string;
...
EFL_START_TEST(efl_shared_test_strbuf_strftime_test)
{
   Efl_Strbuf *buf;
   time_t curr_time;
   struct tm *info;
...
{
   tcase_add_test(tc, efl_shared_test_strbuf_simple);
   tcase_add_test(tc, efl_shared_test_strbuf_remove);
   tcase_add_test(tc, efl_shared_test_strbuf_append);
   tcase_add_test(tc, efl_shared_test_strbuf_insert);
   tcase_add_test(tc, efl_shared_test_strbuf_replace);
   tcase_add_test(tc, efl_shared_test_strbuf_realloc);
   tcase_add_test(tc, efl_shared_test_strbuf_append_realloc);
   tcase_add_test(tc, efl_shared_test_strbuf_prepend_realloc);
   tcase_add_test(tc, efl_shared_test_strbuf_manage_simple);
   tcase_add_test(tc, efl_shared_test_strbuf_trim);
   tcase_add_test(tc, efl_shared_test_strbuf_tolower);
   tcase_add_test(tc, efl_shared_test_strbuf_substr_get);
   tcase_add_test(tc, efl_shared_test_strbuf_prepend_print);
   tcase_add_test(tc, efl_shared_test_strbuf_release_test);
   tcase_add_test(tc, efl_shared_test_strbuf_strftime_test);
}
