...
EFL_START_TEST(efl_shared_test_quaternion_norm)
{
...
EFL_START_TEST(efl_shared_test_quaternion_conjugate)
{
...
EFL_START_TEST(efl_shared_test_quaternion_matrix)
{
...
EFL_START_TEST(efl_shared_test_quaternion_op)
{
  Eina_Quaternion q = { 7, 9, 5, 1 };
...
EFL_START_TEST(efl_shared_test_quaternion_f16p16)
{
  ...
  fail_if(s.x != s.y || s.y != s.z || s.z != s.w || s.w != -65536);

  eina_quaternion_f16p16_add(&t, &s, &r);
  fail_if(t.x != t.y || t.y != t.z || t.z != t.w || t.w != 0);

  res = 1;
  eina_quaternion_f16p16_scale(&t, &r, res);
  fail_if(t.x != t.y || t.y != t.z || t.z != t.w || t.w != 65536);

  eina_quaternion_f16p16_conjugate(&t, &r);
  fail_if(t.x != -65536 || t.y != -65536 || t.z != -65536 || t.w != 65536);
  ...
  fail_if(t.x != 131072 || t.y != 131072 || t.z != 131072 || t.w != 0);
}

EFL_END_TEST

EFL_START_TEST(efl_shared_test_quaternion_dot)
{
...
EFL_START_TEST(efl_shared_test_quaternion_scale)
{
  Eina_Quaternion q     = { 1, 3, 4, 5 };
  double          scale = 2;
...
EFL_START_TEST(efl_shared_test_quaternion_set)
{
...
EFL_START_TEST(efl_shared_test_quaternion_mul)
{
...
EFL_START_TEST(efl_shared_test_matrix_recompose)
{
...
EFL_START_TEST(efl_shared_test_quaternion_normalized)
{
...
#if 0
EFL_START_TEST(efl_shared_test_matrix_quaternion)
{
...
EFL_START_TEST(efl_shared_test_quaternion_f16p16_lerp)
{
...
EFL_START_TEST(efl_shared_test_quaternion_lerp)
{
...
EFL_START_TEST(efl_shared_test_quaternion_f16p16_rotate_matrix)
{
  Eina_Quaternion_F16p16 q = { 65536, 65536, 65536, 0 };
  ...
  fail_if(r.x != res.x || r.y != res.y || r.z != res.z);
...
EFL_START_TEST(efl_shared_test_quaternion_rotate)
{
...
EFL_START_TEST(efl_shared_test_quaternion_operations)
{
  ...
  fail_if(
    (fabs(out.x) - 2.0) > DBL_EPSILON || (fabs(out.y) - 2.0) > DBL_EPSILON ||
    (fabs(out.z) - 1.0) > DBL_EPSILON || (fabs(out.w) - 1.0) > DBL_EPSILON);
  ...
  eina_quaternion_transform(&out, &in, &m);
  fail_if(
    (fabs(out.x) - 1.0) > DBL_EPSILON || (fabs(out.y) - 1.0) > DBL_EPSILON ||
    (fabs(out.z) - 1.0) > DBL_EPSILON || (fabs(out.w) - 1.0) > DBL_EPSILON);
}
...
{
  tcase_add_test(tc, efl_shared_test_quaternion_norm);
  tcase_add_test(tc, efl_shared_test_quaternion_conjugate);
  tcase_add_test(tc, efl_shared_test_quaternion_matrix);
  tcase_add_test(tc, efl_shared_test_quaternion_op);
  tcase_add_test(tc, efl_shared_test_quaternion_f16p16);
  tcase_add_test(tc, efl_shared_test_quaternion_dot);
  tcase_add_test(tc, efl_shared_test_quaternion_scale);
  tcase_add_test(tc, efl_shared_test_quaternion_set);
  tcase_add_test(tc, efl_shared_test_quaternion_mul);
  tcase_add_test(tc, efl_shared_test_quaternion_normalized);
   //tcase_add_test(tc, efl_shared_test_matrix_quaternion);
  tcase_add_test(tc, efl_shared_test_matrix_recompose);
  tcase_add_test(tc, efl_shared_test_quaternion_f16p16_lerp);
  tcase_add_test(tc, efl_shared_test_quaternion_lerp);
  tcase_add_test(tc, efl_shared_test_quaternion_f16p16_rotate_matrix);
  tcase_add_test(tc, efl_shared_test_quaternion_rotate);
  tcase_add_test(tc, efl_shared_test_quaternion_operations);
}
