...
TEST(ustringshare_simple)
{
   ...
   efl_assert_fail_if((int)eina_unicode_strlen(TEST0) != eina_ustringshare_strlen(t0));
   efl_assert_fail_if((int)eina_unicode_strlen(TEST1) != eina_ustringshare_strlen(t1));

   t0 = eina_ustringshare_ref(t0);
   efl_assert_fail_if(t0 == NULL);
   efl_assert_fail_if((int)strlen((char*)TEST0) != eina_stringshare_strlen((const char*)t0));
...
TEST(ustringshare_test_share)
{
   ...
   efl_assert_fail_if((int)eina_unicode_strlen(TEST0) != eina_ustringshare_strlen(t0));
   efl_assert_fail_if((int)eina_unicode_strlen(TEST0) != eina_ustringshare_strlen(t1));
   ...
   for (i = 100; i > 0; --i)
     {
        ...
        efl_assert_fail_if((int)eina_unicode_strlen(build) != eina_ustringshare_strlen(tmp));
     }
