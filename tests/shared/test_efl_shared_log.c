...
EFL_START_TEST(efl_shared_log_macro)
{
   struct log_ctx ctx;
   int oldlevel;
   int maxlevel;
...
EFL_START_TEST(efl_shared_log_domains_macros)
{
   struct log_ctx ctx;
   int oldlevel;
   int maxlevel;
...
EFL_START_TEST(efl_shared_log_domains_registry)
{
...
EFL_START_TEST(efl_shared_log_domains_slot_reuse)
{
...
EFL_START_TEST(efl_shared_log_level_indexes)
{
   struct log_ctx ctx;
   int maxlevel;
...
EFL_START_TEST(efl_shared_log_customize)
{
   struct log_ctx ctx;
   int d;
...
EFL_START_TEST(efl_shared_log_level_name)
{
   char name[4];
...
{
   tcase_add_test(tc, efl_shared_log_macro);
   tcase_add_test(tc, efl_shared_log_domains_macros);
   tcase_add_test(tc, efl_shared_log_domains_registry);
   tcase_add_test(tc, efl_shared_log_domains_slot_reuse);
   tcase_add_test(tc, efl_shared_log_level_indexes);
   tcase_add_test(tc, efl_shared_log_customize);
   tcase_add_test(tc, efl_shared_log_level_name);
}
