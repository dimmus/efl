...
TEST(test_vector2_operations)
{
    ...
    eina_matrix2_values_set(&m2, 2, 2, 2, 2);
    ...
    eina_matrix3_values_set(&m3, 2, 2, 2, 2, 2, 2, 2, 2, 2);
...
TEST(test_vector3_operations)
{
    ...
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, 5) || !EINA_DBL_EQ(v3.y, 10) ||
                       !EINA_DBL_EQ(v3.z, 15));
    ...
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, -40) || !EINA_DBL_EQ(v3.y, -10) ||
                       !EINA_DBL_EQ(v3.z, 20));
    ...
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, 12) || !EINA_DBL_EQ(v3.y, 12) ||
                       !EINA_DBL_EQ(v3.z, 12));

    eina_vector3_transform(&v3, &m3, &v3);
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, 72) || !EINA_DBL_EQ(v3.y, 72) ||
                       !EINA_DBL_EQ(v3.z, 72));
    ...
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, 25) || !EINA_DBL_EQ(v3.y, 2) ||
                       !EINA_DBL_EQ(v3.z, -21));

    eina_vector3_orthogonal_projection_on_plane(&v3, &v1, &v2);
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, -1) || !EINA_DBL_EQ(v3.y, 0) ||
                       !EINA_DBL_EQ(v3.z, 1));

    eina_vector3_plane_by_points(&q, &v3, &v1, &v2);
    efl_assert_fail_if(!EINA_DBL_EQ(q.x, -2) || !EINA_DBL_EQ(q.y, 4) ||
                       !EINA_DBL_EQ(q.z, -2) || (q.z > DBL_EPSILON));
    ...
    efl_assert_fail_if(!EINA_DBL_EQ(v3.x, 4) || !EINA_DBL_EQ(v3.y, 4) ||
                       !EINA_DBL_EQ(v3.z, 4));

    res2 = eina_vector3_equivalent(&v1, &v2);
    efl_assert_fail_if(res2 != EFL_FALSE);

    res2 = eina_vector3_equivalent(&v1, &v1);
    efl_assert_fail_if(res2 != EFL_TRUE);

    res2 = eina_vector3_triangle_equivalent(&v1, &v2, &v3, &v2, &v3, &v1);
    efl_assert_fail_if(res2 != EFL_FALSE);

    res2 = eina_vector3_triangle_equivalent(&v1, &v2, &v3, &v1, &v2, &v3);
    efl_assert_fail_if(res2 != EFL_TRUE);
