...
EINA_TEST_START(eina_util_fpx)
{
    ...
    ck_assert_int_eq(eina_dbl_exact(a, b), EFL_FALSE);
    ck_assert_int_eq(eina_dbl_exact(a, a), EFL_TRUE);
    ck_assert_int_eq(eina_flt_exact(c, d), EFL_FALSE);
    ck_assert_int_eq(eina_flt_exact(c, c), EFL_TRUE);
    ck_assert_int_eq(eina_dbl_exact(a, c), EFL_FALSE);
}
