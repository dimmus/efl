...
EFL_START_TEST(efl_shared_test_slice_init)
{
...
EFL_START_TEST(efl_shared_test_slice_ro)
{
...
EFL_START_TEST(efl_shared_test_slice_rw)
{
  ...
  ro_slice =
    (Eina_Slice)EINA_SLICE_STR_LITERAL("HELLO WORLD, big string to be cropped");
  ...
  r =
    eina_rw_slice_startswith(rw_slice, (Eina_Slice)EINA_SLICE_STR_LITERAL(""));
  fail_unless(r == EFL_FALSE);

  r =
    eina_rw_slice_endswith(rw_slice, (Eina_Slice)EINA_SLICE_STR_LITERAL("WO"));
  fail_unless(r == EFL_TRUE);
...
EFL_START_TEST(efl_shared_test_slice_print)
{
...
EFL_START_TEST(efl_shared_test_slice_find)
{
...
{
  tcase_add_test(tc, efl_shared_test_slice_init);
  tcase_add_test(tc, efl_shared_test_slice_ro);
  tcase_add_test(tc, efl_shared_test_slice_rw);
  tcase_add_test(tc, efl_shared_test_slice_print);
  tcase_add_test(tc, efl_shared_test_slice_find);
}
