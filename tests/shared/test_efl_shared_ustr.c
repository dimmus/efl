...
EFL_START_TEST(efl_shared_unicode_strcmp_test)
{
   /* 1 & 2 */
...
EFL_START_TEST(efl_shared_unicode_strcpy_test)
{
...
EFL_START_TEST(efl_shared_unicode_strncpy_test)
{
  Eina_Unicode  buf[10] = { 0 };
  Eina_Unicode *rv;
...
EFL_START_TEST(efl_shared_ustr_strlen_test)
{
...
EFL_START_TEST(efl_shared_unicode_strnlen_test)
{
   /* Strlen style tests*/
...
EFL_START_TEST(efl_shared_unicode_strdup_test)
{
  Eina_Unicode *buf;
...
EFL_START_TEST(efl_shared_unicode_strstr_test)
{
  Eina_Unicode *buf;
...
EFL_START_TEST(efl_shared_unicode_escape_test)
{
  Eina_Unicode str[][10] = {
    { 'P', 'a', ' ', 'O', 'n', 0 },
    { 'P', 'a', ' ', '\\', '\'', 0 },
...
EFL_START_TEST(efl_shared_unicode_utf8)
{
  int           ind;
  unsigned char ch;
  ...
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\x00", &ind) != 0x00) || (ind != 0));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\x01", &ind) != 0x01) || (ind != 1));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xC2\x80", &ind) != 0x80) || (ind != 2));
  ind = 0;
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_next_get("\xF8\x88\x80\x80\x80", &ind) != 0x200000) ||
    (ind != 5));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xFC\x84\x80\x80\x80\x80", &ind) !=
           0x4000000) ||
          (ind != 6));

   /* Last possible sequence of a certain length */
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\x7F", &ind) != 0x7F) || (ind != 1));
  ind = 0;
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_next_get("\xFB\xBF\xBF\xBF\xBF", &ind) != 0x3FFFFFF) ||
    (ind != 5));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xFD\xBF\xBF\xBF\xBF\xBF", &ind) !=
           0x7FFFFFFF) ||
          (ind != 6));
  ...
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\x80", &ind) != 0xDC80) || (ind != 1));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xBF", &ind) != 0xDCBF) || (ind != 1));
  ind = 0;
...
#define _INCOMPLETE_SEQUENCES(first, conti, len)                              \
  ...
  _INCOMPLETE_SEQUENCES(0xFD, 0xBF, 6);
   ...
   /* Impossible bytes */
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xFE", &ind) != 0xDCFE) || (ind != 1));
  ind = 0;
  fail_if((eina_unicode_utf8_next_get("\xFF", &ind) != 0xDCFF) || (ind != 1));
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_next_get("\xFC\x80\x80\x80\x80\xAF", &ind) != 0xDCFC) ||
    (ind != 1));
  ...
  ind = 0;
  fail_if(
    (eina_unicode_utf8_next_get("\xFC\x83\xBF\xBF\xBF\xBF", &ind) != 0xDCFC) ||
    (ind != 1));
...
EFL_START_TEST(efl_shared_unicode_utf8_conversion)
{
...
{
  printf("ustr test\n");
  tcase_add_test(tc, efl_shared_unicode_strcmp_test);
  tcase_add_test(tc, efl_shared_unicode_strcpy_test);
  tcase_add_test(tc, efl_shared_unicode_strncpy_test);
  tcase_add_test(tc, efl_shared_ustr_strlen_test);
  tcase_add_test(tc, efl_shared_unicode_strnlen_test);
  tcase_add_test(tc, efl_shared_unicode_strdup_test);
  tcase_add_test(tc, efl_shared_unicode_strstr_test);
  tcase_add_test(tc, efl_shared_unicode_escape_test);
  tcase_add_test(tc, efl_shared_unicode_utf8);
  tcase_add_test(tc, efl_shared_unicode_utf8_conversion);
}
