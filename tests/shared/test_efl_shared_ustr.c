...
EFL_START_TEST(efl_shared_unicode_utf8)
{
   ...
   /* First possible sequence of a certain length */
    ...
    fail_if((eina_unicode_utf8_next_get("\xF0\x90\x80\x80", &ind) != 0x10000) ||
            (ind != 4));
    ind = 0;
    fail_if((eina_unicode_utf8_next_get("\xF8\x88\x80\x80\x80", &ind) !=
             0x200000) ||
            (ind != 5));
    ind = 0;
   ...
   /* Last possible sequence of a certain length */
    ...
    fail_if(
        ...
        (ind != 4));
    ind = 0;
    fail_if((eina_unicode_utf8_next_get("\xFB\xBF\xBF\xBF\xBF", &ind) !=
             0x3FFFFFF) ||
            (ind != 5));
    ind = 0;
...
#define _INCOMPLETE_SEQUENCES(first, conti, len)                              \
   ...
   /* Overlong sequences */
    ...
    fail_if(
        ...
        (ind != 1));
    ind = 0;
    fail_if((eina_unicode_utf8_next_get("\xFC\x80\x80\x80\x80\xAF", &ind) !=
             0xDCFC) ||
            (ind != 1));
   ...
   /* Maximum overlong sequences */
    ...
    fail_if(
        ...
        (ind != 1));
    ind = 0;
    fail_if((eina_unicode_utf8_next_get("\xFC\x83\xBF\xBF\xBF\xBF", &ind) !=
             0xDCFC) ||
            (ind != 1));
