...
EFL_START_TEST(efl_shared_bezier_test_values)
{
  Eina_Bezier b;
  ...
  fail_if(!EINA_DBL_EQ(sx, 1) || !EINA_DBL_EQ(sy, 2) || !EINA_DBL_EQ(cx1, 3) ||
          !EINA_DBL_EQ(cy1, 4) || !EINA_DBL_EQ(cx2, 5) ||
          !EINA_DBL_EQ(cy2, 6) || !EINA_DBL_EQ(ex, 7) || !EINA_DBL_EQ(ey, 8));
}

EFL_END_TEST

EFL_START_TEST(efl_shared_bezier_test_angle)
{
  Eina_Bezier b;
  double      angle;
...
EFL_START_TEST(efl_shared_bezier_test_length)
{
  Eina_Bezier b;
  double      length;
...
EFL_START_TEST(efl_shared_bezier_test_t_at)
{
  Eina_Bezier b;
  double      length, t;
...
EFL_START_TEST(efl_shared_bezier_test_point_at)
{
  Eina_Bezier b;
  double      x, y;
  ...
  fail_if(!EINA_DBL_EQ(x, 1) || !EINA_DBL_EQ(y, 2));

  eina_bezier_point_at(&b, 1, &x, &y);

  fail_if(!EINA_DBL_EQ(x, 7) || !EINA_DBL_EQ(y, 8));
}

EFL_END_TEST

EFL_START_TEST(efl_shared_bezier_test_split_at_length)
{
  Eina_Bezier b, l, r;
...
EFL_START_TEST(efl_shared_bezier_test_bounds_get)
{
  Eina_Bezier b;
  double      x, y, w, h;
...
EFL_START_TEST(efl_shared_bezier_test_on_interval)
{
  Eina_Bezier b, res;
...
{
  tcase_add_test(tc, efl_shared_bezier_test_values);
  tcase_add_test(tc, efl_shared_bezier_test_angle);
  tcase_add_test(tc, efl_shared_bezier_test_length);
  tcase_add_test(tc, efl_shared_bezier_test_t_at);
  tcase_add_test(tc, efl_shared_bezier_test_point_at);
  tcase_add_test(tc, efl_shared_bezier_test_split_at_length);
  tcase_add_test(tc, efl_shared_bezier_test_bounds_get);
  tcase_add_test(tc, efl_shared_bezier_test_on_interval);
}
