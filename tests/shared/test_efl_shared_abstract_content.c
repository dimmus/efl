...
EFL_START_TEST(efl_shared_test_content_create_destroy)
{
...
EFL_START_TEST(efl_shared_test_content_as_file)
{
    const char   *text_str = "TestAsDf";
    Eina_Content *content =
        eina_content_new((Eina_Slice)EINA_SLICE_STR_FULL(text_str),
...
EFL_START_TEST(efl_shared_test_content_convert_none_existing)
{
    const char   *text_str = "TestAsDf";
    Eina_Content *content =
        eina_content_new((Eina_Slice)EINA_SLICE_STR_FULL(text_str),
    ...
    EXPECT_ERROR_START;
    ck_assert_ptr_eq(eina_content_convert(content, "ThisIsReallyNotHere"),
                     NULL);
    EXPECT_ERROR_END;
}
...
EFL_START_TEST(efl_shared_test_content_convert_ascii_to_utf8)
{
    const char   *text_str = "TestAsDf";
    Eina_Content *content =
        eina_content_new((Eina_Slice)EINA_SLICE_STR_FULL(text_str),
...
EFL_START_TEST(efl_shared_test_content_convert_ascii_to_latin)
{
    const char   *text_str = "TestAsDf";
    Eina_Content *content =
        eina_content_new((Eina_Slice)EINA_SLICE_STR_FULL(text_str),
...
EFL_START_TEST(efl_shared_test_content_convert_utf8_to_latin)
{
   //this means AÄÜÖß
...
EFL_START_TEST(efl_shared_test_content_possible_converstions)
{
    ck_assert_int_eq(
...
EFL_START_TEST(efl_shared_test_register_illegal)
{
    ...
    ck_assert_int_eq(getting_called, EFL_TRUE);
}

EFL_END_TEST

EFL_START_TEST(efl_shared_test_content_value)
{
...
EFL_START_TEST(efl_shared_test_content_value_set)
{
    const char   *str_a = "All";
    Eina_Content *a =
        eina_content_new((Eina_Slice)EINA_SLICE_STR_FULL(str_a), "text/plain");
...
EFL_START_TEST(efl_shared_test_content_value_convertion)
{
    const char   *str_a = "All";
    const char   *str_b = "Out";
...
{
    tcase_add_test(tc, efl_shared_test_content_create_destroy);
    tcase_add_test(tc, efl_shared_test_content_as_file);
    tcase_add_test(tc, efl_shared_test_content_convert_none_existing);
    tcase_add_test(tc, efl_shared_test_content_convert_ascii_to_utf8);
    tcase_add_test(tc, efl_shared_test_content_convert_ascii_to_latin);
    tcase_add_test(tc, efl_shared_test_content_convert_utf8_to_latin);
    tcase_add_test(tc, efl_shared_test_content_possible_converstions);
    tcase_add_test(tc, efl_shared_test_register_illegal);
    tcase_add_test(tc, efl_shared_test_content_value);
    tcase_add_test(tc, efl_shared_test_content_value_set);
    tcase_add_test(tc, efl_shared_test_content_value_convertion);
}
